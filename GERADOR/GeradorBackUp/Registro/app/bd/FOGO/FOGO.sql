...
DROP DATABASE IF EXISTS `FOGO`;
CREATE DATABASE `FOGO`;
...
DROP TABLE IF EXISTS `CFOP_CONTACONTAB`;
CREATE TABLE CFOP_CONTACONTAB (
	`EMPRESA` int NOT NULL  , 
	`CFOP` int NOT NULL  , 
	`CONTA_RED` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE Lanc_EntradaProducaoItens (
	...
	`InicioProducaoOriginal` datetime   DEFAULT NULL, 
	`FimProducaoOriginal` datetime   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `LANC_DESPESAS_CAIXA_DIA`;
CREATE TABLE LANC_DESPESAS_CAIXA_DIA (
	`ID_LANC_DESPESAS_CAIXA_DIA` int NOT NULL  , 
...
CREATE TABLE Lanc_Pedidos (
	...
	`FlagColetado` int(1)   DEFAULT NULL, 
	`SiglaUsuarioProcessoColetado` varchar(3)   DEFAULT NULL, 
	`DataHoraProcessoColetado` datetime   DEFAULT NULL, 
	`ImpressaoRomaneio` int   DEFAULT NULL, 
	`UsuarioImpressaoRomaneio` varchar(500)   DEFAULT NULL, 
	`ValorRecebidoFicha` float   DEFAULT NULL, 
	`ValorTrocoFicha` float   DEFAULT NULL, 
	`NumeroFicha` varchar(10)   DEFAULT NULL, 
	`TotalFicha` float   DEFAULT NULL, 
	`ValorRecebidoEmDinheiroFicha` float   DEFAULT NULL, 
	`ValorRecebidoEmCartaoFicha` float   DEFAULT NULL, 
	`ValorRecebidoEmChequeFicha` char(10)   DEFAULT NULL, 
	`TotalFichaDesconto` float   DEFAULT NULL, 
	`ValorFichaDinheiro` float   DEFAULT NULL, 
	`ValorFichaChequeAVista` float   DEFAULT NULL, 
	`ValorFichaChequeAPrazo` float   DEFAULT NULL, 
	`ValorFichaCartao` float   DEFAULT NULL, 
	`ValorFichaAPrazo` float   DEFAULT NULL, 
	`ValorFichaCredito` float   DEFAULT NULL, 
	`idLancPedido` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE Lanc_Pedidos_itens (
	...
	`LancPedidoID` int   DEFAULT NULL, 
	`IDLancPedidosItens` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE MAQUINA (
	...
	`DS_MAQUINA` varchar(500)   DEFAULT NULL, 
	`DS_CAPACIDADE` varchar(500)   DEFAULT NULL, 
	`DS_MARCA` varchar(500)   DEFAULT NULL, 
	`DS_MODELO` varchar(500)   DEFAULT NULL, 
	`DS_IDENTIFICADOR` varchar(500)   DEFAULT NULL, 
	`CK_PRIORIDADE` varchar(10)   DEFAULT NULL, 
	`DS_LOCALIZACAO` varchar(500)   DEFAULT NULL, 
	`ID_TIPO_MAQUINA` int   DEFAULT NULL, 
	`ID_FORNECEDOR` int   DEFAULT NULL, 
	`DT_COMPRA` datetime   DEFAULT NULL, 
	`DS_COMENTARIOS` varchar(4000)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `MAQUINA_ARQUIVO`;
CREATE TABLE MAQUINA_ARQUIVO (
	`ID_MAQUINA_ARQUIVO` int NOT NULL  , 
	`ID_MAQUINA` int   DEFAULT NULL, 
	`DS_ARQUIVO` varchar(4000)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `MAQUINA_IMAGEM`;
CREATE TABLE MAQUINA_IMAGEM (
	`ID_MAQUINA_IMAGEM` int NOT NULL  , 
	`ID_MAQUINA` int   DEFAULT NULL, 
	`DS_ARQUIVO` varchar(4000)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `MAQUINA_MAQUINA_PAI`;
CREATE TABLE MAQUINA_MAQUINA_PAI (
	`ID_MAQUINA_MAQUINA_PAI` int NOT NULL  , 
	`ID_MAQUINA` int   DEFAULT NULL, 
	`ID_MAQUINA_PAI` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `MAQUINA_PECAS`;
CREATE TABLE MAQUINA_PECAS (
	`ID_MAQUINA_PECAS` int NOT NULL  , 
	`ID_MAQUINA` int   DEFAULT NULL, 
	`ITEM` int   DEFAULT NULL, 
	`QUANTIDADE` float   DEFAULT NULL, 
	`UNIDADE_MEDIDA` varchar(3)   DEFAULT NULL, 
	`QUANTIDADE_PRINCIPAL` float   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `NATUREZARECEITA_CONTACONTAB`;
CREATE TABLE NATUREZARECEITA_CONTACONTAB (
	`EMPRESA` int NOT NULL  , 
...
CREATE TABLE NF_RECEBER_DEV_NFE (
	`FILIAL` int   DEFAULT NULL, 
	`SERIE` char(3)   DEFAULT NULL, 
	`NOTAFISCAL` varchar(9)   DEFAULT NULL, 
	`SERIEENTRADA` char(3)   DEFAULT NULL, 
	`NOTAFISCALENTRADA` varchar(9)   DEFAULT NULL, 
	`DATAEMISSAO` datetime   DEFAULT NULL, 
	`CHAVENFE` varchar(44)   DEFAULT NULL, 
	`MODELO` char(2)   DEFAULT NULL, 
...
CREATE TABLE PARAMETROS (
	...
	`AliquotaISS_NFS` float   DEFAULT NULL, 
	`ReterAliquotaISS_NFS` int(1)   DEFAULT NULL, 
...
CREATE TABLE Parametros_VendasBalcao (
	...
	`PermiteExclusaoPedido` int(1)   DEFAULT NULL, 
	`TipoNFVenda` int   DEFAULT NULL, 
	`BancoChequeFechamento` int   DEFAULT NULL, 
	`ContaChequeFechamento` varchar(15)   DEFAULT NULL, 
	`TipoNFComodato` int   DEFAULT NULL, 
	`TipoNFEntradaComodato` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `ParametrosVendaFicha`;
CREATE TABLE ParametrosVendaFicha (
	`FILIAL` int NOT NULL  , 
	`Cliente` int   DEFAULT NULL, 
	`CondPagamento` int   DEFAULT NULL, 
	`Banco` int   DEFAULT NULL, 
	...
	`GRUPO_CONTA` int   DEFAULT NULL, 
	`SEQ_CTA_CUSTO` int   DEFAULT NULL, 
	`CondPagamentoAPrazo` int   DEFAULT NULL, 
	`CondPagamentoDinheiro` int   DEFAULT NULL, 
	`CondPagamentoCartao` int   DEFAULT NULL, 
	`CondPagamentoChequeAVista` int   DEFAULT NULL, 
	`CondPagamentoChequeAPrazo` int   DEFAULT NULL, 
	`DiasCondPagamentoAPrazo` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `REL_ETIQUETAS_CLIENTE`;
CREATE TABLE REL_ETIQUETAS_CLIENTE (
	`ID_REL_ETIQUETAS_CLIENTE` int NOT NULL  , 
	`NUM_REL` int   DEFAULT NULL, 
	`SEQUENCIA` int   DEFAULT NULL, 
	`QUANTIDADE` float   DEFAULT NULL, 
	`RAZAOSOCIAL` varchar(100)   DEFAULT NULL, 
...
CREATE TABLE TabUsuarios (
	...
	`MostraValoresFechamentoOrcamento` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE TIPO_MAQUINA (
	...
	`DS_TIPO_MAQUINA` varchar(100)   DEFAULT NULL, 
	`CK_INATIVO` int(1) NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
