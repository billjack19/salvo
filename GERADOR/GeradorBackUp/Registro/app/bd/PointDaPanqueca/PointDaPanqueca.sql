...
DROP DATABASE IF EXISTS `PointDaPanqueca`;
CREATE DATABASE `PointDaPanqueca`;
...
CREATE TABLE aliquota (
	...
	`NFICMS` varchar(2)   DEFAULT NULL, 
	`ECF` varchar(4)   DEFAULT NULL
...
CREATE TABLE Causa (
	`CAUSA` int NOT NULL  , 
	`DESCRICAO` varchar(50)   DEFAULT NULL, 
	`CodCaixa` char(10)   DEFAULT NULL, 
	`CodMov` varchar(5)   DEFAULT NULL, 
	`TipoMovimento` char(1)   DEFAULT NULL, 
	`CodRais` char(10)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE cbalancamentos (
	...
	`EMISSAO` datetime   DEFAULT NULL, 
	`UTILIZADO` varchar(3000)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `CLIEFORNEC_AUTORIZADOS`;
CREATE TABLE CLIEFORNEC_AUTORIZADOS (
	`Cliente` int NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	`Autorizado` varchar(300)   DEFAULT NULL, 
	`DataNascimento` datetime   DEFAULT NULL, 
	`CPF` varchar(18)   DEFAULT NULL, 
	`GrauParentesco` varchar(150)   DEFAULT NULL, 
	`RG` varchar(20)   DEFAULT NULL, 
	`CaminhoFoto` varchar(500)   DEFAULT NULL, 
...
CREATE TABLE CLIEFORNEC (
	...
	`ObservacaoVendas` text(2147483647)   DEFAULT NULL, 
	...
	`BancoContrato` int   DEFAULT NULL, 
	`ContaContrato` char(15)   DEFAULT NULL, 
	...
	`CodEstadoCivil` int   DEFAULT NULL, 
	`TaxaJuros` float   DEFAULT NULL, 
	...
	`ObservacaoImovelFiador` varchar(4000)   DEFAULT NULL, 
...
CREATE TABLE Cliefornec_Creditos (
	...
	`DuasAutorizacoes` int(1)   DEFAULT NULL, 
	`AUTORIZADOEM2` datetime   DEFAULT NULL, 
	`AUTORIZADOPOR2` varchar(50)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Cliefornec_Fiador`;
CREATE TABLE Cliefornec_Fiador (
	`Cliente` int NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	...
	`ENDERECOIMOVELFIADOR` varchar(100)   DEFAULT NULL, 
	`MATRICULAIMOVELFIADOR` varchar(20)   DEFAULT NULL, 
	`VALORVENALIMOVELFIADOR` float   DEFAULT NULL, 
	`METRAGEMIMOVELFIADOR` float   DEFAULT NULL, 
	`ObservacaoImovelFiador` varchar(4000)   DEFAULT NULL, 
	`DATAATUALIZACAO` datetime   DEFAULT NULL, 
	`HORAATUALIZACAO` char(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO` char(3)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `CLIEFORNEC_RECARGA`;
CREATE TABLE CLIEFORNEC_RECARGA (
	`Cliente` int NOT NULL  , 
	`DataInicial` char(10)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Cliefornec_Representante`;
CREATE TABLE Cliefornec_Representante (
	`Cliente` int NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	`NOMEREPRESENTANTE` varchar(70)   DEFAULT NULL, 
	`NASCREPRESENTANTE` datetime   DEFAULT NULL, 
	`RGREPRESENTANTE` varchar(20)   DEFAULT NULL, 
	`CPFREPRESENTANTE` varchar(30)   DEFAULT NULL, 
	`NACIONALIDADEREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`ESTADOCIVILREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`ENDERECOREPRESENTANTE` varchar(70)   DEFAULT NULL, 
	`BAIRROREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`CIDADEREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`ESTADOREPRESENTANTE` varchar(2)   DEFAULT NULL, 
	`CEPREPRESENTANTE` varchar(10)   DEFAULT NULL, 
	`TELEFONEREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`PROFISSAOREPRESENTANTE` varchar(50)   DEFAULT NULL, 
	`DATAATUALIZACAO` datetime   DEFAULT NULL, 
	`HORAATUALIZACAO` varchar(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO` varchar(3)   DEFAULT NULL, 
	`DataAtualizacao_Alteracao` datetime   DEFAULT NULL, 
	`HORAATUALIZACAO_Alteracao` varchar(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO_Alteracao` varchar(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE CondPagamento (
	...
	`ID_CREDENCIADORA_CARTAO` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE convenio (
	...
	`motivobloq` varchar(30)   DEFAULT NULL, 
	`prazofecha` tinyint   DEFAULT NULL, 
	`dia_fecha1` tinyint   DEFAULT NULL, 
	`dia_fecha2` tinyint   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `DCREDITO`;
CREATE TABLE DCREDITO (
	...
	`Col021` varchar(255)   DEFAULT NULL, 
	`Col022` varchar(255)   DEFAULT NULL, 
	`Col023` varchar(255)   DEFAULT NULL, 
	`Col024` varchar(255)   DEFAULT NULL, 
	`Col025` varchar(255)   DEFAULT NULL, 
	`Col026` varchar(255)   DEFAULT NULL, 
	`Col027` varchar(255)   DEFAULT NULL, 
	`Col028` varchar(255)   DEFAULT NULL, 
	`Col029` varchar(255)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE cultura (
	...
	`dosagem` numeric   DEFAULT NULL, 
	`epoca` varchar(30)   DEFAULT NULL, 
	`carencia` varchar(10)   DEFAULT NULL, 
	`aplicacao` varchar(30)   DEFAULT NULL, 
	`id_un_esp_dos` int   DEFAULT NULL, 
	`diagnostico` varchar(40)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `cupom_pagto`;
CREATE TABLE cupom_pagto (
	`id` int NOT NULL  , 
	...
	`cancelado` bigint   DEFAULT NULL, 
	`datahora` datetime   DEFAULT NULL, 
	`descricao` varchar(16)   DEFAULT NULL, 
	`ordem` int   DEFAULT NULL, 
	`loja` bigint   DEFAULT NULL, 
	`processado` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `CREDENCIADORA_CARTAO`;
CREATE TABLE CREDENCIADORA_CARTAO (
	`ID_CREDENCIADORA_CARTAO` int   DEFAULT NULL, 
	`DS_CREDENCIADORA_CARTAO` varchar(100)   DEFAULT NULL, 
...
CREATE TABLE depto (
	...
	`BALANCA` varchar(1)   DEFAULT NULL, 
	`indice` numeric   DEFAULT NULL, 
	`desconto` numeric   DEFAULT NULL, 
...
CREATE TABLE EPI (
	`Codigo` int NOT NULL  , 
	`Descricao` varchar(50)   DEFAULT NULL, 
	`ImprimeRelatorio` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE entradas (
	...
	`CODIGO` int   DEFAULT NULL, 
	`DESCRICAO` varchar(40)   DEFAULT NULL, 
	`QEMB` numeric   DEFAULT NULL, 
	`EMBALAGEM` int   DEFAULT NULL, 
	`QUANT` numeric   DEFAULT NULL, 
	`VALORTOT` numeric   DEFAULT NULL, 
	`VIPI` numeric   DEFAULT NULL, 
	`ICMS` varchar(4)   DEFAULT NULL, 
	`CUSTO` numeric   DEFAULT NULL, 
	`NOTA` varchar(6)   DEFAULT NULL, 
	`CODFOR` int   DEFAULT NULL, 
	`PREQUANT` numeric   DEFAULT NULL, 
	`CODBARRA` varchar(13)   DEFAULT NULL, 
	`UNIDADE` varchar(2)   DEFAULT NULL, 
	`VALIDADE` datetime   DEFAULT NULL, 
	`CFOP` varchar(4)   DEFAULT NULL, 
	`CST` varchar(3)   DEFAULT NULL, 
	`DESCITEM` numeric   DEFAULT NULL, 
	`Data` datetime   DEFAULT NULL, 
	`datahora` datetime   DEFAULT NULL, 
	`id_compra` int   DEFAULT NULL, 
	`redicms` numeric   DEFAULT NULL, 
	`modelo` varchar(2)   DEFAULT NULL, 
	`serie` varchar(3)   DEFAULT NULL, 
	`subserie` varchar(2)   DEFAULT NULL, 
	`hora` bigint   DEFAULT NULL, 
	`qtde_pedida` numeric   DEFAULT NULL, 
	`isentas` numeric   DEFAULT NULL, 
	`outras` numeric   DEFAULT NULL, 
	`desconto_total` numeric   DEFAULT NULL, 
	`valorbruto` numeric   DEFAULT NULL, 
	`nao_bx_estoque` tinyint   DEFAULT NULL, 
	`mva` numeric   DEFAULT NULL, 
	`st_icms` numeric   DEFAULT NULL, 
	`custoreal` numeric   DEFAULT NULL, 
	`st_base` numeric   DEFAULT NULL, 
	`dificms` numeric   DEFAULT NULL, 
	`valor_icms` numeric   DEFAULT NULL, 
	`id_entcab` bigint   DEFAULT NULL, 
	`margem` numeric   DEFAULT NULL, 
	`sugerido` numeric   DEFAULT NULL, 
	`data_digitacao` datetime   DEFAULT NULL, 
	`nao_desconto` bigint   DEFAULT NULL, 
	`aliq_op_propria` numeric   DEFAULT NULL, 
	`st_manual` int   DEFAULT NULL, 
	`RedSt` numeric   DEFAULT NULL, 
	`nao_acrescimo` bigint   DEFAULT NULL, 
	`base_icms` numeric   DEFAULT NULL, 
	`sempiscofins` int   DEFAULT NULL, 
	`qtde_importada_transferencia` numeric   DEFAULT NULL, 
	`ipi_base_icms` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `EPIFuncionario`;
CREATE TABLE EPIFuncionario (
	`Chapa` int NOT NULL  , 
	`EPI` int NOT NULL  , 
...
DROP TABLE IF EXISTS `formpormod`;
CREATE TABLE formpormod (
	`id` bigint NOT NULL  , 
	`id_formpagto` int   DEFAULT NULL, 
	`id_modalidade` bigint   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `formpagto`;
CREATE TABLE formpagto (
	`id` int NOT NULL  , 
	`descricao` varchar(30)   DEFAULT NULL, 
	`parcelas` varchar(250)   DEFAULT NULL, 
	`acrescimo` numeric   DEFAULT NULL, 
	`desc_vend` numeric   DEFAULT NULL, 
	`desc_gere` numeric   DEFAULT NULL, 
	`id_carteira` int   DEFAULT NULL, 
	`id_conta` int   DEFAULT NULL, 
	`atacado` int   DEFAULT NULL, 
	`valminimo` numeric   DEFAULT NULL, 
	`markup_minimo` numeric   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE FORNEC (
	...
	`Col035` varchar(255)   DEFAULT NULL, 
	`Fone` varchar(255)   DEFAULT NULL, 
	`Col037` varchar(255)   DEFAULT NULL, 
	`FAX` varchar(255)   DEFAULT NULL, 
	`Nome` varchar(255)   DEFAULT NULL, 
	`Col040` varchar(255)   DEFAULT NULL, 
	`Col041` varchar(255)   DEFAULT NULL, 
	`Col042` varchar(255)   DEFAULT NULL, 
	`Col043` varchar(255)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE FILIAL (
	...
	`CaminhoNFe` char(255)   DEFAULT NULL, 
	...
	`GeraCreditoICMS` char(10)   DEFAULT NULL, 
	...
	`PortaEmailNfe` varchar(50)   DEFAULT NULL, 
	`DiasLembreteProtesto` int   DEFAULT NULL, 
	`RNTRC` varchar(8)   DEFAULT NULL, 
	`ControlaQualidade` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE fornece (
	...
	`ST` numeric   DEFAULT NULL, 
	`situacao_empresa` bigint   DEFAULT NULL, 
	`senha` varchar(10)   DEFAULT NULL, 
	`anotacoes` varchar(2147483647)   DEFAULT NULL, 
	`cod_autorizado` varchar(20)   DEFAULT NULL, 
	`banco1` varchar(15)   DEFAULT NULL, 
	`banco2` varchar(15)   DEFAULT NULL, 
	`agencia1` varchar(5)   DEFAULT NULL, 
	`agencia2` varchar(5)   DEFAULT NULL, 
	`conta1` varchar(15)   DEFAULT NULL, 
	`conta2` varchar(15)   DEFAULT NULL, 
	`prest_serv` bigint   DEFAULT NULL, 
	`fonevend` varchar(25)   DEFAULT NULL, 
	`supervisor` varchar(80)   DEFAULT NULL, 
	`fonesup` varchar(25)   DEFAULT NULL, 
	`emailsup` varchar(60)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE GRUPO_ESTOQUE (
	...
	`ParametroA` varchar(20)   DEFAULT NULL, 
	`ParametroB` varchar(20)   DEFAULT NULL, 
	`ParametroC` varchar(20)   DEFAULT NULL, 
...
CREATE TABLE Funcoes (
	`codigo` int NOT NULL  , 
	`descricao` varchar(50)   DEFAULT NULL, 
	`cbo` int   DEFAULT NULL, 
	`QuadroHorario` int(1)   DEFAULT NULL, 
	`DocExperiencia` varchar(100)   DEFAULT NULL, 
	`TermoResponsabilidade` varchar(100)   DEFAULT NULL, 
...
CREATE TABLE Horarios (
	...
	`INTERVALO_DE` varchar(5)   DEFAULT NULL, 
	`INTERVALO_ATE` varchar(5)   DEFAULT NULL, 
	`SAIDA` varchar(5)   DEFAULT NULL, 
	`OBSERVACAO` varchar(40)   DEFAULT NULL, 
	`ENTRADASAB` varchar(5)   DEFAULT NULL, 
	`INTERVALO_DESAB` varchar(5)   DEFAULT NULL, 
	`INTERVALO_ATESAB` varchar(5)   DEFAULT NULL, 
	`SAIDASAB` varchar(5)   DEFAULT NULL, 
	`TIPO_TURNO` int NOT NULL  , 
	`GRAVAINTERVALO` int(1) NOT NULL  , 
	`INTERVALOESCALA` varchar(5)   DEFAULT NULL, 
	`HORARIODOMINGO` int(1) NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE IMPRESSORA_FISCAL (
	...
	`CK_TIPO` int   DEFAULT NULL, 
	`MARCA` varchar(20)   DEFAULT NULL, 
	`AssinaturaAC` varchar(344)   DEFAULT NULL, 
	`CodigoAtivacao` varchar(20)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE INTERMEDIO (
	...
	`DS_INTERMEDIO` varchar(50)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Lanc_Cobranca`;
CREATE TABLE Lanc_Cobranca (
	`Documento` varchar(6) NOT NULL  , 
	`DataEmissao` date NOT NULL  , 
	`Observacao` varchar(4000)   DEFAULT NULL, 
	`FiltroEmissaoInicial` date   DEFAULT NULL, 
	`FiltroEmissaoFinal` date   DEFAULT NULL, 
	`FiltroVencimentoInicial` date   DEFAULT NULL, 
	`FiltroVencimentoFinal` date   DEFAULT NULL, 
	`FiltroRegiao` int   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `LANC_DIMOB`;
CREATE TABLE LANC_DIMOB (
	`ID_LANC_DIMOB` int NOT NULL  , 
	`FILIAL` int   DEFAULT NULL, 
	`ANO` int   DEFAULT NULL, 
	`CODIGO_LOCADOR` int   DEFAULT NULL, 
	`CODIGO_LOCATARIO` int   DEFAULT NULL, 
	`NUMERO_CONTRATO` varchar(6)   DEFAULT NULL, 
	`DATA_CONTRATO` datetime   DEFAULT NULL, 
	`TIPO_IMOVEL` varchar(1)   DEFAULT NULL, 
	`CODIGO_IMOVEL` int   DEFAULT NULL, 
	`CODIGO_MUNICIPIO_IMOVEL` int   DEFAULT NULL, 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` char(3)   DEFAULT NULL, 
	`DataAtualizacao_Alteracao` datetime   DEFAULT NULL, 
...
CREATE TABLE Lanc_EntradaProducaoItens (
	...
	`SaldoPedido` float   DEFAULT NULL, 
	`DesejadoPedido` float   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `LANC_DIMOB_MESES`;
CREATE TABLE LANC_DIMOB_MESES (
	`ID_LANC_DIMOB_MESES` int NOT NULL  , 
	`ID_LANC_DIMOB` int   DEFAULT NULL, 
	`MES` int   DEFAULT NULL, 
	`VLR_ALUGUEL` float   DEFAULT NULL, 
	`VLR_COMISSAO` float   DEFAULT NULL, 
	`VLR_IMPOSTO` float   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `Lanc_GeraBoletos`;
CREATE TABLE Lanc_GeraBoletos (
	...
	`Encerrado` int(1)   DEFAULT NULL, 
	`Filial` int   DEFAULT NULL, 
	`NumBoleto` varchar(15)   DEFAULT NULL, 
	`Duplicata` varchar(6)   DEFAULT NULL, 
	`BancoImpressao` char(10)   DEFAULT NULL, 
	`ImpressaoBoleto` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Lanc_GeraBoletos_Itens`;
CREATE TABLE Lanc_GeraBoletos_Itens (
	`Lancamento` char(6) NOT NULL  , 
	`Seq` int NOT NULL  , 
	`Filial` int   DEFAULT NULL, 
	`Serie` char(3)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `LANC_MARKETING_FOLLOWUP`;
CREATE TABLE LANC_MARKETING_FOLLOWUP (
	`ID_LANC_MARKETING_FOLLOWUP` int NOT NULL  , 
	`FILIAL` int   DEFAULT NULL, 
	`DOCUMENTO` varchar(6)   DEFAULT NULL, 
	`DATA_EMISSAO` datetime   DEFAULT NULL, 
	`DESCRICAO` varchar(4000)   DEFAULT NULL, 
	`DATA_RETORNO` datetime   DEFAULT NULL, 
	`CK_OK` int(1) NOT NULL  , 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` varchar(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` varchar(3)   DEFAULT NULL, 
	`DataAtualizacao_Alteracao` datetime   DEFAULT NULL, 
...
CREATE TABLE Lanc_Marketing_Itens_Personalizados (
	...
	`ComplementoDescricao` varchar(100)   DEFAULT NULL, 
	`Observacao` varchar(500)   DEFAULT NULL, 
...
CREATE TABLE Lanc_Marketing (
	...
	`StatusOrcamento` varchar(1)   DEFAULT NULL, 
...
CREATE TABLE Lanc_Pedidos (
	...
	`TaxaServico` float   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `Lanc_Requisicao_Itens_Ped`;
CREATE TABLE Lanc_Requisicao_Itens_Ped (
	`FILIAL` int NOT NULL  , 
	`DOCUMENTO` int NOT NULL  , 
	`SEQUENCIA` int NOT NULL  , 
	`Grupo` int   DEFAULT NULL, 
	...
	`ValorUnitario` float   DEFAULT NULL, 
	`Unidade` char(3)   DEFAULT NULL, 
	`Componente` int(1)   DEFAULT NULL, 
	`ItemKit` int   DEFAULT NULL, 
	`SeqItemPed` int   DEFAULT NULL, 
	`SeqItemComp` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Lanc_Requisicao_Ped`;
CREATE TABLE Lanc_Requisicao_Ped (
	`FILIAL` int NOT NULL  , 
	`DOCUMENTO` int NOT NULL  , 
	`NOTAFISCAL` char(6)   DEFAULT NULL, 
	`DataEmissao` datetime   DEFAULT NULL, 
	...
	`Observacao` varchar(4000)   DEFAULT NULL, 
	`FlagEncerrado` int(1)   DEFAULT NULL, 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` char(3)   DEFAULT NULL, 
	...
	`CidadeDestino` int   DEFAULT NULL, 
	`Carregador` varchar(100)   DEFAULT NULL, 
	`HoraInicial` char(8)   DEFAULT NULL, 
	`HoraFinal` char(8)   DEFAULT NULL, 
	`Conferente` varchar(100)   DEFAULT NULL, 
	`FlagImpressao` int(1)   DEFAULT NULL, 
	`EndEntrega` int(1)   DEFAULT NULL, 
	`DataAtualizacao_Alteracao` datetime   DEFAULT NULL, 
	`HoraAtualizacao_Alteracao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao_Alteracao` char(3)   DEFAULT NULL, 
	`DataAtualizacao_Encerrado` datetime   DEFAULT NULL, 
	`HoraAtualizacao_Encerrado` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao_Encerrado` char(3)   DEFAULT NULL, 
	`DataAtualizacao_Reabre` datetime   DEFAULT NULL, 
	`HoraAtualizacao_Reabre` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao_Reabre` char(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `LancamentoDocumento`;
CREATE TABLE LancamentoDocumento (
	`Lancamento` int NOT NULL  , 
	`DataEmissao` datetime   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `LancamentoExame`;
CREATE TABLE LancamentoExame (
	`Lancamento` int NOT NULL  , 
	`DataEmissao` datetime   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `LancamentoTreinamento_Funcionarios`;
CREATE TABLE LancamentoTreinamento_Funcionarios (
	`Lancamento` int NOT NULL  , 
	`Funcionario` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `LancamentoTreinamento`;
CREATE TABLE LancamentoTreinamento (
	`Lancamento` int NOT NULL  , 
	`DataEmissao` datetime   DEFAULT NULL, 
	`DataInicio` datetime   DEFAULT NULL, 
	`HoraDe` varchar(5)   DEFAULT NULL, 
	`HoraAte` varchar(5)   DEFAULT NULL, 
	`LocalTreinamento` varchar(50)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `LancamentoTreinamento_Func`;
CREATE TABLE LancamentoTreinamento_Func (
	`Lancamento` int NOT NULL  , 
...
DROP TABLE IF EXISTS `LancRateioSetores_Setor`;
CREATE TABLE LancRateioSetores_Setor (
...
DROP TABLE IF EXISTS `LancamentoTreinamento_Treinamentos`;
CREATE TABLE LancamentoTreinamento_Treinamentos (
	`Lancamento` int NOT NULL  , 
	`Treinamento` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE log_sistema (
	...
	`id_subgrupo` bigint   DEFAULT NULL, 
	`usuario` varchar(35)   DEFAULT NULL, 
	`ip` varchar(20)   DEFAULT NULL, 
	`estacao` varchar(30)   DEFAULT NULL, 
...
CREATE TABLE NF_RECEBER (
	...
	`ObservacaoProduto` varchar(2500)   DEFAULT NULL, 
	...
	`DescricaoAutorizado` varchar(300)   DEFAULT NULL, 
	`ValorPagoEntrada` float   DEFAULT NULL, 
	...
	`DataFormacao` datetime   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `NF_RECEBER_GARANTIA`;
CREATE TABLE NF_RECEBER_GARANTIA (
	`ID_NF_RECEBER_GARANTIA` int NOT NULL  , 
	`FILIAL` int NOT NULL  , 
	`Serie` char(3) NOT NULL  , 
	`NotaFiscal` char(6) NOT NULL  , 
	`DataAtualizacao` datetime   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `NF_RECEBER_ITENS_GARANTIA`;
CREATE TABLE NF_RECEBER_ITENS_GARANTIA (
	`ID_NF_RECEBER_ITENS_GARANTIA` int NOT NULL  , 
	`ID_NF_RECEBER_GARANTIA` int NOT NULL  , 
	`Filial` int NOT NULL  , 
	`Serie` char(3) NOT NULL  , 
	`NotaFiscal` char(6) NOT NULL  , 
	...
	`VENCIMENTO_GARANTIA` datetime   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `NF_RECEBER_MANUTENCAO`;
CREATE TABLE NF_RECEBER_MANUTENCAO (
	`Filial` int NOT NULL  , 
	`Serie` varchar(3) NOT NULL  , 
	`NotaFiscal` varchar(6) NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	`DataReclamancaoManutencao` datetime   DEFAULT NULL, 
	`ProblemaRelatadoManutencao` varchar(2000)   DEFAULT NULL, 
	`DataVisitaManutencao` datetime   DEFAULT NULL, 
	`PeriodoManutencao` varchar(1)   DEFAULT NULL, 
	`NomeRGManutencao` varchar(200)   DEFAULT NULL, 
	`ProblemaConstatadoManutencao` varchar(2000)   DEFAULT NULL, 
	`SolucaoManutencao` varchar(2000)   DEFAULT NULL, 
	`ResolvidoManutencao` varchar(1)   DEFAULT NULL, 
	`DATAATUALIZACAO` datetime   DEFAULT NULL, 
	`HORAATUALIZACAO` char(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO` char(3)   DEFAULT NULL, 
	`DATAATUALIZACAO_Alteracao` datetime   DEFAULT NULL, 
	`HORAATUALIZACAO_Alteracao` char(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO_Alteracao` char(3)   DEFAULT NULL, 
	`FlagEncerrado` int(1) NOT NULL  , 
	`MotivoNaoResolvidoManutencao` varchar(2000)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE NFe_NCM_CST_IPI_FILIAL (
	...
	`ID_CST_PIS_COFINS` char(2)   DEFAULT NULL, 
	`PercPIS` float   DEFAULT NULL, 
	`PercCOFINS` float   DEFAULT NULL, 
	`DescPercPIS` float   DEFAULT NULL, 
	`DescPercCOFINS` float   DEFAULT NULL
...
CREATE TABLE NFe_PARAMETROS (
	...
	`ID_MODELO_TALAO` int   DEFAULT NULL, 
	`ID_TIPO_NF` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE NFe_PARAMETROS_SERIE (
	...
	`SERIE_FS` char(3)   DEFAULT NULL, 
	`SERIE_TALAO` char(3)   DEFAULT NULL, 
	`SERIE_PEDIDO` char(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE operador (
	...
	`obs` varchar(80)   DEFAULT NULL, 
	`canccupom` int   DEFAULT NULL, 
	`reducaoz` int   DEFAULT NULL, 
	`senha` varchar(15)   DEFAULT NULL, 
	`senha_quem` varchar(30)   DEFAULT NULL, 
	`senha_data` datetime   DEFAULT NULL, 
	`abregav` int   DEFAULT NULL, 
	`cancitem` int   DEFAULT NULL, 
	`desconto` tinyint   DEFAULT NULL, 
	`acres` tinyint   DEFAULT NULL, 
...
CREATE TABLE OrdemCompraItens (
	...
	`ValorIPI` float   DEFAULT NULL, 
	`ValorTotal` float   DEFAULT NULL, 
	`NotaFiscal` char(7)   DEFAULT NULL, 
...
CREATE TABLE ORDEMCOMPRA (
	...
	`NrControle` char(10)   DEFAULT NULL, 
...
CREATE TABLE PARAMETROS (
	...
	`CondPagamentoLocacao` int   DEFAULT NULL, 
	`BloqClieAutomatico` int(1)   DEFAULT NULL, 
	`EspecieMercadoria` varchar(20)   DEFAULT NULL, 
	`MarcaMercadoria` varchar(20)   DEFAULT NULL, 
	`TIPO_MOV_LOCACAO_ENTRADA` int   DEFAULT NULL, 
	`TIPO_MOV_LOCACAO_SAIDA` int   DEFAULT NULL, 
	`TIPO_MOV_TROCA_ENTRADA` int   DEFAULT NULL, 
	`TIPO_MOV_TROCA_SAIDA` int   DEFAULT NULL, 
	...
	`TipoMovCilindroEntrada` int   DEFAULT NULL, 
	`TipoMovCilindroSaida` int   DEFAULT NULL, 
	...
	`NaoCalculaDevolucaoCarteira` int(1)   DEFAULT NULL, 
	`VerificaFilialCarteira` int(1)   DEFAULT NULL, 
	`ControlaCorTamanhoCarteira` int(1)   DEFAULT NULL, 
	...
	`PercVendaMenorCustoProducao` float   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `Parametros_Locacao`;
CREATE TABLE Parametros_Locacao (
	`Grupo` int NOT NULL  , 
	`Sequencia` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `Parametros_Lastro`;
CREATE TABLE Parametros_Lastro (
	`Filial` int NOT NULL  , 
	`InventarioE` int   DEFAULT NULL, 
	`InventarioS` int   DEFAULT NULL, 
	`TransferenciaE` int   DEFAULT NULL, 
	`TransferenciaS` int   DEFAULT NULL, 
	`NotasE` int   DEFAULT NULL, 
	`NotasS` int   DEFAULT NULL, 
	`ClienteRecarga` int   DEFAULT NULL, 
	`ClienteR1` int   DEFAULT NULL, 
	`ClienteR3` int   DEFAULT NULL, 
	`ClienteR4` int   DEFAULT NULL, 
	`ClienteR7` int   DEFAULT NULL, 
	`ClienteR10` int   DEFAULT NULL, 
	`ClienteR11` int   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE Parametros_VendasBalcao (
	...
	`DataBaseFechamento` datetime   DEFAULT NULL, 
	...
	`VendedorConsumidor` int   DEFAULT NULL, 
	`TipoNFConsumidor` int   DEFAULT NULL, 
	`TaxaServicoConsumidor` float   DEFAULT NULL, 
	`CondPagamentoConsumidor` int   DEFAULT NULL, 
	`ClienteConsumidor` int   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `ParametrosRegiao`;
CREATE TABLE ParametrosRegiao (
	`Filial` int NOT NULL  , 
	`Regiao` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `ParametrosNFe_OLD`;
CREATE TABLE ParametrosNFe_OLD (
	`Filial` int NOT NULL  , 
...
DROP TABLE IF EXISTS `REL_EtiquetasVendas`;
CREATE TABLE REL_EtiquetasVendas (
	`ID` int NOT NULL  , 
	`FILIAL` int NOT NULL  , 
	`ITEM` int NOT NULL  , 
	`DESCRICAO` varchar(300)   DEFAULT NULL, 
	...
	`QTDEPARCELAS` tinyint   DEFAULT NULL, 
...
CREATE TABLE setor (
	`id` bigint NOT NULL  , 
	`descricao` varchar(30)   DEFAULT NULL, 
	`id_representante` bigint   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `SetorExame`;
CREATE TABLE SetorExame (
	`Setor` int NOT NULL  , 
	`Exame` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `SetorTreinamento`;
CREATE TABLE SetorTreinamento (
	`Setor` int NOT NULL  , 
	`Treinamento` int NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Tab_EstadoCivil`;
CREATE TABLE Tab_EstadoCivil (
	`Codigo` int NOT NULL  , 
	`Descricao` varchar(100)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Tab_ImoveisIPTU`;
CREATE TABLE Tab_ImoveisIPTU (
	`Imovel` int NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	`IPTU` varchar(50)   DEFAULT NULL, 
	`Valor` float   DEFAULT NULL, 
	`Inscricao_Cadastral` varchar(15)   DEFAULT NULL, 
...
CREATE TABLE Tab_SetorPrincipal (
	...
	`HORAATUALIZACAO` char(8)   DEFAULT NULL, 
	`USUARIOATUALIZACAO` char(3)   DEFAULT NULL, 
	`HoraDepreciacao` float   DEFAULT NULL, 
	`HoraEnergia` float   DEFAULT NULL, 
	`HoraManutencao` float   DEFAULT NULL, 
	`HoraAdministracao` float   DEFAULT NULL, 
	`NaoCalcularCMV` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `Tab_TipoMovimentacao`;
CREATE TABLE Tab_TipoMovimentacao (
	`Codigo` int NOT NULL  , 
	`Descricao` char(50)   DEFAULT NULL, 
	`TipoMovimentacao` char(2)   DEFAULT NULL, 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` char(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `TabDocumento`;
CREATE TABLE TabDocumento (
	`Documento` int NOT NULL  , 
	`Descricao` varchar(50)   DEFAULT NULL, 
	`Validade` int   DEFAULT NULL, 
	`AvisoVencimento` int   DEFAULT NULL, 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` char(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `TabExame`;
CREATE TABLE TabExame (
	`Exame` int NOT NULL  , 
	`Descricao` varchar(50)   DEFAULT NULL, 
	`Validade` int   DEFAULT NULL, 
	`AvisoVencimento` int   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `TabGasesCilindro`;
CREATE TABLE TabGasesCilindro (
	`CodCilindro` int NOT NULL  , 
	`CodGas` int NOT NULL  , 
	`Sequencia` int NOT NULL  , 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `TabTreinamento`;
CREATE TABLE TabTreinamento (
	`Treinamento` int NOT NULL  , 
	`Descricao` varchar(50)   DEFAULT NULL, 
	`Validade` int   DEFAULT NULL, 
	`TipoCarteira` char(1)   DEFAULT NULL, 
	`Mandatario` int(1)   DEFAULT NULL, 
	`AvisoVencimento` int   DEFAULT NULL, 
	`AvisoAgendamento` int   DEFAULT NULL, 
	`DataAtualizacao` datetime   DEFAULT NULL, 
	`HoraAtualizacao` char(8)   DEFAULT NULL, 
	`UsuarioAtualizacao` char(3)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `Temp_Numeracao`;
CREATE TABLE Temp_Numeracao (
	`ITEM` int   DEFAULT NULL, 
	`QUANTIDADE` float   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `TMP_FALHA_EMAIL`;
CREATE TABLE TMP_FALHA_EMAIL (
	`FILIAL` int   DEFAULT NULL, 
	`SERIE` varchar(3)   DEFAULT NULL, 
	`DUPLICATA` varchar(6)   DEFAULT NULL, 
	`CLIENTE` int   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `TMP_BAIXAS`;
CREATE TABLE TMP_BAIXAS (
	`FILIAL` int   DEFAULT NULL, 
	`SERIE` char(3)   DEFAULT NULL, 
	`CLIENTE` int   DEFAULT NULL, 
	`DUPLICATA` varchar(10)   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `view_ItemMovimentacao`;
CREATE TABLE view_ItemMovimentacao (
	`FILIAL` int NOT NULL  , 
	`ITEM` int   DEFAULT NULL, 
	`DATA_MOVIMENTO` datetime   DEFAULT NULL, 
	`COD_MOVIMENTO` int   DEFAULT NULL, 
...
DROP TABLE IF EXISTS `view_DataMovimento`;
CREATE TABLE view_DataMovimento (
	`FILIAL` int NOT NULL  , 
	`ITEM` int   DEFAULT NULL, 
	`DATA_MOVIMENTO` datetime   DEFAULT NULL, 
	`COD_MOVIMENTO` int   DEFAULT NULL
...
CREATE TABLE VENDEDOR (
	...
	`atacadovarejo` int(1)   DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;


DROP TABLE IF EXISTS `view_SaldoCilindroCliente`;
CREATE TABLE view_SaldoCilindroCliente (
	`Filial` int   DEFAULT NULL, 
	`Item` int   DEFAULT NULL, 
	`Cliente` int   DEFAULT NULL, 
	`QuantidadeLocacaoEntrada` float NOT NULL  , 
	`QuantidadeLocacaoSaida` float NOT NULL  , 
	`QuantidadeTrocaSaida` float NOT NULL  , 
	`QuantidadeTrocaEntrada` float NOT NULL  
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
DROP TABLE IF EXISTS `view_MovItens`;
CREATE TABLE view_MovItens (
	`QUANTIDADE` float   DEFAULT NULL, 
	`Estoque_Atual` float   DEFAULT NULL, 
	`FILIAL` int NOT NULL  , 
	`DATA_MOVIMENTO` datetime   DEFAULT NULL, 
