	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				imagem_logo_sm_configurar_site = subvetor[7];
				bem_vindo_configurar_site = subvetor[8];
				data_atualizacao_configurar_site = subvetor[9];
				bool_ativo_configurar_site = subvetor[10];
