...
<div id="header" class="page-navbar">
	...
	<a href="index.html" class="navbar-brand hidden-xs hidden-sm">
		<img src="app/img/logo.png" class="logo hidden-xs" alt="Dynamic logo" width="191px" height="48px;">
		<img src="app/img/logosm.png" class="logo-sm hidden-lg hidden-md" alt="Dynamic logo" width="auto" height="48px;">
	</a>
	<!-- / navbar-brand -->
	<!-- .no-collapse -->
	<div id="navbar-no-collapse" class="navbar-no-collapse">
		...
		<ul class="nav navbar-nav">
			...
			<li>
				<a href="#" class="reset-layout tipB" title="Reset panel position for this page">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li>
				<a href="#" title="Sair" onclick="deslogar()">
