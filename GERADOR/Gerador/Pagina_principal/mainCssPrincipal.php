...
.dark-bg {
  color: #ffffff !important;
  background-color: #3b4655 !important;
}
.dark-light-bg {
  color: #ffffff !important;
...
criarArquivo("../../GeradorProjetos/$projetoNome/app/css/main.css", $mainCss);