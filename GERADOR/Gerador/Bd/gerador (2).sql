...
-- Copiando dados para a tabela gerador.config_login: ~1 rows (aproximadamente)
...
INSERT INTO `config_login` (`id_config_login`, `descricao_config_login`, `imagem_fundo_id`, `imagem_icone_id`, `tabela_login_config_login`, `login_config_login`, `senha_config_login`, `cor_fundo_config_login`, `password_config_login`, `projeto_id`) VALUES
	(21, '11/07/2018 10:57:59', 2, 11, 'usuario', 'login_usuario', 'senha_usuario', '#c8f0c6', 1, 25);
...
-- Copiando dados para a tabela gerador.config_principal: ~9 rows (aproximadamente)
...
INSERT INTO `config_principal` (`id_config_principal`, `projeto_id`, `modelo_cores_menu_id`, `icone_cadastro_config_principa`, `tabelas_cadastro_config_principa`, `logoLg_config_principa`, `logoSm_config_principa`, `bool_upload_config_principa`) VALUES
	(12, 23, 2, '\n						\n						\n						\n						\n						<i class="fa fa-list" aria-hidden="true"></i>																				', 'grupo+item+lanc_preco+marca+orcamento+supermercado', 'LogotipoFinal.png', 'LogotipoFinal.png', 1);
INSERT INTO `config_principal` (`id_config_principal`, `projeto_id`, `modelo_cores_menu_id`, `icone_cadastro_config_principa`, `tabelas_cadastro_config_principa`, `logoLg_config_principa`, `logoSm_config_principa`, `bool_upload_config_principa`) VALUES
...
INSERT INTO `config_principal` (`id_config_principal`, `projeto_id`, `modelo_cores_menu_id`, `icone_cadastro_config_principa`, `tabelas_cadastro_config_principa`, `logoLg_config_principa`, `logoSm_config_principa`, `bool_upload_config_principa`) VALUES
	(14, 25, 1, '\n						<i class="fa fa-list" aria-hidden="true"></i>					', 'adicional_site+cliente_site+configurar_site+contato+empresa+estado+grupo+item+quem_somos+saiba_mais+videos', 'LogotipoFinal.png', 'LogotipoFinal.png', 1);
...
-- Copiando dados para a tabela gerador.grade: ~65 rows (aproximadamente)
DELETE FROM `grade`;
...
-- Copiando dados para a tabela gerador.logica_negocio: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela gerador.projetos: ~17 rows (aproximadamente)
...
INSERT INTO `projetos` (`id_projeto`, `nome`, `host`, `user`, `pws`, `bancoDados`, `versao`, `bool_ativo`) VALUES
	(25, 'admin_SJT', 'localhost', 'root', '', 'sjt', '1.5.1.1', 1);
...
-- Copiando dados para a tabela gerador.tabela_algoritimo_exe_item: ~20 rows (aproximadamente)
