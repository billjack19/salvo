...
$classeNomeViewCadastro = "adicionar_grade_".$nomeTabela."-".$arrayTabelaGrade[0];
...
<script type=\"text/javascript\" src=\"app/js/combo/".$tabelaEstrangeira."ComboGrade.js\"></script>";	
	...
	<input type=\"text\" class=\"form-control\" id=\"$nomeCampoOriginal\" disabled>";
			...
			$inputDefinido = "<button onclick=\"chamarModalImagem('$nomeCampoOriginal', '$classeNomeViewCadastro', 'video')\" class=\"btn\" $accesskeyInicial>
		Selecionar Vídeo
	</button>
	<input type=\"text\" class=\"form-control\" id=\"$nomeCampoOriginal\" disabled>";
		}
			...
			$inputDefinido = "<button onclick=\"chamarModalImagem('$nomeCampoOriginal', '$classeNomeViewCadastro', 'audio')\" class=\"btn\" $accesskeyInicial>
		Selecionar Áudio
	</button>
	<input type=\"text\" class=\"form-control\" id=\"$nomeCampoOriginal\" disabled>";
		}
			...
			$inputDefinido = "<button onclick=\"chamarModalImagem('$nomeCampoOriginal', '$classeNomeViewCadastro', 'text')\" class=\"btn\" $accesskeyInicial>
...
<script type=\"text/javascript\">
	verificaAcess('".$nomeTable."-".$arrayTabelaGrade[0]."', 'I');
</script>
...
";
		...
		$nomeArquivos .= $contArq == 1 ? $classeNomeViewCadastro : "+".$classeNomeViewCadastro;
	}
}
