...
$classeNomeViewAtualiza = "editar_".$nomeTabela;
...
<script type=\"text/javascript\" src=\"app/js/combo/".$tabelaEstrangeira."ComboGrade.js\"></script>";
		...
		<option value=\"0\">Não</option>
			...
			$inputDefinido = "<button onclick=\"chamarModalImagem('$nomeCampoOriginal', '$nomeTabela', 'img')\" class=\"btn\" $accesskeyInicial>
		Selecionar Imagem
	</button>
