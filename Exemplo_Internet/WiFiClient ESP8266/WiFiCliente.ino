 ...
 * http://josecintra.com/blog/esp8266-bancos-dados-requisicoes-http/
 */ 
...
const char http_site[] = "http://192.168.1.102";
const int http_port = 80;
 
// Variáveis globais
WiFiClient client;
IPAddress server(192,168,1,102); //Endereço IP do servidor - http_site
int pinDHT11 = D1;
SimpleDHT11 dht11;
