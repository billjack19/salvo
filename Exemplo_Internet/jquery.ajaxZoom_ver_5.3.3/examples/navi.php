...
if (!isset($displayHome)) {
	if (!stristr($currentExample, '34')) {
		$homeButton = '<a href="https://www.ajax-zoom.com">
		<img class="aze_example_navi_buttons" src="../axZm/icons/home-icon.png" border="0" style="margin-left: 25px" alt="HOME" title="HOME">
		</a>';
	}

	if ($isAjaxZoomCom) {
		$homeButton .= '<a href="https://www.ajax-zoom.com/examples/">
		<img class="aze_example_navi_buttons" src="../axZm/icons/overview_48x48.png" border="0" style="margin-left: 5px" alt="Examples overview" title="Examples overview">
		</a>';
	} else {
		$homeButton .= '<a href="index.php">
	...
	if ($isAjaxZoomCom) {
		$homeButton .= '<a href="https://www.ajax-zoom.com/index.php?cid=download">
		<img class="aze_example_navi_buttons" src="../axZm/icons/download_48x48.png" border="0" style="margin-left:5px" alt="Download" title="Download">
		</a>';
	} else {
		$homeButton .= '<a href="https://www.ajax-zoom.com/index.php?cid=download" target="_blank">
	...
	$homeButton .= '<a href="https://www.ajax-zoom.com/index.php?cid=contact">
