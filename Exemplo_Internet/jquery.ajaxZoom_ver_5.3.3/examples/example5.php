...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h1 class="page-header">AJAX-ZOOM - responsive thumbnails gallery with ajax page switch</h1>
		</div>
		<div class="col-md-12">
			<p style="margin-top: 40px;">Ver. 4.2.1+ This example has been totally rewritten. It does not contain indispensable PHP code within the actual page any more. 
				Also all JavaScript has been wrapped into one plugin (jQuery.axZm.thumbGallery, which is controllable over various options passed to it. 
			</p>
			<p>With the below configurations the plugin gets all image paths from 
				...
				When the user clicks on a thumb, the AJAX-ZOOM image player with high-resolution image opens 
				in a configurable lightbox (Fancybox / colorbox) or at fullscreen. 
				Instead of "zoomDir" option, you can also define the image paths from various directories...
			</p>
...
<div id="thumbsParentContainer" class="clearfix" style="min-height: 150px; clear: both"></div>
			...
			<h3>JavaScript</h3>
			<div style="clear:both; margin: 5px 0px 5px 0px;">
				<pre class="brush: js;"><code class="language-js" id="exampleJsPrism"></code></pre>
			</div>
