	...
	<body>
		<div class="aze_example_navi_container">
			<div style="padding: 5px 0px 0px 5px">
				<a href="https://www.ajax-zoom.com"><img class="aze_example_navi_buttons" title="HOME" alt="HOME" src="../axZm/icons/home-icon.png"></a>
				<a href="https://www.ajax-zoom.com/index.php?cid=download"><img class="aze_example_navi_buttons" title="Download AJAX-ZOOM" alt="Download AJAX-ZOOM" src="../axZm/icons/download_48x48.png"></a>
				<a href="https://www.ajax-zoom.com/index.php?cid=docs"><img class="aze_example_navi_buttons" title="Documentaion" alt="Documentaion" src="../axZm/icons/docu_48x48.png"></a>
				<a href="https://www.ajax-zoom.com/index.php?cid=contact"><img class="aze_example_navi_buttons" title="Ask a question" alt="Ask a question" src="../axZm/icons/support_48x48.png"></a>
			</div>
		</div>
		...
		<div class="container-fluid">
			...
			<div class="exampleImgOuter">
				...
				if (!empty($files)) {
					...
					foreach ($files as $k => $file) {
						...
						if (strstr($file, 'example') && strstr($file, 'php')) {
							...
							if ($isAjaxZoomCom) {
								$exampleThumb = 'https://www.ajax-zoom.com/pic/layout/thumbs/'.$thumbName;
							} else {
							...
							echo '<a href="'.basename($file).($isVario ? '?zoomDir=/pic/zoom/animals' : '').'" class="exampleImg" >
				...
				if ($isAjaxZoomCom && file_exists($_SERVER['DOCUMENT_ROOT'].'/admin/google.php')){
