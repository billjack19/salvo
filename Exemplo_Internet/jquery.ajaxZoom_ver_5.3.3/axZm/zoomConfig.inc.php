...
$zoom['config']['fullScreenExitText'] = array(
    'en' => 'Press ESC to exit full screen mode',
    'de' => 'Drücken Sie ESC, um den Vollbildmodus zu beenden',
    'fr' => 'Appuyez sur ÉCHAP pour quitter le mode plein écran',
    'es' => 'Presione ESC para salir del modo de pantalla completa',
    'it' => 'Premere ESC per uscire dalla modalità a schermo intero',
    'pt' => 'Pressione ESC para sair do modo de tela cheia',
    'ru' => 'Нажмите ESC для выхода из полноэкранного режима',
    'pl' => 'Naciśnij ESC, aby wyjść z trybu pełnoekranowego',
    'nl' => 'Druk op ESC om de modus Volledig scherm af te sluiten',
    'cn' => '按ESC退出全屏模式',
    'jp' => 'ESCを押して全画面モードを終了する'
);
...
// For more information please refere to: https://www.w3.org/QA/2002/04/valid-dtd-list.html
