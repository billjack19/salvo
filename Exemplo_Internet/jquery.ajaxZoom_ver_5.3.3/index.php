            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    if (!defined('PHALANGER')) {
                        ...
                        if (!$ionCube) {
                            ...
                            <a href="https://www.ioncube.com/loaders.php" target="_blank">https://www.ioncube.com/loaders.php</a>
                            ';
                    ...
                    if (!$error) {
                        ...
                        <div style="border-color: green" class="alert">
                            ...
                            <ul>
                                <li><a href="https://www.ajax-zoom.com/index.php?cid=docs#installPath" target="_blank">$zoom['config']['installPath']</a><br><br>
                                    Replace:<br>
                                ...
                                <li><a href="https://www.ajax-zoom.com/index.php?cid=docs#fpPP" target="_blank">$zoom['config']['fpPP']</a><br><br>
                                ...
                                <li><a href="https://www.ajax-zoom.com/index.php?cid=docs#rewriteBase" target="_blank">$zoom['config']['rewriteBase']</a><br><br>
                        ...
                        <p>In order to change the button template into your own (skin AJAX-ZOOM) 
                            simply set <a href="https://www.ajax-zoom.com/index.php?cid=docs#buttonSet" target="_blank">$zoom['config']['buttonSet']</a> option,  
                            ...
                            For CSS colors an so on you can change <a href="https://www.ajax-zoom.com/index.php?cid=docs#themeCss" target="_blank">$zoom['config']['themeCss']</a> option; 
                        ...
                        <p>Every image must have an unique filename!!! This is also the case if images are prepared for completely different 360s or 3D; 
                        ...
                        <p>The only difference between regular 360 spin and multirow is that original images are placed in subfolders of the target folder. 
                            ...
                            file structure see <a href="examples/example28.php">example28.php</a>
                        </p>
                ...
                <div class="col-lg-6">
                    ...
                    <p>Local examples do not contain high-resolution images. 
                        ...
                        <a href="https://www.ajax-zoom.com/index.php?cid=examples" target="_blank">https://www.ajax-zoom.com/index.php?cid=examples</a>
                    </p>
                        ...
                        if (!empty($files)) {
                            foreach (array_reverse($files, true) as $k => $file) {
                                if (strstr($file,'example') && strstr($file,'php')) {
                                    ...
                                    echo '<a href="examples/'.basename($file).($isVario ? '?zoomDir=/pic/zoom/animals' : '').'" class="exampleImg" target="_blank">
