...
-- Copiando estrutura para tabela questionario.respota_item
CREATE TABLE IF NOT EXISTS `respota_item` (
  `respota_item` int(11) NOT NULL AUTO_INCREMENT,
  `resposta_id` int(11) NOT NULL,
  `pergunta_id` int(11) NOT NULL,
  `alternativas_id` int(11) NOT NULL,
  PRIMARY KEY (`respota_item`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela questionario.respota_item: ~0 rows (aproximadamente)
DELETE FROM `respota_item`;
/*!40000 ALTER TABLE `respota_item` DISABLE KEYS */;
/*!40000 ALTER TABLE `respota_item` ENABLE KEYS */;
