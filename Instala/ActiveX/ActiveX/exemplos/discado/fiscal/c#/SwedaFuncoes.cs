...
namespace ECFSweda
{
	...
	{	
		...
		#region IMPORT DAS FUNÇÕES DA CONVECF.DLL
		/*
		 ===============================================================================
			********************************************************************************
		...
		*/
		...
		/// <summary>
		/// Faz a abertura do caixa emitindo um suprimento e uma leitura X. Essa função grava o COO inicial e o Grande Total inicial que serão usados na função ECF_RelatorioTipo60Mestre. Portanto, se você for emitir o relatório "tipo 60 mestre" é obrigatório o uso dessa função.
		/// </summary>
		...
		/// <summary>
		/// Faz o fechamento do dia emitindo uma Redução Z. Essa função grava o COO final e o Grande Total final que serão usados na função ECF_RelatorioTipo60Mestre.
		/// </summary>
		/// <returns>INTEIRO - Indica se a função conseguiu enviar o comando para impressora.</returns>
		...
		/// <summary>
		/// Emite um cupom de conferência de mesa. Essa função reúne as funções ECF_AbreConferenciaMesa e ECF_FechaConferenciaMesa. Ela abre e fecha o cupom de conferência não permitindo registrar produtos nesse cupom de conferência.
		/// </summary>
		/// <param name="Mesa">STRING com o número da Mesa com até 4 dígitos.</param>
