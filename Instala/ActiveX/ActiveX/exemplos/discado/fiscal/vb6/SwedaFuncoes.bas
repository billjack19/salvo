Attribute VB_Name = "SwedaFuncoes"
...
Public Declare Function ECF_ImpressaoCarne Lib "CONVECF.DLL" (ByVal titulo, ByVal Percelas As String, ByVal _
                        datas, ByVal _
...
Public Declare Function ECF_CancelaCupomMFD Lib "CONVECF.DLL" (ByVal CGC, ByVal Nome, ByVal Endereco As String) As Integer
Public Declare Function ECF_ProgramaFormaPagamentoMFD Lib "CONVECF.DLL" (ByVal FormaPagto, ByVal OperacaoTef As String) As Integer
Public Declare Function ECF_EfetuaFormaPagamentoMFD Lib "CONVECF.DLL" (ByVal FormaPagamento, ByVal ValorFormaPagamento, ByVal Parcelas, ByVal DescricaoFormaPagto As String) As Integer
Public Declare Function ECF_CupomAdicionalMFD Lib "CONVECF.DLL" () As Integer
Public Declare Function ECF_AcrescimoDescontoItemMFD Lib "CONVECF.DLL" (ByVal Item, ByVal AcrescimoDesconto, ByVal TipoAcrescimoDesconto, ByVal ValorAcrescimoDesconto As String) As Integer
Public Declare Function ECF_NomeiaRelatorioGerencialMFD Lib "CONVECF.DLL" (ByVal Indice, ByVal Descricao As String) As Integer
Public Declare Function ECF_AutenticacaoMFD Lib "CONVECF.DLL" (ByVal Linhas, ByVal texto As String) As Integer
Public Declare Function ECF_AbreComprovanteNaoFiscalVinculadoMFD Lib "CONVECF.DLL" (ByVal FormaPagamento, ByVal valor, ByVal NumeroCupom, ByVal CGC, ByVal Nome, ByVal Endereco As String) As Integer
Public Declare Function ECF_ReimpressaoNaoFiscalVinculadoMFD Lib "CONVECF.DLL" () As Integer
Public Declare Function ECF_AbreRecebimentoNaoFiscalMFD Lib "CONVECF.DLL" (ByVal CGC, ByVal Nome, ByVal Endereco As String) As Integer
Public Declare Function ECF_EfetuaRecebimentoNaoFiscalMFD Lib "CONVECF.DLL" (ByVal IndiceTotalizador, ByVal ValorRecebimento As String) As Integer
Public Declare Function ECF_IniciaFechamentoRecebimentoNaoFiscalMFD Lib "CONVECF.DLL" (ByVal AcrescimoDesconto, ByVal TipoAcrescimoDesconto, ByVal ValorAcrescimo, ByVal ValorDesconto As String) As Integer
Public Declare Function ECF_FechaRecebimentoNaoFiscalMFD Lib "CONVECF.DLL" (ByVal Mensagem As String) As Integer
Public Declare Function ECF_CancelaRecebimentoNaoFiscalMFD Lib "CONVECF.DLL" (ByVal CGC, ByVal Nome, ByVal Endereco As String) As Integer
...
Public Declare Function ECF_EstornoNaoFiscalVinculadoMFD Lib "CONVECF.DLL" (ByVal CGC, ByVal Nome, ByVal Endereco As String) As Integer
...
Public Declare Function ECF_MarcaModeloTipoImpressoraMFD Lib "CONVECF.DLL" (ByVal Marca, ByVal Modelo, ByVal Tipo As String) As Integer
...
Public Declare Function ECF_LeituraMemoriaFiscalDataMFD Lib "CONVECF.DLL" (ByVal DataInicial, ByVal DataFinal, ByVal FlagLeitura As String) As Integer
Public Declare Function ECF_LeituraMemoriaFiscalReducaoMFD Lib "CONVECF.DLL" (ByVal ReducaoInicial, ByVal ReducaoFinal, ByVal FlagLeitura As String) As Integer
Public Declare Function ECF_LeituraMemoriaFiscalSerialDataMFD Lib "CONVECF.DLL" (ByVal DataInicial, ByVal DataFinal, ByVal FlagLeitura As String) As Integer
Public Declare Function ECF_LeituraMemoriaFiscalSerialReducaoMFD Lib "CONVECF.DLL" (ByVal ReducaoInicial, ByVal ReducaoFinal, ByVal FlagLeitura As String) As Integer
...
Public Declare Function ECF_AbreBilhetePassagemMFD Lib "CONVECF.DLL" (ByVal Embarque, ByVal _
...
Public Declare Function ECF_CancelaAcrescimoDescontoItemMFD Lib "CONVECF.DLL" (ByVal cFlag, ByVal cItem As String) As Integer
...
Public Declare Function ECF_AcrescimoDescontoSubtotalRecebimentoMFD Lib "CONVECF.DLL" (ByVal cFlag, ByVal cTipo, ByVal cValor As String) As Integer
Public Declare Function ECF_AcrescimoDescontoSubtotalMFD Lib "CONVECF.DLL" (ByVal cFlag, ByVal cTipo, ByVal cValor As String) As Integer
...
Public Declare Function ECF_InicioFimCOOsMFD Lib "CONVECF.DLL" (ByVal cCOOIni, ByVal cCOOFim As String) As Integer
Public Declare Function ECF_InicioFimGTsMFD Lib "CONVECF.DLL" (ByVal cGTIni, ByVal cGTFim As String) As Integer
