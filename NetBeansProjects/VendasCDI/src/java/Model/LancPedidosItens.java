...
public class LancPedidosItens {
    ...
    public int getLancPedidoId() {
        return lancPedidoId;
    }

    public void setLancPedidoId(int lancPedidoId) {
        this.lancPedidoId = lancPedidoId;
    }
    ...
    public LancPedidosItens() {
    }

    public LancPedidosItens(int idLancPedido, int lancPedidoId, int filial, String documento, int sequencia, int item, float quantidade, float valorUnitario, float valorTotal) {
        this.idLancPedido = idLancPedido;
        this.lancPedidoId = lancPedidoId;
        this.filial = filial;
        this.documento = documento;
