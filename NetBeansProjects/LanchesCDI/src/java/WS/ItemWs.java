...
public class ItemWs {
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("listarTodosItem/{filial}")
    public String listarTodosItens(@PathParam("filial")int filial) throws SQLException{
        Gson g = new Gson();
        ItemDao _ItemDao = new ItemDao();
        List<Item> _Item = _ItemDao.listarTodosItens(filial);
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("listarItemCodigo/{item}/{filial}")
    public String listarItemCodigo(
            @PathParam("item")int item,
            @PathParam("filial")int filial 
    ) throws SQLException{
        Gson g = new Gson();
        ItemDao _ItemDao = new ItemDao();
        List<Item> _Item = _ItemDao.itemCodigo(item, filial);
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("listarLancPedidoItemAdicionalSPreco/{id}")
    public String listarLancPedidoItemAdicionalSPreco(
            @PathParam("id")int id
    ) throws SQLException{
        ItemDao _ItemDao = new ItemDao();
        return _ItemDao.listarLancPedidosItensAdicionalSPreco(id);
    }
    /* *************************************************************************************** */
    ...
    public String excluirLancPedidosItens(
        ...
        Gson g = new Gson();
        ItemDao _ItemDao = new ItemDao();
        return _ItemDao.removerItem(filial, documento, sequencia);
    ...
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("setarAdicionalProduto/{id}")
    public String setarAdicionalProduto(
            @PathParam("id")int id
    ) throws SQLException{
        ItemDao _ItemDao = new ItemDao();
        if(_ItemDao.setarAdicionalProduto(id)) return "1";
        else return "0";
    }
