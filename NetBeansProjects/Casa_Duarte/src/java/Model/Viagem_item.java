...
public class Viagem_item {
    ...
    public void setIndicePosicao(int indicePosicao) {
        this.indicePosicao = indicePosicao;
    }

    public String getEndEntregaItem() {
        return endEntregaItem;
    }

    public void setEndEntregaItem(String endEntregaItem) {
        this.endEntregaItem = endEntregaItem;
    }
