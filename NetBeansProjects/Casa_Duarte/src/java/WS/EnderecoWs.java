...
public class EnderecoWs {
    ...
    /* ESTA FUNÇÃO DOIS ELA RETORNA OS PEDIDOS QUE ESTÃO PNDENTES */
    @GET
    @Produces(MediaType.APPLICATION_JSON)
    @Path("listar2")
    public String getEnderecosPendentes2() throws SQLException{
        Gson g = new Gson();
        EnderecoDao _EnderecoDao = new EnderecoDao();
        List<Endereco> Enderecos = _EnderecoDao.retonaEnderecosPendentes2();
    ...
    public String inserirLancPedidosItens(String content){
        ...
        /*{"codigo":"10+ENC+015354","latitude":-21.787227,"longitude":-46.56129000000001}*/
        /*{"codigo":"10+ENC+015354","latitude":-21.787227,"longitude":-46.56129000000001}*/
    }
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Path("/inserir2")
    public String inserirLancPedidosItens2(String content){
        Gson g = new Gson();
        Endereco _Endereco = (Endereco) g.fromJson(content, Endereco.class);
        
        EnderecoDao _EnderecoDao = new EnderecoDao();
        return _EnderecoDao.setGeocodificacao2(_Endereco);
