...
-- Copiando dados para a tabela compras_jk_19.area_nivel_acesso: ~14 rows (aproximadamente)
...
-- Copiando dados para a tabela compras_jk_19.item: ~2 rows (aproximadamente)
DELETE FROM `item`;
/*!40000 ALTER TABLE `item` DISABLE KEYS */;
INSERT INTO `item` (`id_item`, `descricao_item`, `codigo_item`, `grupo_id`, `data_atualizacao_item`, `usuario_id`, `bool_ativo_item`) VALUES
...
-- Copiando dados para a tabela compras_jk_19.marca: ~4 rows (aproximadamente)
DELETE FROM `marca`;
...
-- Copiando dados para a tabela compras_jk_19.supermercado: ~4 rows (aproximadamente)
