...
DROP DATABASE IF EXISTS `compras_jk_19`;
...
-- Copiando dados para a tabela compras_jk_19.compra: ~1 rows (aproximadamente)
DELETE FROM `compra`;
...
-- Copiando dados para a tabela compras_jk_19.equivalentes: ~2 rows (aproximadamente)
...
INSERT INTO `equivalentes` (`id_equivalentes`, `codigo_equivalentes`, `especificacao_equivalentes`, `item_id`, `data_atualizacao_equivalentes`, `usuario_id`, `bool_ativo_equivalentes`) VALUES
	...
	(2, '7791293028781', 'BLACK', 7, '2018-08-03 01:04:37', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.item: ~7 rows (aproximadamente)
DELETE FROM `item`;
...
INSERT INTO `item` (`id_item`, `descricao_item`, `marca_id`, `quantidade_item`, `unidade_medida_id`, `grupo_id`, `data_atualizacao_item`, `usuario_id`, `bool_ativo_item`) VALUES
	...
	(7, 'Desodorante Bodyspray', 10, 150, 6, 1, '2018-08-03 01:04:35', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.lanc_preco: ~9 rows (aproximadamente)
...
INSERT INTO `lanc_preco` (`id_lanc_preco`, `supermercado_id`, `item_id`, `marca_id`, `preco_lanc_preco`, `data_atualizacao_lanc_preco`, `usuario_id`, `bool_ativo_lanc_preco`) VALUES
	...
	(3, 0, 7, 10, 0, '2018-08-03 01:04:36', 1, 1),
	(4, 1, 7, 10, 0, '2018-08-03 01:04:36', 1, 1),
	(5, 2, 7, 10, 0, '2018-08-03 01:04:36', 1, 1),
	(6, 3, 7, 10, 0, '2018-08-03 01:04:37', 1, 1),
	(7, 4, 7, 10, 0, '2018-08-03 01:04:37', 1, 1),
	(8, 5, 7, 10, 0, '2018-08-03 01:04:37', 1, 1),
	(9, 6, 7, 10, 0, '2018-08-03 01:04:37', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.marca: ~10 rows (aproximadamente)
DELETE FROM `marca`;
...
INSERT INTO `marca` (`id_marca`, `descricao_marca`, `data_atualizacao_marca`, `usuario_id`, `bool_ativo_marca`) VALUES
	...
	(10, 'AXE', '2018-08-03 01:04:05', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.nivel_acesso: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela compras_jk_19.orcamento: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela compras_jk_19.pedido: ~1 rows (aproximadamente)
DELETE FROM `pedido`;
...
CREATE TABLE IF NOT EXISTS `pedido_item` (
  ...
  `item_id` int(11) NOT NULL,
  `codigo_item_pedido_item` varchar(50) NOT NULL,
...
INSERT INTO `pedido_item` (`id_pedido_item`, `item_id`, `codigo_item_pedido_item`, `quantidade_pedido_item`, `valor_unitario_pedido_item`, `total_pedido_item`, `pedido_id`, `supermercado_id`, `data_atualizacao_pedido_item`, `usuario_id`, `bool_ativo_pedido_item`) VALUES
	(1, 4, '0', 13, 3.5, 45.5, 1, 3, '2018-07-30 15:57:57', 1, 1);
