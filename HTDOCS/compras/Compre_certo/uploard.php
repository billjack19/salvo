...
$_SESSION['statusUp'] = "Setar chmod na pasta <br />";
chmod($_UP['pasta'], 0755);
...
if($_FILES['arquivo']['error'] != 0){
	$_SESSION['statusUp'] = "Não foi possivel fazer o upload, erro: <br />". $_UP['erros'][$_FILES['arquivo']['error']];
...
if(array_search($extensao, $_UP['extensoes'])=== false){$_SESSION['statusUp'] = "Extenção inválida<br />";}
//Faz a verificação do tamanho do arquivo
else if ($_UP['tamanho'] < $_FILES['arquivo']['size']) {$_SESSION['statusUp'] = "Arquivo muito grande 200mb<br />";}
//O arquivo passou em todas as verificações, hora de tentar move-lo para a pasta foto
	...
	if(move_uploaded_file($_FILES['arquivo']['tmp_name'], $_UP['pasta'] . $nome_final)){
		...
		$_SESSION['statusUp'] = "Falha ao fazer upload! <br />";
	}
}
