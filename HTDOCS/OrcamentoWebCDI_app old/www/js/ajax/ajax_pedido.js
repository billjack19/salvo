	...
	$.ajax({
		...
		if(pedido_Global.length == 0) {
			...
			for (var i = pedido_Global.length - 1; i >= 0; i--) {
				...
				conteudo += "<tr style='border-top-style:solid;' bgcolor='"+corLinha+"' name='linhaPedido"+i+"'>";
				...
				conteudo += "<tr bgcolor='"+corLinha+"' name='linhaPedido"+i+"'>";
		...
		conteudo += "<div class='menuLegenda'>"
					...
					+ 		"<tr>"
					+ 			"<td>"
					+ 				"<div class='legenda' style='background-color: #5cb85c;'></div> "
					+ 			"</td>"
					+ 			"<td>"
					+ 				"OK &nbsp;&nbsp;&nbsp;&nbsp;"
					+ 			"</td>"
					+ 			"<td>"
					+ 				"<div class='legenda' style='background-color: #f0ad4e;'></div> "
					+ 			"</td>"
					+ 			"<td>"
					+				"Incompleto"
					+ 			"</td>"
					+ 			"<td>"
					+ 				"<div class='legenda' style='background-color: #d9534f;'></div> "
					+ 			"</td>"
					+ 			"<td>"
					+ 				"Cancelado"
					+ 			"</td>"
