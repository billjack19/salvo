...
// Create page object
$area_nivel_acesso_add = new area_nivel_acesso_add();

// Run the page
$area_nivel_acesso_add->run();
...
$area_nivel_acesso_add->Page_Render();
?>
...
var farea_nivel_acessoadd = currentForm = new ew.Form("farea_nivel_acessoadd", "add");

// Validate form
farea_nivel_acessoadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($area_nivel_acesso_add->area_area_nivel_acesso->Required) { ?>
		...
		<?php } ?>
		<?php if ($area_nivel_acesso_add->demostrativo_area_nivel_acesso->Required) { ?>
		...
		<?php } ?>
		<?php if ($area_nivel_acesso_add->bool_list_area_nivel_acesso->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->bool_insert_area_nivel_acesso->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->bool_update_area_nivel_acesso->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->nivel_acesso_id->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->data_atualizacao_area_nivel_acesso->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->usuario_id->Required) { ?>
		...
		<?php if ($area_nivel_acesso_add->bool_ativo_area_nivel_acesso->Required) { ?>
...
farea_nivel_acessoadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
farea_nivel_acessoadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $area_nivel_acesso_add->showPageHeader(); ?>
<?php
$area_nivel_acesso_add->showMessage();
?>
<form name="farea_nivel_acessoadd" id="farea_nivel_acessoadd" class="<?php echo $area_nivel_acesso_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($area_nivel_acesso_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $area_nivel_acesso_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="area_nivel_acesso">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$area_nivel_acesso_add->IsModal ?>">
...
<?php if ($area_nivel_acesso->area_area_nivel_acesso->Visible) { // area_area_nivel_acesso ?>
	<div id="r_area_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_area_area_nivel_acesso" for="x_area_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->area_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->area_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->area_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->demostrativo_area_nivel_acesso->Visible) { // demostrativo_area_nivel_acesso ?>
	<div id="r_demostrativo_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_demostrativo_area_nivel_acesso" for="x_demostrativo_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->demostrativo_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->demostrativo_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->demostrativo_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->bool_list_area_nivel_acesso->Visible) { // bool_list_area_nivel_acesso ?>
	<div id="r_bool_list_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_bool_list_area_nivel_acesso" for="x_bool_list_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->bool_list_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->bool_list_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->bool_list_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->bool_insert_area_nivel_acesso->Visible) { // bool_insert_area_nivel_acesso ?>
	<div id="r_bool_insert_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_bool_insert_area_nivel_acesso" for="x_bool_insert_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->bool_insert_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->bool_insert_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->bool_insert_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->bool_update_area_nivel_acesso->Visible) { // bool_update_area_nivel_acesso ?>
	<div id="r_bool_update_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_bool_update_area_nivel_acesso" for="x_bool_update_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->bool_update_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->bool_update_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->bool_update_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->nivel_acesso_id->Visible) { // nivel_acesso_id ?>
	<div id="r_nivel_acesso_id" class="form-group row">
		<label id="elh_area_nivel_acesso_nivel_acesso_id" for="x_nivel_acesso_id" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->nivel_acesso_id->caption() ?><?php echo ($area_nivel_acesso->nivel_acesso_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->nivel_acesso_id->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->data_atualizacao_area_nivel_acesso->Visible) { // data_atualizacao_area_nivel_acesso ?>
	<div id="r_data_atualizacao_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_data_atualizacao_area_nivel_acesso" for="x_data_atualizacao_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->data_atualizacao_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->data_atualizacao_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->data_atualizacao_area_nivel_acesso->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_area_nivel_acesso_usuario_id" for="x_usuario_id" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->usuario_id->caption() ?><?php echo ($area_nivel_acesso->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->usuario_id->cellAttributes() ?>>
...
<?php if ($area_nivel_acesso->bool_ativo_area_nivel_acesso->Visible) { // bool_ativo_area_nivel_acesso ?>
	<div id="r_bool_ativo_area_nivel_acesso" class="form-group row">
		<label id="elh_area_nivel_acesso_bool_ativo_area_nivel_acesso" for="x_bool_ativo_area_nivel_acesso" class="<?php echo $area_nivel_acesso_add->LeftColumnClass ?>"><?php echo $area_nivel_acesso->bool_ativo_area_nivel_acesso->caption() ?><?php echo ($area_nivel_acesso->bool_ativo_area_nivel_acesso->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $area_nivel_acesso_add->RightColumnClass ?>"><div<?php echo $area_nivel_acesso->bool_ativo_area_nivel_acesso->cellAttributes() ?>>
...
<?php if (!$area_nivel_acesso_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $area_nivel_acesso_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $area_nivel_acesso_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$area_nivel_acesso_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$area_nivel_acesso_add->terminate();
?>
