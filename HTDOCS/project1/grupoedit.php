...
var fgrupoedit = currentForm = new ew.Form("fgrupoedit", "edit");
...
fgrupoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($grupo_edit->id_grupo->Required) { ?>
			elm = this.getElements("x" + infix + "_id_grupo");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $grupo->id_grupo->caption(), $grupo->id_grupo->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($grupo_edit->descricao_grupo->Required) { ?>
		...
		<?php } ?>
		<?php if ($grupo_edit->imagem_grupo->Required) { ?>
		...
		<?php } ?>
		<?php if ($grupo_edit->data_atualizacao_grupo->Required) { ?>
		...
		<?php if ($grupo_edit->usuario_id->Required) { ?>
		...
		<?php if ($grupo_edit->bool_ativo_grupo->Required) { ?>
...
fgrupoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fgrupoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fgrupoedit" id="fgrupoedit" class="<?php echo $grupo_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($grupo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $grupo_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="grupo">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$grupo_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($grupo->id_grupo->Visible) { // id_grupo ?>
	<div id="r_id_grupo" class="form-group row">
		<label id="elh_grupo_id_grupo" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->id_grupo->caption() ?><?php echo ($grupo->id_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->id_grupo->cellAttributes() ?>>
<span id="el_grupo_id_grupo">
<span<?php echo $grupo->id_grupo->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($grupo->id_grupo->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="grupo" data-field="x_id_grupo" name="x_id_grupo" id="x_id_grupo" value="<?php echo HtmlEncode($grupo->id_grupo->CurrentValue) ?>">
<?php echo $grupo->id_grupo->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($grupo->descricao_grupo->Visible) { // descricao_grupo ?>
	<div id="r_descricao_grupo" class="form-group row">
		<label id="elh_grupo_descricao_grupo" for="x_descricao_grupo" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->descricao_grupo->caption() ?><?php echo ($grupo->descricao_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->descricao_grupo->cellAttributes() ?>>
...
<?php if ($grupo->imagem_grupo->Visible) { // imagem_grupo ?>
	<div id="r_imagem_grupo" class="form-group row">
		<label id="elh_grupo_imagem_grupo" for="x_imagem_grupo" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->imagem_grupo->caption() ?><?php echo ($grupo->imagem_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->imagem_grupo->cellAttributes() ?>>
...
<?php if ($grupo->data_atualizacao_grupo->Visible) { // data_atualizacao_grupo ?>
	<div id="r_data_atualizacao_grupo" class="form-group row">
		<label id="elh_grupo_data_atualizacao_grupo" for="x_data_atualizacao_grupo" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->data_atualizacao_grupo->caption() ?><?php echo ($grupo->data_atualizacao_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->data_atualizacao_grupo->cellAttributes() ?>>
...
<?php if ($grupo->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_grupo_usuario_id" for="x_usuario_id" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->usuario_id->caption() ?><?php echo ($grupo->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->usuario_id->cellAttributes() ?>>
...
<?php if ($grupo->bool_ativo_grupo->Visible) { // bool_ativo_grupo ?>
	<div id="r_bool_ativo_grupo" class="form-group row">
		<label id="elh_grupo_bool_ativo_grupo" for="x_bool_ativo_grupo" class="<?php echo $grupo_edit->LeftColumnClass ?>"><?php echo $grupo->bool_ativo_grupo->caption() ?><?php echo ($grupo->bool_ativo_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $grupo_edit->RightColumnClass ?>"><div<?php echo $grupo->bool_ativo_grupo->cellAttributes() ?>>
...
<?php if (!$grupo_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $grupo_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $grupo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
