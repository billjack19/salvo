...
faudittrailadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php } ?>
		<?php if ($audittrail_add->action->Required) { ?>
...
<?php if ($audittrail->action->Visible) { // action ?>
	<div id="r_action" class="form-group row">
		<label id="elh_audittrail_action" for="x_action" class="<?php echo $audittrail_add->LeftColumnClass ?>"><?php echo $audittrail->action->caption() ?><?php echo ($audittrail->action->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
