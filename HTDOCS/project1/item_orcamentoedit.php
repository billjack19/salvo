...
// Create page object
$item_orcamento_edit = new item_orcamento_edit();

// Run the page
$item_orcamento_edit->run();
...
$item_orcamento_edit->Page_Render();
?>
...
var fitem_orcamentoedit = currentForm = new ew.Form("fitem_orcamentoedit", "edit");

// Validate form
fitem_orcamentoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($item_orcamento_edit->id_item_orcamento->Required) { ?>
			elm = this.getElements("x" + infix + "_id_item_orcamento");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $item_orcamento->id_item_orcamento->caption(), $item_orcamento->id_item_orcamento->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($item_orcamento_edit->data_lanc_item_orcamento->Required) { ?>
		...
		<?php if ($item_orcamento_edit->orcamento_id->Required) { ?>
		...
		<?php if ($item_orcamento_edit->item_id->Required) { ?>
		...
		<?php if ($item_orcamento_edit->quantidade_item_orcamento->Required) { ?>
		...
		<?php if ($item_orcamento_edit->total_item_orcamento->Required) { ?>
		...
		<?php if ($item_orcamento_edit->usuario_id->Required) { ?>
		...
		<?php if ($item_orcamento_edit->bool_ativo_item_orcamento->Required) { ?>
...
fitem_orcamentoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fitem_orcamentoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $item_orcamento_edit->showPageHeader(); ?>
<?php
$item_orcamento_edit->showMessage();
?>
<form name="fitem_orcamentoedit" id="fitem_orcamentoedit" class="<?php echo $item_orcamento_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($item_orcamento_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $item_orcamento_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="item_orcamento">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$item_orcamento_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($item_orcamento->id_item_orcamento->Visible) { // id_item_orcamento ?>
	<div id="r_id_item_orcamento" class="form-group row">
		<label id="elh_item_orcamento_id_item_orcamento" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->id_item_orcamento->caption() ?><?php echo ($item_orcamento->id_item_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->id_item_orcamento->cellAttributes() ?>>
<span id="el_item_orcamento_id_item_orcamento">
<span<?php echo $item_orcamento->id_item_orcamento->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($item_orcamento->id_item_orcamento->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="item_orcamento" data-field="x_id_item_orcamento" name="x_id_item_orcamento" id="x_id_item_orcamento" value="<?php echo HtmlEncode($item_orcamento->id_item_orcamento->CurrentValue) ?>">
<?php echo $item_orcamento->id_item_orcamento->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($item_orcamento->data_lanc_item_orcamento->Visible) { // data_lanc_item_orcamento ?>
	<div id="r_data_lanc_item_orcamento" class="form-group row">
		<label id="elh_item_orcamento_data_lanc_item_orcamento" for="x_data_lanc_item_orcamento" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->data_lanc_item_orcamento->caption() ?><?php echo ($item_orcamento->data_lanc_item_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->data_lanc_item_orcamento->cellAttributes() ?>>
...
<?php if ($item_orcamento->orcamento_id->Visible) { // orcamento_id ?>
	<div id="r_orcamento_id" class="form-group row">
		<label id="elh_item_orcamento_orcamento_id" for="x_orcamento_id" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->orcamento_id->caption() ?><?php echo ($item_orcamento->orcamento_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->orcamento_id->cellAttributes() ?>>
...
<?php if ($item_orcamento->item_id->Visible) { // item_id ?>
	<div id="r_item_id" class="form-group row">
		<label id="elh_item_orcamento_item_id" for="x_item_id" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->item_id->caption() ?><?php echo ($item_orcamento->item_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->item_id->cellAttributes() ?>>
...
<?php if ($item_orcamento->quantidade_item_orcamento->Visible) { // quantidade_item_orcamento ?>
	<div id="r_quantidade_item_orcamento" class="form-group row">
		<label id="elh_item_orcamento_quantidade_item_orcamento" for="x_quantidade_item_orcamento" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->quantidade_item_orcamento->caption() ?><?php echo ($item_orcamento->quantidade_item_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->quantidade_item_orcamento->cellAttributes() ?>>
...
<?php if ($item_orcamento->total_item_orcamento->Visible) { // total_item_orcamento ?>
	<div id="r_total_item_orcamento" class="form-group row">
		<label id="elh_item_orcamento_total_item_orcamento" for="x_total_item_orcamento" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->total_item_orcamento->caption() ?><?php echo ($item_orcamento->total_item_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->total_item_orcamento->cellAttributes() ?>>
...
<?php if ($item_orcamento->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_item_orcamento_usuario_id" for="x_usuario_id" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->usuario_id->caption() ?><?php echo ($item_orcamento->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->usuario_id->cellAttributes() ?>>
...
<?php if ($item_orcamento->bool_ativo_item_orcamento->Visible) { // bool_ativo_item_orcamento ?>
	<div id="r_bool_ativo_item_orcamento" class="form-group row">
		<label id="elh_item_orcamento_bool_ativo_item_orcamento" for="x_bool_ativo_item_orcamento" class="<?php echo $item_orcamento_edit->LeftColumnClass ?>"><?php echo $item_orcamento->bool_ativo_item_orcamento->caption() ?><?php echo ($item_orcamento->bool_ativo_item_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_orcamento_edit->RightColumnClass ?>"><div<?php echo $item_orcamento->bool_ativo_item_orcamento->cellAttributes() ?>>
...
<?php if (!$item_orcamento_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $item_orcamento_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $item_orcamento_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$item_orcamento_edit->showPageFooter();
if (DEBUG_ENABLED)
