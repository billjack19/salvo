...
var ffotosedit = currentForm = new ew.Form("ffotosedit", "edit");

// Validate form
ffotosedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($fotos_edit->id_fotos->Required) { ?>
			elm = this.getElements("x" + infix + "_id_fotos");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $fotos->id_fotos->caption(), $fotos->id_fotos->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($fotos_edit->descricao_fotos->Required) { ?>
		...
		<?php } ?>
		<?php if ($fotos_edit->imagem_fotos->Required) { ?>
		...
		<?php } ?>
		<?php if ($fotos_edit->item_id->Required) { ?>
		...
		<?php if ($fotos_edit->data_atualizacao_fotos->Required) { ?>
		...
		<?php if ($fotos_edit->usuario_id->Required) { ?>
		...
		<?php if ($fotos_edit->bool_ativo_fotos->Required) { ?>
...
ffotosedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ffotosedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $fotos_edit->showPageHeader(); ?>
<?php
$fotos_edit->showMessage();
?>
<form name="ffotosedit" id="ffotosedit" class="<?php echo $fotos_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($fotos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $fotos_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="fotos">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$fotos_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($fotos->id_fotos->Visible) { // id_fotos ?>
	<div id="r_id_fotos" class="form-group row">
		<label id="elh_fotos_id_fotos" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->id_fotos->caption() ?><?php echo ($fotos->id_fotos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->id_fotos->cellAttributes() ?>>
<span id="el_fotos_id_fotos">
<span<?php echo $fotos->id_fotos->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($fotos->id_fotos->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="fotos" data-field="x_id_fotos" name="x_id_fotos" id="x_id_fotos" value="<?php echo HtmlEncode($fotos->id_fotos->CurrentValue) ?>">
<?php echo $fotos->id_fotos->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($fotos->descricao_fotos->Visible) { // descricao_fotos ?>
	<div id="r_descricao_fotos" class="form-group row">
		<label id="elh_fotos_descricao_fotos" for="x_descricao_fotos" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->descricao_fotos->caption() ?><?php echo ($fotos->descricao_fotos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->descricao_fotos->cellAttributes() ?>>
...
<?php if ($fotos->imagem_fotos->Visible) { // imagem_fotos ?>
	<div id="r_imagem_fotos" class="form-group row">
		<label id="elh_fotos_imagem_fotos" for="x_imagem_fotos" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->imagem_fotos->caption() ?><?php echo ($fotos->imagem_fotos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->imagem_fotos->cellAttributes() ?>>
...
<?php if ($fotos->item_id->Visible) { // item_id ?>
	<div id="r_item_id" class="form-group row">
		<label id="elh_fotos_item_id" for="x_item_id" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->item_id->caption() ?><?php echo ($fotos->item_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->item_id->cellAttributes() ?>>
...
<?php if ($fotos->data_atualizacao_fotos->Visible) { // data_atualizacao_fotos ?>
	<div id="r_data_atualizacao_fotos" class="form-group row">
		<label id="elh_fotos_data_atualizacao_fotos" for="x_data_atualizacao_fotos" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->data_atualizacao_fotos->caption() ?><?php echo ($fotos->data_atualizacao_fotos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->data_atualizacao_fotos->cellAttributes() ?>>
...
<?php if ($fotos->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_fotos_usuario_id" for="x_usuario_id" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->usuario_id->caption() ?><?php echo ($fotos->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->usuario_id->cellAttributes() ?>>
...
<?php if ($fotos->bool_ativo_fotos->Visible) { // bool_ativo_fotos ?>
	<div id="r_bool_ativo_fotos" class="form-group row">
		<label id="elh_fotos_bool_ativo_fotos" for="x_bool_ativo_fotos" class="<?php echo $fotos_edit->LeftColumnClass ?>"><?php echo $fotos->bool_ativo_fotos->caption() ?><?php echo ($fotos->bool_ativo_fotos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $fotos_edit->RightColumnClass ?>"><div<?php echo $fotos->bool_ativo_fotos->cellAttributes() ?>>
...
<?php if (!$fotos_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $fotos_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $fotos_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$fotos_edit->showPageFooter();
if (DEBUG_ENABLED)
