...
var fsituacaoadd = currentForm = new ew.Form("fsituacaoadd", "add");

// Validate form
fsituacaoadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($situacao_add->descricao_situacao->Required) { ?>
		...
		<?php } ?>
		<?php if ($situacao_add->cor_situacao->Required) { ?>
		...
		<?php } ?>
		<?php if ($situacao_add->data_atualizacao_situacao->Required) { ?>
		...
		<?php if ($situacao_add->usuario_id->Required) { ?>
		...
		<?php if ($situacao_add->bool_ativo_situacao->Required) { ?>
...
fsituacaoadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fsituacaoadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $situacao_add->showPageHeader(); ?>
<?php
$situacao_add->showMessage();
?>
<form name="fsituacaoadd" id="fsituacaoadd" class="<?php echo $situacao_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($situacao_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $situacao_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="situacao">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$situacao_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($situacao->descricao_situacao->Visible) { // descricao_situacao ?>
	<div id="r_descricao_situacao" class="form-group row">
		<label id="elh_situacao_descricao_situacao" for="x_descricao_situacao" class="<?php echo $situacao_add->LeftColumnClass ?>"><?php echo $situacao->descricao_situacao->caption() ?><?php echo ($situacao->descricao_situacao->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $situacao_add->RightColumnClass ?>"><div<?php echo $situacao->descricao_situacao->cellAttributes() ?>>
...
<?php if ($situacao->cor_situacao->Visible) { // cor_situacao ?>
	<div id="r_cor_situacao" class="form-group row">
		<label id="elh_situacao_cor_situacao" for="x_cor_situacao" class="<?php echo $situacao_add->LeftColumnClass ?>"><?php echo $situacao->cor_situacao->caption() ?><?php echo ($situacao->cor_situacao->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $situacao_add->RightColumnClass ?>"><div<?php echo $situacao->cor_situacao->cellAttributes() ?>>
...
<?php if ($situacao->data_atualizacao_situacao->Visible) { // data_atualizacao_situacao ?>
	<div id="r_data_atualizacao_situacao" class="form-group row">
		<label id="elh_situacao_data_atualizacao_situacao" for="x_data_atualizacao_situacao" class="<?php echo $situacao_add->LeftColumnClass ?>"><?php echo $situacao->data_atualizacao_situacao->caption() ?><?php echo ($situacao->data_atualizacao_situacao->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $situacao_add->RightColumnClass ?>"><div<?php echo $situacao->data_atualizacao_situacao->cellAttributes() ?>>
...
<?php if ($situacao->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_situacao_usuario_id" for="x_usuario_id" class="<?php echo $situacao_add->LeftColumnClass ?>"><?php echo $situacao->usuario_id->caption() ?><?php echo ($situacao->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $situacao_add->RightColumnClass ?>"><div<?php echo $situacao->usuario_id->cellAttributes() ?>>
...
<?php if ($situacao->bool_ativo_situacao->Visible) { // bool_ativo_situacao ?>
	<div id="r_bool_ativo_situacao" class="form-group row">
		<label id="elh_situacao_bool_ativo_situacao" for="x_bool_ativo_situacao" class="<?php echo $situacao_add->LeftColumnClass ?>"><?php echo $situacao->bool_ativo_situacao->caption() ?><?php echo ($situacao->bool_ativo_situacao->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $situacao_add->RightColumnClass ?>"><div<?php echo $situacao->bool_ativo_situacao->cellAttributes() ?>>
...
<?php if (!$situacao_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $situacao_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $situacao_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$situacao_add->showPageFooter();
if (DEBUG_ENABLED)
