...
// Create page object
$slide_show_edit = new slide_show_edit();
...
var fslide_showedit = currentForm = new ew.Form("fslide_showedit", "edit");

// Validate form
fslide_showedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($slide_show_edit->id_slide_show->Required) { ?>
			elm = this.getElements("x" + infix + "_id_slide_show");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $slide_show->id_slide_show->caption(), $slide_show->id_slide_show->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($slide_show_edit->titulo_slide_show->Required) { ?>
		...
		<?php } ?>
		<?php if ($slide_show_edit->descricao_slide_show->Required) { ?>
		...
		<?php } ?>
		<?php if ($slide_show_edit->imagem_slide_show->Required) { ?>
		...
		<?php } ?>
		<?php if ($slide_show_edit->item_id->Required) { ?>
		...
		<?php if ($slide_show_edit->pagina_principal_id->Required) { ?>
		...
		<?php if ($slide_show_edit->data_atualizacao_slide_show->Required) { ?>
		...
		<?php if ($slide_show_edit->usuario_id->Required) { ?>
		...
		<?php if ($slide_show_edit->bool_ativo_slide_show->Required) { ?>
...
fslide_showedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fslide_showedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $slide_show_edit->showPageHeader(); ?>
<?php
$slide_show_edit->showMessage();
?>
<form name="fslide_showedit" id="fslide_showedit" class="<?php echo $slide_show_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($slide_show_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $slide_show_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="slide_show">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$slide_show_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($slide_show->id_slide_show->Visible) { // id_slide_show ?>
	<div id="r_id_slide_show" class="form-group row">
		<label id="elh_slide_show_id_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->id_slide_show->caption() ?><?php echo ($slide_show->id_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->id_slide_show->cellAttributes() ?>>
<span id="el_slide_show_id_slide_show">
<span<?php echo $slide_show->id_slide_show->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($slide_show->id_slide_show->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="slide_show" data-field="x_id_slide_show" name="x_id_slide_show" id="x_id_slide_show" value="<?php echo HtmlEncode($slide_show->id_slide_show->CurrentValue) ?>">
<?php echo $slide_show->id_slide_show->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($slide_show->titulo_slide_show->Visible) { // titulo_slide_show ?>
	<div id="r_titulo_slide_show" class="form-group row">
		<label id="elh_slide_show_titulo_slide_show" for="x_titulo_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->titulo_slide_show->caption() ?><?php echo ($slide_show->titulo_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->titulo_slide_show->cellAttributes() ?>>
...
<?php if ($slide_show->descricao_slide_show->Visible) { // descricao_slide_show ?>
	<div id="r_descricao_slide_show" class="form-group row">
		<label id="elh_slide_show_descricao_slide_show" for="x_descricao_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->descricao_slide_show->caption() ?><?php echo ($slide_show->descricao_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->descricao_slide_show->cellAttributes() ?>>
...
<?php if ($slide_show->imagem_slide_show->Visible) { // imagem_slide_show ?>
	<div id="r_imagem_slide_show" class="form-group row">
		<label id="elh_slide_show_imagem_slide_show" for="x_imagem_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->imagem_slide_show->caption() ?><?php echo ($slide_show->imagem_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->imagem_slide_show->cellAttributes() ?>>
...
<?php if ($slide_show->item_id->Visible) { // item_id ?>
	<div id="r_item_id" class="form-group row">
		<label id="elh_slide_show_item_id" for="x_item_id" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->item_id->caption() ?><?php echo ($slide_show->item_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->item_id->cellAttributes() ?>>
...
<?php if ($slide_show->pagina_principal_id->Visible) { // pagina_principal_id ?>
	<div id="r_pagina_principal_id" class="form-group row">
		<label id="elh_slide_show_pagina_principal_id" for="x_pagina_principal_id" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->pagina_principal_id->caption() ?><?php echo ($slide_show->pagina_principal_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->pagina_principal_id->cellAttributes() ?>>
...
<?php if ($slide_show->data_atualizacao_slide_show->Visible) { // data_atualizacao_slide_show ?>
	<div id="r_data_atualizacao_slide_show" class="form-group row">
		<label id="elh_slide_show_data_atualizacao_slide_show" for="x_data_atualizacao_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->data_atualizacao_slide_show->caption() ?><?php echo ($slide_show->data_atualizacao_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->data_atualizacao_slide_show->cellAttributes() ?>>
...
<?php if ($slide_show->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_slide_show_usuario_id" for="x_usuario_id" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->usuario_id->caption() ?><?php echo ($slide_show->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->usuario_id->cellAttributes() ?>>
...
<?php if ($slide_show->bool_ativo_slide_show->Visible) { // bool_ativo_slide_show ?>
	<div id="r_bool_ativo_slide_show" class="form-group row">
		<label id="elh_slide_show_bool_ativo_slide_show" for="x_bool_ativo_slide_show" class="<?php echo $slide_show_edit->LeftColumnClass ?>"><?php echo $slide_show->bool_ativo_slide_show->caption() ?><?php echo ($slide_show->bool_ativo_slide_show->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $slide_show_edit->RightColumnClass ?>"><div<?php echo $slide_show->bool_ativo_slide_show->cellAttributes() ?>>
...
<?php if (!$slide_show_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $slide_show_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $slide_show_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$slide_show_edit->showPageFooter();
if (DEBUG_ENABLED)
