...
var fvideosedit = currentForm = new ew.Form("fvideosedit", "edit");
...
fvideosedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($videos_edit->id_videos->Required) { ?>
			elm = this.getElements("x" + infix + "_id_videos");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $videos->id_videos->caption(), $videos->id_videos->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($videos_edit->descricao_videos->Required) { ?>
		...
		<?php } ?>
		<?php if ($videos_edit->link_videos->Required) { ?>
		...
		<?php } ?>
		<?php if ($videos_edit->pagina_principal_id->Required) { ?>
		...
		<?php if ($videos_edit->data_atualizacao_videos->Required) { ?>
		...
		<?php if ($videos_edit->bool_ativo_videos->Required) { ?>
...
fvideosedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php if ($videos_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $videos_edit->Token ?>">
<?php } ?>
...
<?php if ($videos->id_videos->Visible) { // id_videos ?>
	<div id="r_id_videos" class="form-group row">
		<label id="elh_videos_id_videos" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->id_videos->caption() ?><?php echo ($videos->id_videos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->id_videos->cellAttributes() ?>>
<span id="el_videos_id_videos">
<span<?php echo $videos->id_videos->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($videos->id_videos->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="videos" data-field="x_id_videos" name="x_id_videos" id="x_id_videos" value="<?php echo HtmlEncode($videos->id_videos->CurrentValue) ?>">
<?php echo $videos->id_videos->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($videos->descricao_videos->Visible) { // descricao_videos ?>
	<div id="r_descricao_videos" class="form-group row">
		<label id="elh_videos_descricao_videos" for="x_descricao_videos" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->descricao_videos->caption() ?><?php echo ($videos->descricao_videos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->descricao_videos->cellAttributes() ?>>
...
<?php if ($videos->link_videos->Visible) { // link_videos ?>
	<div id="r_link_videos" class="form-group row">
		<label id="elh_videos_link_videos" for="x_link_videos" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->link_videos->caption() ?><?php echo ($videos->link_videos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->link_videos->cellAttributes() ?>>
...
<?php if ($videos->pagina_principal_id->Visible) { // pagina_principal_id ?>
	<div id="r_pagina_principal_id" class="form-group row">
		<label id="elh_videos_pagina_principal_id" for="x_pagina_principal_id" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->pagina_principal_id->caption() ?><?php echo ($videos->pagina_principal_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->pagina_principal_id->cellAttributes() ?>>
...
<?php if ($videos->data_atualizacao_videos->Visible) { // data_atualizacao_videos ?>
	<div id="r_data_atualizacao_videos" class="form-group row">
		<label id="elh_videos_data_atualizacao_videos" for="x_data_atualizacao_videos" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->data_atualizacao_videos->caption() ?><?php echo ($videos->data_atualizacao_videos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->data_atualizacao_videos->cellAttributes() ?>>
...
<?php if ($videos->bool_ativo_videos->Visible) { // bool_ativo_videos ?>
	<div id="r_bool_ativo_videos" class="form-group row">
		<label id="elh_videos_bool_ativo_videos" for="x_bool_ativo_videos" class="<?php echo $videos_edit->LeftColumnClass ?>"><?php echo $videos->bool_ativo_videos->caption() ?><?php echo ($videos->bool_ativo_videos->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $videos_edit->RightColumnClass ?>"><div<?php echo $videos->bool_ativo_videos->cellAttributes() ?>>
