...
// Create page object
$notificacoes_pendentes_edit = new notificacoes_pendentes_edit();

// Run the page
$notificacoes_pendentes_edit->run();
...
$notificacoes_pendentes_edit->Page_Render();
?>
...
var fnotificacoes_pendentesedit = currentForm = new ew.Form("fnotificacoes_pendentesedit", "edit");

// Validate form
fnotificacoes_pendentesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($notificacoes_pendentes_edit->id_notificacoes_pendentes->Required) { ?>
			elm = this.getElements("x" + infix + "_id_notificacoes_pendentes");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $notificacoes_pendentes->id_notificacoes_pendentes->caption(), $notificacoes_pendentes->id_notificacoes_pendentes->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($notificacoes_pendentes_edit->descricao_notificacoes_pendentes->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_pendentes_edit->usuario_atuador_notificacoes_pendentes->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_pendentes_edit->usuaio_requerente_notificacoes_pendentes->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_pendentes_edit->tipo_alteracao_notificacoes_pendentes->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_pendentes_edit->notificacoes_config_id->Required) { ?>
		...
		<?php if ($notificacoes_pendentes_edit->data_atualizacao_notificacoes_pendentes->Required) { ?>
		...
		<?php if ($notificacoes_pendentes_edit->bool_ativo_notificacoes_pendentes->Required) { ?>
...
fnotificacoes_pendentesedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fnotificacoes_pendentesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
fnotificacoes_pendentesedit.lists["x_tipo_alteracao_notificacoes_pendentes"] = <?php echo $notificacoes_pendentes_edit->tipo_alteracao_notificacoes_pendentes->Lookup->toClientList() ?>;
fnotificacoes_pendentesedit.lists["x_tipo_alteracao_notificacoes_pendentes"].options = <?php echo JsonEncode($notificacoes_pendentes_edit->tipo_alteracao_notificacoes_pendentes->options(FALSE, TRUE)) ?>;
...
<?php $notificacoes_pendentes_edit->showPageHeader(); ?>
<?php
$notificacoes_pendentes_edit->showMessage();
?>
<form name="fnotificacoes_pendentesedit" id="fnotificacoes_pendentesedit" class="<?php echo $notificacoes_pendentes_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($notificacoes_pendentes_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $notificacoes_pendentes_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="notificacoes_pendentes">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$notificacoes_pendentes_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($notificacoes_pendentes->id_notificacoes_pendentes->Visible) { // id_notificacoes_pendentes ?>
	<div id="r_id_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_id_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->id_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->id_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->id_notificacoes_pendentes->cellAttributes() ?>>
...
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($notificacoes_pendentes->id_notificacoes_pendentes->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="notificacoes_pendentes" data-field="x_id_notificacoes_pendentes" name="x_id_notificacoes_pendentes" id="x_id_notificacoes_pendentes" value="<?php echo HtmlEncode($notificacoes_pendentes->id_notificacoes_pendentes->CurrentValue) ?>">
<?php echo $notificacoes_pendentes->id_notificacoes_pendentes->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($notificacoes_pendentes->descricao_notificacoes_pendentes->Visible) { // descricao_notificacoes_pendentes ?>
	<div id="r_descricao_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_descricao_notificacoes_pendentes" for="x_descricao_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->descricao_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->descricao_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->descricao_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->usuario_atuador_notificacoes_pendentes->Visible) { // usuario_atuador_notificacoes_pendentes ?>
	<div id="r_usuario_atuador_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_usuario_atuador_notificacoes_pendentes" for="x_usuario_atuador_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->usuario_atuador_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->usuario_atuador_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->usuario_atuador_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->usuaio_requerente_notificacoes_pendentes->Visible) { // usuaio_requerente_notificacoes_pendentes ?>
	<div id="r_usuaio_requerente_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_usuaio_requerente_notificacoes_pendentes" for="x_usuaio_requerente_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->usuaio_requerente_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->usuaio_requerente_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->usuaio_requerente_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->tipo_alteracao_notificacoes_pendentes->Visible) { // tipo_alteracao_notificacoes_pendentes ?>
	<div id="r_tipo_alteracao_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_tipo_alteracao_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->tipo_alteracao_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->tipo_alteracao_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->tipo_alteracao_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->notificacoes_config_id->Visible) { // notificacoes_config_id ?>
	<div id="r_notificacoes_config_id" class="form-group row">
		<label id="elh_notificacoes_pendentes_notificacoes_config_id" for="x_notificacoes_config_id" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->notificacoes_config_id->caption() ?><?php echo ($notificacoes_pendentes->notificacoes_config_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->notificacoes_config_id->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->data_atualizacao_notificacoes_pendentes->Visible) { // data_atualizacao_notificacoes_pendentes ?>
	<div id="r_data_atualizacao_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_data_atualizacao_notificacoes_pendentes" for="x_data_atualizacao_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->data_atualizacao_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->data_atualizacao_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->data_atualizacao_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if ($notificacoes_pendentes->bool_ativo_notificacoes_pendentes->Visible) { // bool_ativo_notificacoes_pendentes ?>
	<div id="r_bool_ativo_notificacoes_pendentes" class="form-group row">
		<label id="elh_notificacoes_pendentes_bool_ativo_notificacoes_pendentes" for="x_bool_ativo_notificacoes_pendentes" class="<?php echo $notificacoes_pendentes_edit->LeftColumnClass ?>"><?php echo $notificacoes_pendentes->bool_ativo_notificacoes_pendentes->caption() ?><?php echo ($notificacoes_pendentes->bool_ativo_notificacoes_pendentes->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_pendentes_edit->RightColumnClass ?>"><div<?php echo $notificacoes_pendentes->bool_ativo_notificacoes_pendentes->cellAttributes() ?>>
...
<?php if (!$notificacoes_pendentes_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $notificacoes_pendentes_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $notificacoes_pendentes_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$notificacoes_pendentes_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$notificacoes_pendentes_edit->terminate();
?>
