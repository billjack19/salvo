...
// Create page object
$destaque_grupo_edit = new destaque_grupo_edit();

// Run the page
$destaque_grupo_edit->run();
...
$destaque_grupo_edit->Page_Render();
?>
...
var fdestaque_grupoedit = currentForm = new ew.Form("fdestaque_grupoedit", "edit");

// Validate form
fdestaque_grupoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($destaque_grupo_edit->id_destaque_grupo->Required) { ?>
			elm = this.getElements("x" + infix + "_id_destaque_grupo");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $destaque_grupo->id_destaque_grupo->caption(), $destaque_grupo->id_destaque_grupo->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($destaque_grupo_edit->titulo_destaque_grupo->Required) { ?>
		...
		<?php } ?>
		<?php if ($destaque_grupo_edit->grupo_id->Required) { ?>
		...
		<?php if ($destaque_grupo_edit->imagem_destaque_grupo->Required) { ?>
		...
		<?php } ?>
		<?php if ($destaque_grupo_edit->descricao_destaque_grupo->Required) { ?>
		...
		<?php } ?>
		<?php if ($destaque_grupo_edit->configurar_site_id->Required) { ?>
		...
		<?php if ($destaque_grupo_edit->data_atualizacao_destaque_grupo->Required) { ?>
		...
		<?php if ($destaque_grupo_edit->usuario_id->Required) { ?>
		...
		<?php if ($destaque_grupo_edit->bool_ativo_destaque_grupo->Required) { ?>
...
fdestaque_grupoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fdestaque_grupoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $destaque_grupo_edit->showPageHeader(); ?>
<?php
$destaque_grupo_edit->showMessage();
?>
<form name="fdestaque_grupoedit" id="fdestaque_grupoedit" class="<?php echo $destaque_grupo_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($destaque_grupo_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $destaque_grupo_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="destaque_grupo">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$destaque_grupo_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($destaque_grupo->id_destaque_grupo->Visible) { // id_destaque_grupo ?>
	<div id="r_id_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_id_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->id_destaque_grupo->caption() ?><?php echo ($destaque_grupo->id_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->id_destaque_grupo->cellAttributes() ?>>
<span id="el_destaque_grupo_id_destaque_grupo">
<span<?php echo $destaque_grupo->id_destaque_grupo->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($destaque_grupo->id_destaque_grupo->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="destaque_grupo" data-field="x_id_destaque_grupo" name="x_id_destaque_grupo" id="x_id_destaque_grupo" value="<?php echo HtmlEncode($destaque_grupo->id_destaque_grupo->CurrentValue) ?>">
<?php echo $destaque_grupo->id_destaque_grupo->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($destaque_grupo->titulo_destaque_grupo->Visible) { // titulo_destaque_grupo ?>
	<div id="r_titulo_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_titulo_destaque_grupo" for="x_titulo_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->titulo_destaque_grupo->caption() ?><?php echo ($destaque_grupo->titulo_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->titulo_destaque_grupo->cellAttributes() ?>>
...
<?php if ($destaque_grupo->grupo_id->Visible) { // grupo_id ?>
	<div id="r_grupo_id" class="form-group row">
		<label id="elh_destaque_grupo_grupo_id" for="x_grupo_id" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->grupo_id->caption() ?><?php echo ($destaque_grupo->grupo_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->grupo_id->cellAttributes() ?>>
...
<?php if ($destaque_grupo->imagem_destaque_grupo->Visible) { // imagem_destaque_grupo ?>
	<div id="r_imagem_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_imagem_destaque_grupo" for="x_imagem_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->imagem_destaque_grupo->caption() ?><?php echo ($destaque_grupo->imagem_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->imagem_destaque_grupo->cellAttributes() ?>>
...
<?php if ($destaque_grupo->descricao_destaque_grupo->Visible) { // descricao_destaque_grupo ?>
	<div id="r_descricao_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_descricao_destaque_grupo" for="x_descricao_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->descricao_destaque_grupo->caption() ?><?php echo ($destaque_grupo->descricao_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->descricao_destaque_grupo->cellAttributes() ?>>
...
<?php if ($destaque_grupo->configurar_site_id->Visible) { // configurar_site_id ?>
	<div id="r_configurar_site_id" class="form-group row">
		<label id="elh_destaque_grupo_configurar_site_id" for="x_configurar_site_id" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->configurar_site_id->caption() ?><?php echo ($destaque_grupo->configurar_site_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->configurar_site_id->cellAttributes() ?>>
...
<?php if ($destaque_grupo->data_atualizacao_destaque_grupo->Visible) { // data_atualizacao_destaque_grupo ?>
	<div id="r_data_atualizacao_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_data_atualizacao_destaque_grupo" for="x_data_atualizacao_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->data_atualizacao_destaque_grupo->caption() ?><?php echo ($destaque_grupo->data_atualizacao_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->data_atualizacao_destaque_grupo->cellAttributes() ?>>
...
<?php if ($destaque_grupo->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_destaque_grupo_usuario_id" for="x_usuario_id" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->usuario_id->caption() ?><?php echo ($destaque_grupo->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->usuario_id->cellAttributes() ?>>
...
<?php if ($destaque_grupo->bool_ativo_destaque_grupo->Visible) { // bool_ativo_destaque_grupo ?>
	<div id="r_bool_ativo_destaque_grupo" class="form-group row">
		<label id="elh_destaque_grupo_bool_ativo_destaque_grupo" for="x_bool_ativo_destaque_grupo" class="<?php echo $destaque_grupo_edit->LeftColumnClass ?>"><?php echo $destaque_grupo->bool_ativo_destaque_grupo->caption() ?><?php echo ($destaque_grupo->bool_ativo_destaque_grupo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $destaque_grupo_edit->RightColumnClass ?>"><div<?php echo $destaque_grupo->bool_ativo_destaque_grupo->cellAttributes() ?>>
...
<?php if (!$destaque_grupo_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $destaque_grupo_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $destaque_grupo_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$destaque_grupo_edit->showPageFooter();
if (DEBUG_ENABLED)
