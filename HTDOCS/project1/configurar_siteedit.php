...
// Create page object
$configurar_site_edit = new configurar_site_edit();

// Run the page
$configurar_site_edit->run();
...
$configurar_site_edit->Page_Render();
?>
...
var fconfigurar_siteedit = currentForm = new ew.Form("fconfigurar_siteedit", "edit");

// Validate form
fconfigurar_siteedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($configurar_site_edit->id_configurar_site->Required) { ?>
			elm = this.getElements("x" + infix + "_id_configurar_site");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $configurar_site->id_configurar_site->caption(), $configurar_site->id_configurar_site->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($configurar_site_edit->titulo_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->titulo_menu_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->cor_pagina_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->contra_cor_pagina_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->imagem_icone_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->imagem_logo_configurar_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($configurar_site_edit->data_atualizacao_configurar_site->Required) { ?>
		...
		<?php if ($configurar_site_edit->usuario_id->Required) { ?>
		...
		<?php if ($configurar_site_edit->bool_ativo_configurar_site->Required) { ?>
...
fconfigurar_siteedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fconfigurar_siteedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $configurar_site_edit->showPageHeader(); ?>
<?php
$configurar_site_edit->showMessage();
?>
<form name="fconfigurar_siteedit" id="fconfigurar_siteedit" class="<?php echo $configurar_site_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($configurar_site_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $configurar_site_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="configurar_site">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$configurar_site_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($configurar_site->id_configurar_site->Visible) { // id_configurar_site ?>
	<div id="r_id_configurar_site" class="form-group row">
		<label id="elh_configurar_site_id_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->id_configurar_site->caption() ?><?php echo ($configurar_site->id_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->id_configurar_site->cellAttributes() ?>>
<span id="el_configurar_site_id_configurar_site">
<span<?php echo $configurar_site->id_configurar_site->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($configurar_site->id_configurar_site->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="configurar_site" data-field="x_id_configurar_site" name="x_id_configurar_site" id="x_id_configurar_site" value="<?php echo HtmlEncode($configurar_site->id_configurar_site->CurrentValue) ?>">
<?php echo $configurar_site->id_configurar_site->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($configurar_site->titulo_configurar_site->Visible) { // titulo_configurar_site ?>
	<div id="r_titulo_configurar_site" class="form-group row">
		<label id="elh_configurar_site_titulo_configurar_site" for="x_titulo_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->titulo_configurar_site->caption() ?><?php echo ($configurar_site->titulo_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->titulo_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->titulo_menu_configurar_site->Visible) { // titulo_menu_configurar_site ?>
	<div id="r_titulo_menu_configurar_site" class="form-group row">
		<label id="elh_configurar_site_titulo_menu_configurar_site" for="x_titulo_menu_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->titulo_menu_configurar_site->caption() ?><?php echo ($configurar_site->titulo_menu_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->titulo_menu_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->cor_pagina_configurar_site->Visible) { // cor_pagina_configurar_site ?>
	<div id="r_cor_pagina_configurar_site" class="form-group row">
		<label id="elh_configurar_site_cor_pagina_configurar_site" for="x_cor_pagina_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->cor_pagina_configurar_site->caption() ?><?php echo ($configurar_site->cor_pagina_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->cor_pagina_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->contra_cor_pagina_configurar_site->Visible) { // contra_cor_pagina_configurar_site ?>
	<div id="r_contra_cor_pagina_configurar_site" class="form-group row">
		<label id="elh_configurar_site_contra_cor_pagina_configurar_site" for="x_contra_cor_pagina_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->contra_cor_pagina_configurar_site->caption() ?><?php echo ($configurar_site->contra_cor_pagina_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->contra_cor_pagina_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->imagem_icone_configurar_site->Visible) { // imagem_icone_configurar_site ?>
	<div id="r_imagem_icone_configurar_site" class="form-group row">
		<label id="elh_configurar_site_imagem_icone_configurar_site" for="x_imagem_icone_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->imagem_icone_configurar_site->caption() ?><?php echo ($configurar_site->imagem_icone_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->imagem_icone_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->imagem_logo_configurar_site->Visible) { // imagem_logo_configurar_site ?>
	<div id="r_imagem_logo_configurar_site" class="form-group row">
		<label id="elh_configurar_site_imagem_logo_configurar_site" for="x_imagem_logo_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->imagem_logo_configurar_site->caption() ?><?php echo ($configurar_site->imagem_logo_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->imagem_logo_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->data_atualizacao_configurar_site->Visible) { // data_atualizacao_configurar_site ?>
	<div id="r_data_atualizacao_configurar_site" class="form-group row">
		<label id="elh_configurar_site_data_atualizacao_configurar_site" for="x_data_atualizacao_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->data_atualizacao_configurar_site->caption() ?><?php echo ($configurar_site->data_atualizacao_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->data_atualizacao_configurar_site->cellAttributes() ?>>
...
<?php if ($configurar_site->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_configurar_site_usuario_id" for="x_usuario_id" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->usuario_id->caption() ?><?php echo ($configurar_site->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->usuario_id->cellAttributes() ?>>
...
<?php if ($configurar_site->bool_ativo_configurar_site->Visible) { // bool_ativo_configurar_site ?>
	<div id="r_bool_ativo_configurar_site" class="form-group row">
		<label id="elh_configurar_site_bool_ativo_configurar_site" for="x_bool_ativo_configurar_site" class="<?php echo $configurar_site_edit->LeftColumnClass ?>"><?php echo $configurar_site->bool_ativo_configurar_site->caption() ?><?php echo ($configurar_site->bool_ativo_configurar_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $configurar_site_edit->RightColumnClass ?>"><div<?php echo $configurar_site->bool_ativo_configurar_site->cellAttributes() ?>>
...
<?php if (!$configurar_site_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $configurar_site_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $configurar_site_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$configurar_site_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$configurar_site_edit->terminate();
?>
