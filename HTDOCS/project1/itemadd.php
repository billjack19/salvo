...
fitemadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($item_add->titulo_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->descricao_resumida_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->descricao_site_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->imagem_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->endereco_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->numero_item->Required) { ?>
		...
		<?php if ($item_add->bairro_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->cidade_item->Required) { ?>
		...
		<?php } ?>
		<?php if ($item_add->estado_id->Required) { ?>
		...
		<?php if ($item_add->situacao_id->Required) { ?>
		...
		<?php if ($item_add->grupo_id->Required) { ?>
		...
		<?php if ($item_add->usuario_id->Required) { ?>
		...
		<?php if ($item_add->bool_ativo_item->Required) { ?>
...
<?php if ($item->titulo_item->Visible) { // titulo_item ?>
	<div id="r_titulo_item" class="form-group row">
		<label id="elh_item_titulo_item" for="x_titulo_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->titulo_item->caption() ?><?php echo ($item->titulo_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->titulo_item->cellAttributes() ?>>
...
<?php if ($item->descricao_resumida_item->Visible) { // descricao_resumida_item ?>
	<div id="r_descricao_resumida_item" class="form-group row">
		<label id="elh_item_descricao_resumida_item" for="x_descricao_resumida_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->descricao_resumida_item->caption() ?><?php echo ($item->descricao_resumida_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->descricao_resumida_item->cellAttributes() ?>>
...
<?php if ($item->descricao_site_item->Visible) { // descricao_site_item ?>
	<div id="r_descricao_site_item" class="form-group row">
		<label id="elh_item_descricao_site_item" for="x_descricao_site_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->descricao_site_item->caption() ?><?php echo ($item->descricao_site_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->descricao_site_item->cellAttributes() ?>>
...
<?php if ($item->imagem_item->Visible) { // imagem_item ?>
	<div id="r_imagem_item" class="form-group row">
		<label id="elh_item_imagem_item" for="x_imagem_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->imagem_item->caption() ?><?php echo ($item->imagem_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->imagem_item->cellAttributes() ?>>
...
<?php if ($item->endereco_item->Visible) { // endereco_item ?>
	<div id="r_endereco_item" class="form-group row">
		<label id="elh_item_endereco_item" for="x_endereco_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->endereco_item->caption() ?><?php echo ($item->endereco_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->endereco_item->cellAttributes() ?>>
...
<?php if ($item->numero_item->Visible) { // numero_item ?>
	<div id="r_numero_item" class="form-group row">
		<label id="elh_item_numero_item" for="x_numero_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->numero_item->caption() ?><?php echo ($item->numero_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->numero_item->cellAttributes() ?>>
...
<?php if ($item->bairro_item->Visible) { // bairro_item ?>
	<div id="r_bairro_item" class="form-group row">
		<label id="elh_item_bairro_item" for="x_bairro_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->bairro_item->caption() ?><?php echo ($item->bairro_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->bairro_item->cellAttributes() ?>>
...
<?php if ($item->cidade_item->Visible) { // cidade_item ?>
	<div id="r_cidade_item" class="form-group row">
		<label id="elh_item_cidade_item" for="x_cidade_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->cidade_item->caption() ?><?php echo ($item->cidade_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->cidade_item->cellAttributes() ?>>
...
<?php if ($item->estado_id->Visible) { // estado_id ?>
	<div id="r_estado_id" class="form-group row">
		<label id="elh_item_estado_id" for="x_estado_id" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->estado_id->caption() ?><?php echo ($item->estado_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->estado_id->cellAttributes() ?>>
...
<?php if ($item->situacao_id->Visible) { // situacao_id ?>
	<div id="r_situacao_id" class="form-group row">
		<label id="elh_item_situacao_id" for="x_situacao_id" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->situacao_id->caption() ?><?php echo ($item->situacao_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->situacao_id->cellAttributes() ?>>
...
<?php if ($item->grupo_id->Visible) { // grupo_id ?>
	<div id="r_grupo_id" class="form-group row">
		<label id="elh_item_grupo_id" for="x_grupo_id" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->grupo_id->caption() ?><?php echo ($item->grupo_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->grupo_id->cellAttributes() ?>>
...
<?php if ($item->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_item_usuario_id" for="x_usuario_id" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->usuario_id->caption() ?><?php echo ($item->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->usuario_id->cellAttributes() ?>>
...
<?php if ($item->bool_ativo_item->Visible) { // bool_ativo_item ?>
	<div id="r_bool_ativo_item" class="form-group row">
		<label id="elh_item_bool_ativo_item" for="x_bool_ativo_item" class="<?php echo $item_add->LeftColumnClass ?>"><?php echo $item->bool_ativo_item->caption() ?><?php echo ($item->bool_ativo_item->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $item_add->RightColumnClass ?>"><div<?php echo $item->bool_ativo_item->cellAttributes() ?>>
