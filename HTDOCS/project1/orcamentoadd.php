...
// Create page object
$orcamento_add = new orcamento_add();
...
var forcamentoadd = currentForm = new ew.Form("forcamentoadd", "add");

// Validate form
forcamentoadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($orcamento_add->descricao_orcamento->Required) { ?>
		...
		<?php } ?>
		<?php if ($orcamento_add->cliente_site_id->Required) { ?>
		...
		<?php if ($orcamento_add->data_lanc_orcamento->Required) { ?>
		...
		<?php if ($orcamento_add->usuario_id->Required) { ?>
		...
		<?php if ($orcamento_add->bool_ativo_orcamento->Required) { ?>
...
forcamentoadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
forcamentoadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $orcamento_add->showPageHeader(); ?>
<?php
$orcamento_add->showMessage();
?>
<form name="forcamentoadd" id="forcamentoadd" class="<?php echo $orcamento_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($orcamento_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $orcamento_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="orcamento">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$orcamento_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($orcamento->descricao_orcamento->Visible) { // descricao_orcamento ?>
	<div id="r_descricao_orcamento" class="form-group row">
		<label id="elh_orcamento_descricao_orcamento" for="x_descricao_orcamento" class="<?php echo $orcamento_add->LeftColumnClass ?>"><?php echo $orcamento->descricao_orcamento->caption() ?><?php echo ($orcamento->descricao_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $orcamento_add->RightColumnClass ?>"><div<?php echo $orcamento->descricao_orcamento->cellAttributes() ?>>
...
<?php if ($orcamento->cliente_site_id->Visible) { // cliente_site_id ?>
	<div id="r_cliente_site_id" class="form-group row">
		<label id="elh_orcamento_cliente_site_id" for="x_cliente_site_id" class="<?php echo $orcamento_add->LeftColumnClass ?>"><?php echo $orcamento->cliente_site_id->caption() ?><?php echo ($orcamento->cliente_site_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $orcamento_add->RightColumnClass ?>"><div<?php echo $orcamento->cliente_site_id->cellAttributes() ?>>
...
<?php if ($orcamento->data_lanc_orcamento->Visible) { // data_lanc_orcamento ?>
	<div id="r_data_lanc_orcamento" class="form-group row">
		<label id="elh_orcamento_data_lanc_orcamento" for="x_data_lanc_orcamento" class="<?php echo $orcamento_add->LeftColumnClass ?>"><?php echo $orcamento->data_lanc_orcamento->caption() ?><?php echo ($orcamento->data_lanc_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $orcamento_add->RightColumnClass ?>"><div<?php echo $orcamento->data_lanc_orcamento->cellAttributes() ?>>
...
<?php if ($orcamento->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_orcamento_usuario_id" for="x_usuario_id" class="<?php echo $orcamento_add->LeftColumnClass ?>"><?php echo $orcamento->usuario_id->caption() ?><?php echo ($orcamento->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $orcamento_add->RightColumnClass ?>"><div<?php echo $orcamento->usuario_id->cellAttributes() ?>>
...
<?php if ($orcamento->bool_ativo_orcamento->Visible) { // bool_ativo_orcamento ?>
	<div id="r_bool_ativo_orcamento" class="form-group row">
		<label id="elh_orcamento_bool_ativo_orcamento" for="x_bool_ativo_orcamento" class="<?php echo $orcamento_add->LeftColumnClass ?>"><?php echo $orcamento->bool_ativo_orcamento->caption() ?><?php echo ($orcamento->bool_ativo_orcamento->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $orcamento_add->RightColumnClass ?>"><div<?php echo $orcamento->bool_ativo_orcamento->cellAttributes() ?>>
...
<?php if (!$orcamento_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $orcamento_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $orcamento_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$orcamento_add->showPageFooter();
if (DEBUG_ENABLED)
