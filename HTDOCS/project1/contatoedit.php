...
var fcontatoedit = currentForm = new ew.Form("fcontatoedit", "edit");

// Validate form
fcontatoedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($contato_edit->id_contato->Required) { ?>
			elm = this.getElements("x" + infix + "_id_contato");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $contato->id_contato->caption(), $contato->id_contato->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($contato_edit->nome_contato->Required) { ?>
		...
		<?php } ?>
		<?php if ($contato_edit->email_contato->Required) { ?>
		...
		<?php } ?>
		<?php if ($contato_edit->telefone_contato->Required) { ?>
		...
		<?php } ?>
		<?php if ($contato_edit->assunto_contato->Required) { ?>
		...
		<?php } ?>
		<?php if ($contato_edit->mensagem_contato->Required) { ?>
		...
		<?php } ?>
		<?php if ($contato_edit->usuario_id->Required) { ?>
		...
		<?php if ($contato_edit->data_atualizacao_contato->Required) { ?>
		...
		<?php if ($contato_edit->bool_ativo_contato->Required) { ?>
...
fcontatoedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcontatoedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $contato_edit->showPageHeader(); ?>
<?php
$contato_edit->showMessage();
?>
<form name="fcontatoedit" id="fcontatoedit" class="<?php echo $contato_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($contato_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $contato_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="contato">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$contato_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($contato->id_contato->Visible) { // id_contato ?>
	<div id="r_id_contato" class="form-group row">
		<label id="elh_contato_id_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->id_contato->caption() ?><?php echo ($contato->id_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->id_contato->cellAttributes() ?>>
<span id="el_contato_id_contato">
<span<?php echo $contato->id_contato->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($contato->id_contato->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="contato" data-field="x_id_contato" name="x_id_contato" id="x_id_contato" value="<?php echo HtmlEncode($contato->id_contato->CurrentValue) ?>">
<?php echo $contato->id_contato->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($contato->nome_contato->Visible) { // nome_contato ?>
	<div id="r_nome_contato" class="form-group row">
		<label id="elh_contato_nome_contato" for="x_nome_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->nome_contato->caption() ?><?php echo ($contato->nome_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->nome_contato->cellAttributes() ?>>
...
<?php if ($contato->email_contato->Visible) { // email_contato ?>
	<div id="r_email_contato" class="form-group row">
		<label id="elh_contato_email_contato" for="x_email_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->email_contato->caption() ?><?php echo ($contato->email_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->email_contato->cellAttributes() ?>>
...
<?php if ($contato->telefone_contato->Visible) { // telefone_contato ?>
	<div id="r_telefone_contato" class="form-group row">
		<label id="elh_contato_telefone_contato" for="x_telefone_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->telefone_contato->caption() ?><?php echo ($contato->telefone_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->telefone_contato->cellAttributes() ?>>
...
<?php if ($contato->assunto_contato->Visible) { // assunto_contato ?>
	<div id="r_assunto_contato" class="form-group row">
		<label id="elh_contato_assunto_contato" for="x_assunto_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->assunto_contato->caption() ?><?php echo ($contato->assunto_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->assunto_contato->cellAttributes() ?>>
...
<?php if ($contato->mensagem_contato->Visible) { // mensagem_contato ?>
	<div id="r_mensagem_contato" class="form-group row">
		<label id="elh_contato_mensagem_contato" for="x_mensagem_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->mensagem_contato->caption() ?><?php echo ($contato->mensagem_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->mensagem_contato->cellAttributes() ?>>
...
<?php if ($contato->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_contato_usuario_id" for="x_usuario_id" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->usuario_id->caption() ?><?php echo ($contato->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->usuario_id->cellAttributes() ?>>
...
<?php if ($contato->data_atualizacao_contato->Visible) { // data_atualizacao_contato ?>
	<div id="r_data_atualizacao_contato" class="form-group row">
		<label id="elh_contato_data_atualizacao_contato" for="x_data_atualizacao_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->data_atualizacao_contato->caption() ?><?php echo ($contato->data_atualizacao_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->data_atualizacao_contato->cellAttributes() ?>>
...
<?php if ($contato->bool_ativo_contato->Visible) { // bool_ativo_contato ?>
	<div id="r_bool_ativo_contato" class="form-group row">
		<label id="elh_contato_bool_ativo_contato" for="x_bool_ativo_contato" class="<?php echo $contato_edit->LeftColumnClass ?>"><?php echo $contato->bool_ativo_contato->caption() ?><?php echo ($contato->bool_ativo_contato->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $contato_edit->RightColumnClass ?>"><div<?php echo $contato->bool_ativo_contato->cellAttributes() ?>>
...
<?php if (!$contato_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $contato_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $contato_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$contato_edit->showPageFooter();
if (DEBUG_ENABLED)
