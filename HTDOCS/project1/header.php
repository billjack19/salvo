...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>IconeCDI_32.ico"><link rel="icon" type="image/x-icon" href="<?php echo $RELATIVE_PATH ?>IconeCDI_32.ico">
