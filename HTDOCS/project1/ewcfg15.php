...
define(PROJECT_NAMESPACE . "PROJECT_ID", "{94B279FF-E847-4DCA-BF46-A72808D48DBD}"); // Project ID (GUID)
define(PROJECT_NAMESPACE . "RANDOM_KEY", 'VTNgagR5SgzoG2W4'); // Random key for encryption
...
define(PROJECT_NAMESPACE . "FONT_SIZE", 1);
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "sjt", "qs" => "`", "qe" => "`");
