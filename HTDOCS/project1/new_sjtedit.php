...
var fnew_sjtedit = currentForm = new ew.Form("fnew_sjtedit", "edit");

// Validate form
fnew_sjtedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($new_sjt_edit->id_new_sjt->Required) { ?>
			elm = this.getElements("x" + infix + "_id_new_sjt");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $new_sjt->id_new_sjt->caption(), $new_sjt->id_new_sjt->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($new_sjt_edit->descricao_new_sjt->Required) { ?>
		...
		<?php } ?>
		<?php if ($new_sjt_edit->imagem_demonstrativa_new_sjt->Required) { ?>
		...
		<?php } ?>
		<?php if ($new_sjt_edit->numero_edicao_new_sjt->Required) { ?>
		...
		<?php if ($new_sjt_edit->data_atualizacao_new_sjt->Required) { ?>
		...
		<?php if ($new_sjt_edit->usuario_id->Required) { ?>
		...
		<?php if ($new_sjt_edit->bool_ativo_new_sjt->Required) { ?>
...
fnew_sjtedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fnew_sjtedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $new_sjt_edit->showPageHeader(); ?>
<?php
$new_sjt_edit->showMessage();
?>
<form name="fnew_sjtedit" id="fnew_sjtedit" class="<?php echo $new_sjt_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($new_sjt_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $new_sjt_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="new_sjt">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$new_sjt_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($new_sjt->id_new_sjt->Visible) { // id_new_sjt ?>
	<div id="r_id_new_sjt" class="form-group row">
		<label id="elh_new_sjt_id_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->id_new_sjt->caption() ?><?php echo ($new_sjt->id_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->id_new_sjt->cellAttributes() ?>>
<span id="el_new_sjt_id_new_sjt">
<span<?php echo $new_sjt->id_new_sjt->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($new_sjt->id_new_sjt->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="new_sjt" data-field="x_id_new_sjt" name="x_id_new_sjt" id="x_id_new_sjt" value="<?php echo HtmlEncode($new_sjt->id_new_sjt->CurrentValue) ?>">
<?php echo $new_sjt->id_new_sjt->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($new_sjt->descricao_new_sjt->Visible) { // descricao_new_sjt ?>
	<div id="r_descricao_new_sjt" class="form-group row">
		<label id="elh_new_sjt_descricao_new_sjt" for="x_descricao_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->descricao_new_sjt->caption() ?><?php echo ($new_sjt->descricao_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->descricao_new_sjt->cellAttributes() ?>>
...
<?php if ($new_sjt->imagem_demonstrativa_new_sjt->Visible) { // imagem_demonstrativa_new_sjt ?>
	<div id="r_imagem_demonstrativa_new_sjt" class="form-group row">
		<label id="elh_new_sjt_imagem_demonstrativa_new_sjt" for="x_imagem_demonstrativa_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->imagem_demonstrativa_new_sjt->caption() ?><?php echo ($new_sjt->imagem_demonstrativa_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->imagem_demonstrativa_new_sjt->cellAttributes() ?>>
...
<?php if ($new_sjt->numero_edicao_new_sjt->Visible) { // numero_edicao_new_sjt ?>
	<div id="r_numero_edicao_new_sjt" class="form-group row">
		<label id="elh_new_sjt_numero_edicao_new_sjt" for="x_numero_edicao_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->numero_edicao_new_sjt->caption() ?><?php echo ($new_sjt->numero_edicao_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->numero_edicao_new_sjt->cellAttributes() ?>>
...
<?php if ($new_sjt->data_atualizacao_new_sjt->Visible) { // data_atualizacao_new_sjt ?>
	<div id="r_data_atualizacao_new_sjt" class="form-group row">
		<label id="elh_new_sjt_data_atualizacao_new_sjt" for="x_data_atualizacao_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->data_atualizacao_new_sjt->caption() ?><?php echo ($new_sjt->data_atualizacao_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->data_atualizacao_new_sjt->cellAttributes() ?>>
...
<?php if ($new_sjt->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_new_sjt_usuario_id" for="x_usuario_id" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->usuario_id->caption() ?><?php echo ($new_sjt->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->usuario_id->cellAttributes() ?>>
...
<?php if ($new_sjt->bool_ativo_new_sjt->Visible) { // bool_ativo_new_sjt ?>
	<div id="r_bool_ativo_new_sjt" class="form-group row">
		<label id="elh_new_sjt_bool_ativo_new_sjt" for="x_bool_ativo_new_sjt" class="<?php echo $new_sjt_edit->LeftColumnClass ?>"><?php echo $new_sjt->bool_ativo_new_sjt->caption() ?><?php echo ($new_sjt->bool_ativo_new_sjt->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $new_sjt_edit->RightColumnClass ?>"><div<?php echo $new_sjt->bool_ativo_new_sjt->cellAttributes() ?>>
...
<?php if (!$new_sjt_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $new_sjt_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $new_sjt_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$new_sjt_edit->showPageFooter();
if (DEBUG_ENABLED)
