...
// Create page object
$adicional_site_add = new adicional_site_add();

// Run the page
$adicional_site_add->run();
...
$adicional_site_add->Page_Render();
?>
...
var fadicional_siteadd = currentForm = new ew.Form("fadicional_siteadd", "add");

// Validate form
fadicional_siteadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($adicional_site_add->titulo_adicional_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($adicional_site_add->descricao_adicional_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($adicional_site_add->imagem_adicional_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($adicional_site_add->saiba_mais_id->Required) { ?>
		...
		<?php if ($adicional_site_add->usuario_id->Required) { ?>
		...
		<?php if ($adicional_site_add->data_atualizacao_adicional_site->Required) { ?>
		...
		<?php if ($adicional_site_add->bool_ativo_adicional_site->Required) { ?>
...
fadicional_siteadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fadicional_siteadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $adicional_site_add->showPageHeader(); ?>
<?php
$adicional_site_add->showMessage();
?>
<form name="fadicional_siteadd" id="fadicional_siteadd" class="<?php echo $adicional_site_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($adicional_site_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $adicional_site_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="adicional_site">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$adicional_site_add->IsModal ?>">
...
<?php if ($adicional_site->titulo_adicional_site->Visible) { // titulo_adicional_site ?>
	<div id="r_titulo_adicional_site" class="form-group row">
		<label id="elh_adicional_site_titulo_adicional_site" for="x_titulo_adicional_site" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->titulo_adicional_site->caption() ?><?php echo ($adicional_site->titulo_adicional_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->titulo_adicional_site->cellAttributes() ?>>
...
<?php if ($adicional_site->descricao_adicional_site->Visible) { // descricao_adicional_site ?>
	<div id="r_descricao_adicional_site" class="form-group row">
		<label id="elh_adicional_site_descricao_adicional_site" for="x_descricao_adicional_site" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->descricao_adicional_site->caption() ?><?php echo ($adicional_site->descricao_adicional_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->descricao_adicional_site->cellAttributes() ?>>
...
<?php if ($adicional_site->imagem_adicional_site->Visible) { // imagem_adicional_site ?>
	<div id="r_imagem_adicional_site" class="form-group row">
		<label id="elh_adicional_site_imagem_adicional_site" for="x_imagem_adicional_site" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->imagem_adicional_site->caption() ?><?php echo ($adicional_site->imagem_adicional_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->imagem_adicional_site->cellAttributes() ?>>
...
<?php if ($adicional_site->saiba_mais_id->Visible) { // saiba_mais_id ?>
	<div id="r_saiba_mais_id" class="form-group row">
		<label id="elh_adicional_site_saiba_mais_id" for="x_saiba_mais_id" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->saiba_mais_id->caption() ?><?php echo ($adicional_site->saiba_mais_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->saiba_mais_id->cellAttributes() ?>>
...
<?php if ($adicional_site->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_adicional_site_usuario_id" for="x_usuario_id" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->usuario_id->caption() ?><?php echo ($adicional_site->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->usuario_id->cellAttributes() ?>>
...
<?php if ($adicional_site->bool_ativo_adicional_site->Visible) { // bool_ativo_adicional_site ?>
	<div id="r_bool_ativo_adicional_site" class="form-group row">
		<label id="elh_adicional_site_bool_ativo_adicional_site" for="x_bool_ativo_adicional_site" class="<?php echo $adicional_site_add->LeftColumnClass ?>"><?php echo $adicional_site->bool_ativo_adicional_site->caption() ?><?php echo ($adicional_site->bool_ativo_adicional_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $adicional_site_add->RightColumnClass ?>"><div<?php echo $adicional_site->bool_ativo_adicional_site->cellAttributes() ?>>
...
<?php if (!$adicional_site_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $adicional_site_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $adicional_site_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$adicional_site_add->showPageFooter();
if (DEBUG_ENABLED)
