...
var fempresaedit = currentForm = new ew.Form("fempresaedit", "edit");

// Validate form
fempresaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($empresa_edit->id_empresa->Required) { ?>
			elm = this.getElements("x" + infix + "_id_empresa");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $empresa->id_empresa->caption(), $empresa->id_empresa->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($empresa_edit->descricao_empresa->Required) { ?>
		...
		<?php } ?>
		<?php if ($empresa_edit->imagem_logo_empresa->Required) { ?>
		...
		<?php } ?>
		<?php if ($empresa_edit->data_atualizacao_empresa->Required) { ?>
		...
		<?php if ($empresa_edit->usuario_id->Required) { ?>
		...
		<?php if ($empresa_edit->bool_ativo_empresa->Required) { ?>
...
fempresaedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fempresaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
?>
<form name="fempresaedit" id="fempresaedit" class="<?php echo $empresa_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($empresa_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $empresa_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="empresa">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$empresa_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($empresa->id_empresa->Visible) { // id_empresa ?>
	<div id="r_id_empresa" class="form-group row">
		<label id="elh_empresa_id_empresa" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->id_empresa->caption() ?><?php echo ($empresa->id_empresa->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->id_empresa->cellAttributes() ?>>
<span id="el_empresa_id_empresa">
<span<?php echo $empresa->id_empresa->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($empresa->id_empresa->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="empresa" data-field="x_id_empresa" name="x_id_empresa" id="x_id_empresa" value="<?php echo HtmlEncode($empresa->id_empresa->CurrentValue) ?>">
<?php echo $empresa->id_empresa->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($empresa->descricao_empresa->Visible) { // descricao_empresa ?>
	<div id="r_descricao_empresa" class="form-group row">
		<label id="elh_empresa_descricao_empresa" for="x_descricao_empresa" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->descricao_empresa->caption() ?><?php echo ($empresa->descricao_empresa->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->descricao_empresa->cellAttributes() ?>>
...
<?php if ($empresa->imagem_logo_empresa->Visible) { // imagem_logo_empresa ?>
	<div id="r_imagem_logo_empresa" class="form-group row">
		<label id="elh_empresa_imagem_logo_empresa" for="x_imagem_logo_empresa" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->imagem_logo_empresa->caption() ?><?php echo ($empresa->imagem_logo_empresa->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->imagem_logo_empresa->cellAttributes() ?>>
...
<?php if ($empresa->data_atualizacao_empresa->Visible) { // data_atualizacao_empresa ?>
	<div id="r_data_atualizacao_empresa" class="form-group row">
		<label id="elh_empresa_data_atualizacao_empresa" for="x_data_atualizacao_empresa" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->data_atualizacao_empresa->caption() ?><?php echo ($empresa->data_atualizacao_empresa->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->data_atualizacao_empresa->cellAttributes() ?>>
...
<?php if ($empresa->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_empresa_usuario_id" for="x_usuario_id" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->usuario_id->caption() ?><?php echo ($empresa->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->usuario_id->cellAttributes() ?>>
...
<?php if ($empresa->bool_ativo_empresa->Visible) { // bool_ativo_empresa ?>
	<div id="r_bool_ativo_empresa" class="form-group row">
		<label id="elh_empresa_bool_ativo_empresa" for="x_bool_ativo_empresa" class="<?php echo $empresa_edit->LeftColumnClass ?>"><?php echo $empresa->bool_ativo_empresa->caption() ?><?php echo ($empresa->bool_ativo_empresa->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $empresa_edit->RightColumnClass ?>"><div<?php echo $empresa->bool_ativo_empresa->cellAttributes() ?>>
...
<?php if (!$empresa_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $empresa_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $empresa_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
