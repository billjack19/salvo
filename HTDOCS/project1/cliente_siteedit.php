...
// Create page object
$cliente_site_edit = new cliente_site_edit();

// Run the page
$cliente_site_edit->run();
...
var fcliente_siteedit = currentForm = new ew.Form("fcliente_siteedit", "edit");

// Validate form
fcliente_siteedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($cliente_site_edit->id_cliente_site->Required) { ?>
			elm = this.getElements("x" + infix + "_id_cliente_site");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $cliente_site->id_cliente_site->caption(), $cliente_site->id_cliente_site->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($cliente_site_edit->nome_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->login_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->senha_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->telefone_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->celular_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->endereco_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->numero_cliente_site->Required) { ?>
		...
		<?php if ($cliente_site_edit->complemento_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->bairro_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->cidade_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->estado_id->Required) { ?>
		...
		<?php if ($cliente_site_edit->cep_cliente_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($cliente_site_edit->data_atualizacao_cliente_site->Required) { ?>
		...
		<?php if ($cliente_site_edit->usuario_id->Required) { ?>
		...
		<?php if ($cliente_site_edit->bool_ativo_cliente_site->Required) { ?>
...
fcliente_siteedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fcliente_siteedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $cliente_site_edit->showPageHeader(); ?>
<?php
$cliente_site_edit->showMessage();
?>
<form name="fcliente_siteedit" id="fcliente_siteedit" class="<?php echo $cliente_site_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($cliente_site_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $cliente_site_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cliente_site">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$cliente_site_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($cliente_site->id_cliente_site->Visible) { // id_cliente_site ?>
	<div id="r_id_cliente_site" class="form-group row">
		<label id="elh_cliente_site_id_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->id_cliente_site->caption() ?><?php echo ($cliente_site->id_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->id_cliente_site->cellAttributes() ?>>
<span id="el_cliente_site_id_cliente_site">
<span<?php echo $cliente_site->id_cliente_site->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($cliente_site->id_cliente_site->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="cliente_site" data-field="x_id_cliente_site" name="x_id_cliente_site" id="x_id_cliente_site" value="<?php echo HtmlEncode($cliente_site->id_cliente_site->CurrentValue) ?>">
<?php echo $cliente_site->id_cliente_site->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cliente_site->nome_cliente_site->Visible) { // nome_cliente_site ?>
	<div id="r_nome_cliente_site" class="form-group row">
		<label id="elh_cliente_site_nome_cliente_site" for="x_nome_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->nome_cliente_site->caption() ?><?php echo ($cliente_site->nome_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->nome_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->login_cliente_site->Visible) { // login_cliente_site ?>
	<div id="r_login_cliente_site" class="form-group row">
		<label id="elh_cliente_site_login_cliente_site" for="x_login_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->login_cliente_site->caption() ?><?php echo ($cliente_site->login_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->login_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->senha_cliente_site->Visible) { // senha_cliente_site ?>
	<div id="r_senha_cliente_site" class="form-group row">
		<label id="elh_cliente_site_senha_cliente_site" for="x_senha_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->senha_cliente_site->caption() ?><?php echo ($cliente_site->senha_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->senha_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->telefone_cliente_site->Visible) { // telefone_cliente_site ?>
	<div id="r_telefone_cliente_site" class="form-group row">
		<label id="elh_cliente_site_telefone_cliente_site" for="x_telefone_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->telefone_cliente_site->caption() ?><?php echo ($cliente_site->telefone_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->telefone_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->celular_cliente_site->Visible) { // celular_cliente_site ?>
	<div id="r_celular_cliente_site" class="form-group row">
		<label id="elh_cliente_site_celular_cliente_site" for="x_celular_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->celular_cliente_site->caption() ?><?php echo ($cliente_site->celular_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->celular_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->endereco_cliente_site->Visible) { // endereco_cliente_site ?>
	<div id="r_endereco_cliente_site" class="form-group row">
		<label id="elh_cliente_site_endereco_cliente_site" for="x_endereco_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->endereco_cliente_site->caption() ?><?php echo ($cliente_site->endereco_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->endereco_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->numero_cliente_site->Visible) { // numero_cliente_site ?>
	<div id="r_numero_cliente_site" class="form-group row">
		<label id="elh_cliente_site_numero_cliente_site" for="x_numero_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->numero_cliente_site->caption() ?><?php echo ($cliente_site->numero_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->numero_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->complemento_cliente_site->Visible) { // complemento_cliente_site ?>
	<div id="r_complemento_cliente_site" class="form-group row">
		<label id="elh_cliente_site_complemento_cliente_site" for="x_complemento_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->complemento_cliente_site->caption() ?><?php echo ($cliente_site->complemento_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->complemento_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->bairro_cliente_site->Visible) { // bairro_cliente_site ?>
	<div id="r_bairro_cliente_site" class="form-group row">
		<label id="elh_cliente_site_bairro_cliente_site" for="x_bairro_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->bairro_cliente_site->caption() ?><?php echo ($cliente_site->bairro_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->bairro_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->cidade_cliente_site->Visible) { // cidade_cliente_site ?>
	<div id="r_cidade_cliente_site" class="form-group row">
		<label id="elh_cliente_site_cidade_cliente_site" for="x_cidade_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->cidade_cliente_site->caption() ?><?php echo ($cliente_site->cidade_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->cidade_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->estado_id->Visible) { // estado_id ?>
	<div id="r_estado_id" class="form-group row">
		<label id="elh_cliente_site_estado_id" for="x_estado_id" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->estado_id->caption() ?><?php echo ($cliente_site->estado_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->estado_id->cellAttributes() ?>>
...
<?php if ($cliente_site->cep_cliente_site->Visible) { // cep_cliente_site ?>
	<div id="r_cep_cliente_site" class="form-group row">
		<label id="elh_cliente_site_cep_cliente_site" for="x_cep_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->cep_cliente_site->caption() ?><?php echo ($cliente_site->cep_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->cep_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->data_atualizacao_cliente_site->Visible) { // data_atualizacao_cliente_site ?>
	<div id="r_data_atualizacao_cliente_site" class="form-group row">
		<label id="elh_cliente_site_data_atualizacao_cliente_site" for="x_data_atualizacao_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->data_atualizacao_cliente_site->caption() ?><?php echo ($cliente_site->data_atualizacao_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->data_atualizacao_cliente_site->cellAttributes() ?>>
...
<?php if ($cliente_site->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_cliente_site_usuario_id" for="x_usuario_id" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->usuario_id->caption() ?><?php echo ($cliente_site->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->usuario_id->cellAttributes() ?>>
...
<?php if ($cliente_site->bool_ativo_cliente_site->Visible) { // bool_ativo_cliente_site ?>
	<div id="r_bool_ativo_cliente_site" class="form-group row">
		<label id="elh_cliente_site_bool_ativo_cliente_site" for="x_bool_ativo_cliente_site" class="<?php echo $cliente_site_edit->LeftColumnClass ?>"><?php echo $cliente_site->bool_ativo_cliente_site->caption() ?><?php echo ($cliente_site->bool_ativo_cliente_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $cliente_site_edit->RightColumnClass ?>"><div<?php echo $cliente_site->bool_ativo_cliente_site->cellAttributes() ?>>
...
<?php if (!$cliente_site_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $cliente_site_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $cliente_site_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$cliente_site_edit->showPageFooter();
if (DEBUG_ENABLED)
