...
// Create page object
$notificacoes_config_add = new notificacoes_config_add();

// Run the page
$notificacoes_config_add->run();
...
$notificacoes_config_add->Page_Render();
?>
...
var fnotificacoes_configadd = currentForm = new ew.Form("fnotificacoes_configadd", "add");

// Validate form
fnotificacoes_configadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($notificacoes_config_add->area_notificacoes_config->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_config_add->tipo_alteracao_notificacoes_config->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_config_add->data_atualizacao_notificacoes_config->Required) { ?>
		...
		<?php if ($notificacoes_config_add->usuario_id->Required) { ?>
		...
		<?php if ($notificacoes_config_add->bool_ativo_notificacoes_config->Required) { ?>
...
fnotificacoes_configadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fnotificacoes_configadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $notificacoes_config_add->showPageHeader(); ?>
<?php
$notificacoes_config_add->showMessage();
?>
<form name="fnotificacoes_configadd" id="fnotificacoes_configadd" class="<?php echo $notificacoes_config_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($notificacoes_config_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $notificacoes_config_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="notificacoes_config">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$notificacoes_config_add->IsModal ?>">
...
<?php if ($notificacoes_config->area_notificacoes_config->Visible) { // area_notificacoes_config ?>
	<div id="r_area_notificacoes_config" class="form-group row">
		<label id="elh_notificacoes_config_area_notificacoes_config" for="x_area_notificacoes_config" class="<?php echo $notificacoes_config_add->LeftColumnClass ?>"><?php echo $notificacoes_config->area_notificacoes_config->caption() ?><?php echo ($notificacoes_config->area_notificacoes_config->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_config_add->RightColumnClass ?>"><div<?php echo $notificacoes_config->area_notificacoes_config->cellAttributes() ?>>
...
<?php if ($notificacoes_config->tipo_alteracao_notificacoes_config->Visible) { // tipo_alteracao_notificacoes_config ?>
	<div id="r_tipo_alteracao_notificacoes_config" class="form-group row">
		<label id="elh_notificacoes_config_tipo_alteracao_notificacoes_config" for="x_tipo_alteracao_notificacoes_config" class="<?php echo $notificacoes_config_add->LeftColumnClass ?>"><?php echo $notificacoes_config->tipo_alteracao_notificacoes_config->caption() ?><?php echo ($notificacoes_config->tipo_alteracao_notificacoes_config->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_config_add->RightColumnClass ?>"><div<?php echo $notificacoes_config->tipo_alteracao_notificacoes_config->cellAttributes() ?>>
...
<?php if ($notificacoes_config->data_atualizacao_notificacoes_config->Visible) { // data_atualizacao_notificacoes_config ?>
	<div id="r_data_atualizacao_notificacoes_config" class="form-group row">
		<label id="elh_notificacoes_config_data_atualizacao_notificacoes_config" for="x_data_atualizacao_notificacoes_config" class="<?php echo $notificacoes_config_add->LeftColumnClass ?>"><?php echo $notificacoes_config->data_atualizacao_notificacoes_config->caption() ?><?php echo ($notificacoes_config->data_atualizacao_notificacoes_config->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_config_add->RightColumnClass ?>"><div<?php echo $notificacoes_config->data_atualizacao_notificacoes_config->cellAttributes() ?>>
...
<?php if ($notificacoes_config->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_notificacoes_config_usuario_id" for="x_usuario_id" class="<?php echo $notificacoes_config_add->LeftColumnClass ?>"><?php echo $notificacoes_config->usuario_id->caption() ?><?php echo ($notificacoes_config->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_config_add->RightColumnClass ?>"><div<?php echo $notificacoes_config->usuario_id->cellAttributes() ?>>
...
<?php if ($notificacoes_config->bool_ativo_notificacoes_config->Visible) { // bool_ativo_notificacoes_config ?>
	<div id="r_bool_ativo_notificacoes_config" class="form-group row">
		<label id="elh_notificacoes_config_bool_ativo_notificacoes_config" for="x_bool_ativo_notificacoes_config" class="<?php echo $notificacoes_config_add->LeftColumnClass ?>"><?php echo $notificacoes_config->bool_ativo_notificacoes_config->caption() ?><?php echo ($notificacoes_config->bool_ativo_notificacoes_config->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_config_add->RightColumnClass ?>"><div<?php echo $notificacoes_config->bool_ativo_notificacoes_config->cellAttributes() ?>>
...
<?php if (!$notificacoes_config_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $notificacoes_config_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $notificacoes_config_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$notificacoes_config_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$notificacoes_config_add->terminate();
?>
