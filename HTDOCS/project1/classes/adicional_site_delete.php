...
// Page class
//
class adicional_site_delete extends adicional_site
{
	...
	// Page object name
	public $PageObjName = "adicional_site_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("adicional_sitelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("adicional_sitelist.php"); // Return to list
			}
		}
	}
