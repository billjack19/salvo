...
// Page class
//
class empresa_delete extends empresa
{
	...
	// Page object name
	public $PageObjName = "empresa_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("empresalist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("empresalist.php"); // Return to list
			}
		}
	}
