...
// Page class
//
class destaque_grupo_delete extends destaque_grupo
{
	...
	// Page object name
	public $PageObjName = "destaque_grupo_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("destaque_grupolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("destaque_grupolist.php"); // Return to list
			}
		}
	}
