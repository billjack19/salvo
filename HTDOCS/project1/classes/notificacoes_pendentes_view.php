...
// Page class
//
class notificacoes_pendentes_view extends notificacoes_pendentes
{
	...
	// Page object name
	public $PageObjName = "notificacoes_pendentes_view";
	...
	public function __construct()
	{
		...
		if (Get("id_notificacoes_pendentes") !== NULL) {
			$this->RecKey["id_notificacoes_pendentes"] = Get("id_notificacoes_pendentes");
			$keyUrl .= "&amp;id_notificacoes_pendentes=" . urlencode($this->RecKey["id_notificacoes_pendentes"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_notificacoes_pendentes") !== NULL) {
				...
				$this->RecKey["id_notificacoes_pendentes"] = $this->id_notificacoes_pendentes->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_notificacoes_pendentes->setQueryStringValue(Key(0));
				$this->RecKey["id_notificacoes_pendentes"] = $this->id_notificacoes_pendentes->QueryStringValue;
			} elseif (Post("id_notificacoes_pendentes") !== NULL) {
				$this->id_notificacoes_pendentes->setFormValue(Post("id_notificacoes_pendentes"));
				$this->RecKey["id_notificacoes_pendentes"] = $this->id_notificacoes_pendentes->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_notificacoes_pendentes->setFormValue(Route(2));
				$this->RecKey["id_notificacoes_pendentes"] = $this->id_notificacoes_pendentes->FormValue;
			} else {
				$returnUrl = "notificacoes_pendenteslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "notificacoes_pendenteslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "notificacoes_pendenteslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
