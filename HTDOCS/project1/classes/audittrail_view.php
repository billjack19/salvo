...
// Page class
//
class audittrail_view extends audittrail
{
	...
	// Page object name
	public $PageObjName = "audittrail_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "audittraillist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "audittraillist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "audittraillist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
