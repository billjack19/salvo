...
// Page class
//
class relatorios_edit extends relatorios
{
	...
	// Page object name
	public $PageObjName = "relatorios_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_relatorios")) {
				$this->id_relatorios->setFormValue($CurrentForm->getValue("x_id_relatorios"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_relatorios->IsDetailKey)
			$this->id_relatorios->setFormValue($val);
	...
	{
		global $CurrentForm;
		$this->id_relatorios->CurrentValue = $this->id_relatorios->FormValue;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// descricao_relatorios
			$this->descricao_relatorios->setDbValueDef($rsnew, $this->descricao_relatorios->CurrentValue, "", $this->descricao_relatorios->ReadOnly);

			// tabela_relatorios
			$this->tabela_relatorios->setDbValueDef($rsnew, $this->tabela_relatorios->CurrentValue, "", $this->tabela_relatorios->ReadOnly);

			// colunas_relatorios
			$this->colunas_relatorios->setDbValueDef($rsnew, $this->colunas_relatorios->CurrentValue, "", $this->colunas_relatorios->ReadOnly);

			// colunas_estrangeiras_relatorios
			$this->colunas_estrangeiras_relatorios->setDbValueDef($rsnew, $this->colunas_estrangeiras_relatorios->CurrentValue, "", $this->colunas_estrangeiras_relatorios->ReadOnly);

			// colunas_filtro_relatorios
			$this->colunas_filtro_relatorios->setDbValueDef($rsnew, $this->colunas_filtro_relatorios->CurrentValue, NULL, $this->colunas_filtro_relatorios->ReadOnly);

			// bool_filtro_ativo_relatorios
			$this->bool_filtro_ativo_relatorios->setDbValueDef($rsnew, $this->bool_filtro_ativo_relatorios->CurrentValue, 0, $this->bool_filtro_ativo_relatorios->ReadOnly);

			// data_atualizacao_relatorios
			$this->data_atualizacao_relatorios->setDbValueDef($rsnew, UnFormatDateTime($this->data_atualizacao_relatorios->CurrentValue, 0), CurrentDate(), $this->data_atualizacao_relatorios->ReadOnly);

			// usuario_id
			$this->usuario_id->setDbValueDef($rsnew, $this->usuario_id->CurrentValue, 0, $this->usuario_id->ReadOnly);

			// bool_emitir_relatorios
			$this->bool_emitir_relatorios->setDbValueDef($rsnew, $this->bool_emitir_relatorios->CurrentValue, 0, $this->bool_emitir_relatorios->ReadOnly);

			// bool_ativo_relatorios
			$this->bool_ativo_relatorios->setDbValueDef($rsnew, $this->bool_ativo_relatorios->CurrentValue, 0, $this->bool_ativo_relatorios->ReadOnly);
