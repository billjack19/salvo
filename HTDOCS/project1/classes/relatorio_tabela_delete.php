...
// Page class
//
class relatorio_tabela_delete extends relatorio_tabela
{
	...
	// Page object name
	public $PageObjName = "relatorio_tabela_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("relatorio_tabelalist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("relatorio_tabelalist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_relatorio_tabela'];
