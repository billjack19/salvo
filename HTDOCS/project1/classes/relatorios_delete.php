...
// Page class
//
class relatorios_delete extends relatorios
{
	...
	// Page object name
	public $PageObjName = "relatorios_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("relatorioslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("relatorioslist.php"); // Return to list
			}
		}
	}
