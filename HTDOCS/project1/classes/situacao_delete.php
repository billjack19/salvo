...
// Page class
//
class situacao_delete extends situacao
{
	...
	// Page object name
	public $PageObjName = "situacao_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("situacaolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("situacaolist.php"); // Return to list
			}
		}
	}
