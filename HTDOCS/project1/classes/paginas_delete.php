...
// Page class
//
class paginas_delete extends paginas
{
	...
	// Page object name
	public $PageObjName = "paginas_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("paginaslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("paginaslist.php"); // Return to list
			}
		}
	}
