...
// Page class
//
class cliente_site_delete extends cliente_site
{
	...
	// Page object name
	public $PageObjName = "cliente_site_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("cliente_sitelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("cliente_sitelist.php"); // Return to list
			}
		}
	}
