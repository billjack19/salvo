...
// Page class
//
class destaque_grupo_view extends destaque_grupo
{
	...
	// Page object name
	public $PageObjName = "destaque_grupo_view";
	...
	public function __construct()
	{
		...
		if (Get("id_destaque_grupo") !== NULL) {
			$this->RecKey["id_destaque_grupo"] = Get("id_destaque_grupo");
			$keyUrl .= "&amp;id_destaque_grupo=" . urlencode($this->RecKey["id_destaque_grupo"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_destaque_grupo") !== NULL) {
				...
				$this->RecKey["id_destaque_grupo"] = $this->id_destaque_grupo->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_destaque_grupo->setQueryStringValue(Key(0));
				$this->RecKey["id_destaque_grupo"] = $this->id_destaque_grupo->QueryStringValue;
			} elseif (Post("id_destaque_grupo") !== NULL) {
				$this->id_destaque_grupo->setFormValue(Post("id_destaque_grupo"));
				$this->RecKey["id_destaque_grupo"] = $this->id_destaque_grupo->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_destaque_grupo->setFormValue(Route(2));
				$this->RecKey["id_destaque_grupo"] = $this->id_destaque_grupo->FormValue;
			} else {
				$returnUrl = "destaque_grupolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "destaque_grupolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "destaque_grupolist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
