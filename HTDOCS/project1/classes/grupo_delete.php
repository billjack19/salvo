...
// Page class
//
class grupo_delete extends grupo
{
	...
	// Page object name
	public $PageObjName = "grupo_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("grupolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("grupolist.php"); // Return to list
			}
		}
	}
