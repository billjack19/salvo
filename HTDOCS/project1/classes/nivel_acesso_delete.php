...
// Page class
//
class nivel_acesso_delete extends nivel_acesso
{
	...
	// Page object name
	public $PageObjName = "nivel_acesso_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("nivel_acessolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("nivel_acessolist.php"); // Return to list
			}
		}
	}
