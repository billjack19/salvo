...
class site_add extends site
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("ID_SITE") !== NULL) {
				...
				$this->setKey("ID_SITE", $this->ID_SITE->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_SITE", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "siteview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->ID_SITE->OldValue = $this->ID_SITE->CurrentValue;
		$this->NOME_EMPRESA->CurrentValue = NULL;
		$this->NOME_EMPRESA->OldValue = $this->NOME_EMPRESA->CurrentValue;
		$this->NOME_CIDADE->CurrentValue = NULL;
		$this->NOME_CIDADE->OldValue = $this->NOME_CIDADE->CurrentValue;
		$this->ESTADO->CurrentValue = NULL;
		$this->ESTADO->OldValue = $this->ESTADO->CurrentValue;
		$this->FONE->CurrentValue = NULL;
		$this->FONE->OldValue = $this->FONE->CurrentValue;
		$this->FONE_APP->CurrentValue = NULL;
		$this->FONE_APP->OldValue = $this->FONE_APP->CurrentValue;
		$this->_EMAIL->CurrentValue = NULL;
		$this->_EMAIL->OldValue = $this->_EMAIL->CurrentValue;
		$this->sendusername->CurrentValue = NULL;
		$this->sendusername->OldValue = $this->sendusername->CurrentValue;
		$this->sendpassword->CurrentValue = NULL;
		$this->sendpassword->OldValue = $this->sendpassword->CurrentValue;
		$this->smtpserver->CurrentValue = NULL;
		$this->smtpserver->OldValue = $this->smtpserver->CurrentValue;
		$this->smtpserverport->CurrentValue = NULL;
		$this->smtpserverport->OldValue = $this->smtpserverport->CurrentValue;
		$this->MailFrom->CurrentValue = NULL;
		$this->MailFrom->OldValue = $this->MailFrom->CurrentValue;
		$this->MailTo->CurrentValue = NULL;
		$this->MailTo->OldValue = $this->MailTo->CurrentValue;
		$this->MailCc->CurrentValue = NULL;
		$this->MailCc->OldValue = $this->MailCc->CurrentValue;
		$this->bool_ativo_site->CurrentValue = 1;
	}
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['ID_SITE'] = $this->ID_SITE->CurrentValue;
		$row['NOME_EMPRESA'] = $this->NOME_EMPRESA->CurrentValue;
		$row['NOME_CIDADE'] = $this->NOME_CIDADE->CurrentValue;
		$row['ESTADO'] = $this->ESTADO->CurrentValue;
		$row['FONE'] = $this->FONE->CurrentValue;
		$row['FONE_APP'] = $this->FONE_APP->CurrentValue;
		$row['EMAIL'] = $this->_EMAIL->CurrentValue;
		$row['sendusername'] = $this->sendusername->CurrentValue;
		$row['sendpassword'] = $this->sendpassword->CurrentValue;
		$row['smtpserver'] = $this->smtpserver->CurrentValue;
		$row['smtpserverport'] = $this->smtpserverport->CurrentValue;
		$row['MailFrom'] = $this->MailFrom->CurrentValue;
		$row['MailTo'] = $this->MailTo->CurrentValue;
		$row['MailCc'] = $this->MailCc->CurrentValue;
		$row['bool_ativo_site'] = $this->bool_ativo_site->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// NOME_CIDADE
		$this->NOME_CIDADE->setDbValueDef($rsnew, $this->NOME_CIDADE->CurrentValue, NULL, FALSE);

		// ESTADO
		$this->ESTADO->setDbValueDef($rsnew, $this->ESTADO->CurrentValue, NULL, FALSE);

		// FONE
		$this->FONE->setDbValueDef($rsnew, $this->FONE->CurrentValue, NULL, FALSE);

		// FONE_APP
		$this->FONE_APP->setDbValueDef($rsnew, $this->FONE_APP->CurrentValue, NULL, FALSE);

		// EMAIL
		$this->_EMAIL->setDbValueDef($rsnew, $this->_EMAIL->CurrentValue, NULL, FALSE);

		// sendusername
		$this->sendusername->setDbValueDef($rsnew, $this->sendusername->CurrentValue, NULL, FALSE);

		// sendpassword
		$this->sendpassword->setDbValueDef($rsnew, $this->sendpassword->CurrentValue, NULL, FALSE);

		// smtpserver
		$this->smtpserver->setDbValueDef($rsnew, $this->smtpserver->CurrentValue, NULL, FALSE);

		// smtpserverport
		$this->smtpserverport->setDbValueDef($rsnew, $this->smtpserverport->CurrentValue, NULL, FALSE);

		// MailFrom
		$this->MailFrom->setDbValueDef($rsnew, $this->MailFrom->CurrentValue, NULL, FALSE);

		// MailTo
		$this->MailTo->setDbValueDef($rsnew, $this->MailTo->CurrentValue, NULL, FALSE);

		// MailCc
		$this->MailCc->setDbValueDef($rsnew, $this->MailCc->CurrentValue, NULL, FALSE);

		// bool_ativo_site
		$this->bool_ativo_site->setDbValueDef($rsnew, $this->bool_ativo_site->CurrentValue, NULL, strval($this->bool_ativo_site->CurrentValue) == "");
