...
// Page class
//
class fotos_delete extends fotos
{
	...
	// Page object name
	public $PageObjName = "fotos_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("fotoslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("fotoslist.php"); // Return to list
			}
		}
	}
