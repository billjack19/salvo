...
// Page class
//
class endereco_site_delete extends endereco_site
{
	...
	// Page object name
	public $PageObjName = "endereco_site_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("endereco_sitelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("endereco_sitelist.php"); // Return to list
			}
		}
	}
