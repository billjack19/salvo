...
// Page class
//
class paginas_view extends paginas
{
	...
	// Page object name
	public $PageObjName = "paginas_view";
	...
	public function __construct()
	{
		...
		if (Get("id_paginas") !== NULL) {
			$this->RecKey["id_paginas"] = Get("id_paginas");
			$keyUrl .= "&amp;id_paginas=" . urlencode($this->RecKey["id_paginas"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_paginas") !== NULL) {
				...
				$this->RecKey["id_paginas"] = $this->id_paginas->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_paginas->setQueryStringValue(Key(0));
				$this->RecKey["id_paginas"] = $this->id_paginas->QueryStringValue;
			} elseif (Post("id_paginas") !== NULL) {
				$this->id_paginas->setFormValue(Post("id_paginas"));
				$this->RecKey["id_paginas"] = $this->id_paginas->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_paginas->setFormValue(Route(2));
				$this->RecKey["id_paginas"] = $this->id_paginas->FormValue;
			} else {
				$returnUrl = "paginaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "paginaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "paginaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
