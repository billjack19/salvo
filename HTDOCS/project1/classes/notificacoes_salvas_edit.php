...
// Page class
//
class notificacoes_salvas_edit extends notificacoes_salvas
{
	...
	// Page object name
	public $PageObjName = "notificacoes_salvas_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_notificacoes_salvas")) {
				$this->id_notificacoes_salvas->setFormValue($CurrentForm->getValue("x_id_notificacoes_salvas"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_notificacoes_salvas->IsDetailKey)
			$this->id_notificacoes_salvas->setFormValue($val);
	...
	{
		global $CurrentForm;
		$this->id_notificacoes_salvas->CurrentValue = $this->id_notificacoes_salvas->FormValue;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// descricao_notificacoes_salvas
			$this->descricao_notificacoes_salvas->setDbValueDef($rsnew, $this->descricao_notificacoes_salvas->CurrentValue, "", $this->descricao_notificacoes_salvas->ReadOnly);

			// usuario_atuador_notificacoes_salvas
			$this->usuario_atuador_notificacoes_salvas->setDbValueDef($rsnew, $this->usuario_atuador_notificacoes_salvas->CurrentValue, "", $this->usuario_atuador_notificacoes_salvas->ReadOnly);

			// usuaio_requerente_notificacoes_salvas
			$this->usuaio_requerente_notificacoes_salvas->setDbValueDef($rsnew, $this->usuaio_requerente_notificacoes_salvas->CurrentValue, "", $this->usuaio_requerente_notificacoes_salvas->ReadOnly);

			// tipo_alteracao_notificacoes_salvas
			$this->tipo_alteracao_notificacoes_salvas->setDbValueDef($rsnew, $this->tipo_alteracao_notificacoes_salvas->CurrentValue, "", $this->tipo_alteracao_notificacoes_salvas->ReadOnly);
			...
			// data_atualizacao_notificacoes_salvas
			$this->data_atualizacao_notificacoes_salvas->setDbValueDef($rsnew, UnFormatDateTime($this->data_atualizacao_notificacoes_salvas->CurrentValue, 0), CurrentDate(), $this->data_atualizacao_notificacoes_salvas->ReadOnly);

			// bool_ativo_notificacoes_salvas
			$this->bool_ativo_notificacoes_salvas->setDbValueDef($rsnew, $this->bool_ativo_notificacoes_salvas->CurrentValue, 0, $this->bool_ativo_notificacoes_salvas->ReadOnly);
