...
// Page class
//
class configurar_site_delete extends configurar_site
{
	...
	// Page object name
	public $PageObjName = "configurar_site_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("configurar_sitelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("configurar_sitelist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_configurar_site'];
