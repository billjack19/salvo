...
// Page class
//
class notificacoes_edit extends notificacoes
{
	...
	// Page object name
	public $PageObjName = "notificacoes_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_notificacoes")) {
				$this->id_notificacoes->setFormValue($CurrentForm->getValue("x_id_notificacoes"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_notificacoes->IsDetailKey)
			$this->id_notificacoes->setFormValue($val);
	...
	{
		global $CurrentForm;
		$this->id_notificacoes->CurrentValue = $this->id_notificacoes->FormValue;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// descricao_notificacoes
			$this->descricao_notificacoes->setDbValueDef($rsnew, $this->descricao_notificacoes->CurrentValue, "", $this->descricao_notificacoes->ReadOnly);

			// usuario_atuador_notificacoes
			$this->usuario_atuador_notificacoes->setDbValueDef($rsnew, $this->usuario_atuador_notificacoes->CurrentValue, "", $this->usuario_atuador_notificacoes->ReadOnly);

			// usuaio_requerente_notificacoes
			$this->usuaio_requerente_notificacoes->setDbValueDef($rsnew, $this->usuaio_requerente_notificacoes->CurrentValue, "", $this->usuaio_requerente_notificacoes->ReadOnly);

			// tipo_alteracao_notificacoes
			$this->tipo_alteracao_notificacoes->setDbValueDef($rsnew, $this->tipo_alteracao_notificacoes->CurrentValue, "", $this->tipo_alteracao_notificacoes->ReadOnly);
			...
			// bool_view_notificacoes
			$this->bool_view_notificacoes->setDbValueDef($rsnew, $this->bool_view_notificacoes->CurrentValue, 0, $this->bool_view_notificacoes->ReadOnly);

			// data_atualizacao_notificacoes
			$this->data_atualizacao_notificacoes->setDbValueDef($rsnew, UnFormatDateTime($this->data_atualizacao_notificacoes->CurrentValue, 0), CurrentDate(), $this->data_atualizacao_notificacoes->ReadOnly);

			// bool_ativo_notificacoes
			$this->bool_ativo_notificacoes->setDbValueDef($rsnew, $this->bool_ativo_notificacoes->CurrentValue, 0, $this->bool_ativo_notificacoes->ReadOnly);
