...
// Page class
//
class item_orcamento_add extends item_orcamento
{
	...
	// Page object name
	public $PageObjName = "item_orcamento_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_item_orcamento") !== NULL) {
				...
				$this->setKey("id_item_orcamento", $this->id_item_orcamento->CurrentValue); // Set up key
			} else {
				$this->setKey("id_item_orcamento", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "item_orcamentoview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_item_orcamento->OldValue = $this->id_item_orcamento->CurrentValue;
		$this->data_lanc_item_orcamento->CurrentValue = NULL;
		$this->data_lanc_item_orcamento->OldValue = $this->data_lanc_item_orcamento->CurrentValue;
		$this->orcamento_id->CurrentValue = NULL;
		$this->orcamento_id->OldValue = $this->orcamento_id->CurrentValue;
		$this->item_id->CurrentValue = NULL;
		$this->item_id->OldValue = $this->item_id->CurrentValue;
		$this->quantidade_item_orcamento->CurrentValue = NULL;
		$this->quantidade_item_orcamento->OldValue = $this->quantidade_item_orcamento->CurrentValue;
		$this->total_item_orcamento->CurrentValue = NULL;
		$this->total_item_orcamento->OldValue = $this->total_item_orcamento->CurrentValue;
		$this->usuario_id->CurrentValue = NULL;
		$this->usuario_id->OldValue = $this->usuario_id->CurrentValue;
		$this->bool_ativo_item_orcamento->CurrentValue = 1;
	}
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_item_orcamento'] = $this->id_item_orcamento->CurrentValue;
		$row['data_lanc_item_orcamento'] = $this->data_lanc_item_orcamento->CurrentValue;
		$row['orcamento_id'] = $this->orcamento_id->CurrentValue;
		$row['item_id'] = $this->item_id->CurrentValue;
		$row['quantidade_item_orcamento'] = $this->quantidade_item_orcamento->CurrentValue;
		$row['total_item_orcamento'] = $this->total_item_orcamento->CurrentValue;
		$row['usuario_id'] = $this->usuario_id->CurrentValue;
		$row['bool_ativo_item_orcamento'] = $this->bool_ativo_item_orcamento->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// data_lanc_item_orcamento
		$this->data_lanc_item_orcamento->setDbValueDef($rsnew, UnFormatDateTime($this->data_lanc_item_orcamento->CurrentValue, 0), CurrentDate(), FALSE);

		// orcamento_id
		$this->orcamento_id->setDbValueDef($rsnew, $this->orcamento_id->CurrentValue, 0, FALSE);

		// item_id
		$this->item_id->setDbValueDef($rsnew, $this->item_id->CurrentValue, 0, FALSE);

		// quantidade_item_orcamento
		$this->quantidade_item_orcamento->setDbValueDef($rsnew, $this->quantidade_item_orcamento->CurrentValue, 0, FALSE);

		// total_item_orcamento
		$this->total_item_orcamento->setDbValueDef($rsnew, $this->total_item_orcamento->CurrentValue, 0, FALSE);

		// usuario_id
		$this->usuario_id->setDbValueDef($rsnew, $this->usuario_id->CurrentValue, 0, FALSE);

		// bool_ativo_item_orcamento
		$this->bool_ativo_item_orcamento->setDbValueDef($rsnew, $this->bool_ativo_item_orcamento->CurrentValue, NULL, strval($this->bool_ativo_item_orcamento->CurrentValue) == "");
