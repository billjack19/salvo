...
// Page class
//
class topicos_loja_delete extends topicos_loja
{
	...
	// Page object name
	public $PageObjName = "topicos_loja_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("topicos_lojalist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("topicos_lojalist.php"); // Return to list
			}
		}
	}
