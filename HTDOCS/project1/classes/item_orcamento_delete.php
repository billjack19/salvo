...
// Page class
//
class item_orcamento_delete extends item_orcamento
{
	...
	// Page object name
	public $PageObjName = "item_orcamento_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("item_orcamentolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("item_orcamentolist.php"); // Return to list
			}
		}
	}
