...
// Page class
//
class orcamento_delete extends orcamento
{
	...
	// Page object name
	public $PageObjName = "orcamento_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("orcamentolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("orcamentolist.php"); // Return to list
			}
		}
	}
