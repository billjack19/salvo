...
// Page class
//
class empresa_view extends empresa
{
	...
	// Page object name
	public $PageObjName = "empresa_view";
	...
	public function __construct()
	{
		...
		if (Get("id_empresa") !== NULL) {
			$this->RecKey["id_empresa"] = Get("id_empresa");
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_empresa") !== NULL) {
				...
				$this->id_empresa->setQueryStringValue(Key(0));
				$this->RecKey["id_empresa"] = $this->id_empresa->QueryStringValue;
			} elseif (Post("id_empresa") !== NULL) {
				$this->id_empresa->setFormValue(Post("id_empresa"));
				$this->RecKey["id_empresa"] = $this->id_empresa->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_empresa->setFormValue(Route(2));
				$this->RecKey["id_empresa"] = $this->id_empresa->FormValue;
			} else {
				$returnUrl = "empresalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "empresalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "empresalist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
