...
// Page class
//
class new_sjt_delete extends new_sjt
{
	...
	// Page object name
	public $PageObjName = "new_sjt_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("new_sjtlist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("new_sjtlist.php"); // Return to list
			}
		}
	}
