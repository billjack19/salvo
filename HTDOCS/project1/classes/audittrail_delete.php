...
// Page class
//
class audittrail_delete extends audittrail
{
	...
	// Page object name
	public $PageObjName = "audittrail_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("audittraillist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("audittraillist.php"); // Return to list
			}
		}
	}
