...
// Page class
//
class notificacoes_salvas_view extends notificacoes_salvas
{
	...
	// Page object name
	public $PageObjName = "notificacoes_salvas_view";
	...
	public function __construct()
	{
		...
		if (Get("id_notificacoes_salvas") !== NULL) {
			$this->RecKey["id_notificacoes_salvas"] = Get("id_notificacoes_salvas");
			$keyUrl .= "&amp;id_notificacoes_salvas=" . urlencode($this->RecKey["id_notificacoes_salvas"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_notificacoes_salvas") !== NULL) {
				...
				$this->RecKey["id_notificacoes_salvas"] = $this->id_notificacoes_salvas->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_notificacoes_salvas->setQueryStringValue(Key(0));
				$this->RecKey["id_notificacoes_salvas"] = $this->id_notificacoes_salvas->QueryStringValue;
			} elseif (Post("id_notificacoes_salvas") !== NULL) {
				$this->id_notificacoes_salvas->setFormValue(Post("id_notificacoes_salvas"));
				$this->RecKey["id_notificacoes_salvas"] = $this->id_notificacoes_salvas->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_notificacoes_salvas->setFormValue(Route(2));
				$this->RecKey["id_notificacoes_salvas"] = $this->id_notificacoes_salvas->FormValue;
			} else {
				$returnUrl = "notificacoes_salvaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "notificacoes_salvaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "notificacoes_salvaslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
