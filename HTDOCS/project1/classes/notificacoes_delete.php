...
// Page class
//
class notificacoes_delete extends notificacoes
{
	...
	// Page object name
	public $PageObjName = "notificacoes_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("notificacoeslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("notificacoeslist.php"); // Return to list
			}
		}
	}
