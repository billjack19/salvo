...
// Page class
//
class notificacoes_pendentes_delete extends notificacoes_pendentes
{
	...
	// Page object name
	public $PageObjName = "notificacoes_pendentes_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("notificacoes_pendenteslist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("notificacoes_pendenteslist.php"); // Return to list
			}
		}
	}
	...
	protected function deleteRows()
	{
		...
		if ($deleteRows) {
			...
			foreach ($rsold as $row) {
				...
				$thisKey .= $row['id_notificacoes_pendentes'];
