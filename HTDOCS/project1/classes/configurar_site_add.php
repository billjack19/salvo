...
// Page class
//
class configurar_site_add extends configurar_site
{
	...
	// Page object name
	public $PageObjName = "configurar_site_add";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("id_configurar_site") !== NULL) {
				...
				$this->setKey("id_configurar_site", $this->id_configurar_site->CurrentValue); // Set up key
			} else {
				$this->setKey("id_configurar_site", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "configurar_siteview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->id_configurar_site->OldValue = $this->id_configurar_site->CurrentValue;
		$this->titulo_configurar_site->CurrentValue = NULL;
		$this->titulo_configurar_site->OldValue = $this->titulo_configurar_site->CurrentValue;
		$this->titulo_menu_configurar_site->CurrentValue = NULL;
		$this->titulo_menu_configurar_site->OldValue = $this->titulo_menu_configurar_site->CurrentValue;
		$this->cor_pagina_configurar_site->CurrentValue = NULL;
		$this->cor_pagina_configurar_site->OldValue = $this->cor_pagina_configurar_site->CurrentValue;
		$this->contra_cor_pagina_configurar_site->CurrentValue = NULL;
		$this->contra_cor_pagina_configurar_site->OldValue = $this->contra_cor_pagina_configurar_site->CurrentValue;
		$this->imagem_icone_configurar_site->CurrentValue = NULL;
		$this->imagem_icone_configurar_site->OldValue = $this->imagem_icone_configurar_site->CurrentValue;
		$this->imagem_logo_configurar_site->CurrentValue = NULL;
		$this->imagem_logo_configurar_site->OldValue = $this->imagem_logo_configurar_site->CurrentValue;
		$this->data_atualizacao_configurar_site->CurrentValue = NULL;
		$this->data_atualizacao_configurar_site->OldValue = $this->data_atualizacao_configurar_site->CurrentValue;
		$this->usuario_id->CurrentValue = NULL;
		$this->usuario_id->OldValue = $this->usuario_id->CurrentValue;
		$this->bool_ativo_configurar_site->CurrentValue = 1;
	}
	...
	protected function newRow()
	{
		...
		$row = [];
		$row['id_configurar_site'] = $this->id_configurar_site->CurrentValue;
		$row['titulo_configurar_site'] = $this->titulo_configurar_site->CurrentValue;
		$row['titulo_menu_configurar_site'] = $this->titulo_menu_configurar_site->CurrentValue;
		$row['cor_pagina_configurar_site'] = $this->cor_pagina_configurar_site->CurrentValue;
		$row['contra_cor_pagina_configurar_site'] = $this->contra_cor_pagina_configurar_site->CurrentValue;
		$row['imagem_icone_configurar_site'] = $this->imagem_icone_configurar_site->CurrentValue;
		$row['imagem_logo_configurar_site'] = $this->imagem_logo_configurar_site->CurrentValue;
		$row['data_atualizacao_configurar_site'] = $this->data_atualizacao_configurar_site->CurrentValue;
		$row['usuario_id'] = $this->usuario_id->CurrentValue;
		$row['bool_ativo_configurar_site'] = $this->bool_ativo_configurar_site->CurrentValue;
		return $row;
	}
	...
	protected function addRow($rsold = NULL)
	{
		...
		// titulo_configurar_site
		$this->titulo_configurar_site->setDbValueDef($rsnew, $this->titulo_configurar_site->CurrentValue, "", FALSE);

		// titulo_menu_configurar_site
		$this->titulo_menu_configurar_site->setDbValueDef($rsnew, $this->titulo_menu_configurar_site->CurrentValue, "", FALSE);

		// cor_pagina_configurar_site
		$this->cor_pagina_configurar_site->setDbValueDef($rsnew, $this->cor_pagina_configurar_site->CurrentValue, "", FALSE);

		// contra_cor_pagina_configurar_site
		$this->contra_cor_pagina_configurar_site->setDbValueDef($rsnew, $this->contra_cor_pagina_configurar_site->CurrentValue, "", FALSE);

		// imagem_icone_configurar_site
		$this->imagem_icone_configurar_site->setDbValueDef($rsnew, $this->imagem_icone_configurar_site->CurrentValue, "", FALSE);

		// imagem_logo_configurar_site
		$this->imagem_logo_configurar_site->setDbValueDef($rsnew, $this->imagem_logo_configurar_site->CurrentValue, "", FALSE);

		// data_atualizacao_configurar_site
		$this->data_atualizacao_configurar_site->setDbValueDef($rsnew, UnFormatDateTime($this->data_atualizacao_configurar_site->CurrentValue, 0), NULL, FALSE);

		// usuario_id
		$this->usuario_id->setDbValueDef($rsnew, $this->usuario_id->CurrentValue, 0, FALSE);

		// bool_ativo_configurar_site
		$this->bool_ativo_configurar_site->setDbValueDef($rsnew, $this->bool_ativo_configurar_site->CurrentValue, 0, strval($this->bool_ativo_configurar_site->CurrentValue) == "");
