...
// Page class
//
class contato_edit extends contato
{
	...
	// Page object name
	public $PageObjName = "contato_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_id_contato")) {
				$this->id_contato->setFormValue($CurrentForm->getValue("x_id_contato"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->id_contato->IsDetailKey)
			$this->id_contato->setFormValue($val);
	...
	{
		global $CurrentForm;
		$this->id_contato->CurrentValue = $this->id_contato->FormValue;
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// nome_contato
			$this->nome_contato->setDbValueDef($rsnew, $this->nome_contato->CurrentValue, "", $this->nome_contato->ReadOnly);

			// email_contato
			$this->email_contato->setDbValueDef($rsnew, $this->email_contato->CurrentValue, NULL, $this->email_contato->ReadOnly);

			// telefone_contato
			$this->telefone_contato->setDbValueDef($rsnew, $this->telefone_contato->CurrentValue, NULL, $this->telefone_contato->ReadOnly);

			// assunto_contato
			$this->assunto_contato->setDbValueDef($rsnew, $this->assunto_contato->CurrentValue, NULL, $this->assunto_contato->ReadOnly);

			// mensagem_contato
			$this->mensagem_contato->setDbValueDef($rsnew, $this->mensagem_contato->CurrentValue, NULL, $this->mensagem_contato->ReadOnly);

			// usuario_id
			$this->usuario_id->setDbValueDef($rsnew, $this->usuario_id->CurrentValue, 0, $this->usuario_id->ReadOnly);

			// data_atualizacao_contato
			$this->data_atualizacao_contato->setDbValueDef($rsnew, UnFormatDateTime($this->data_atualizacao_contato->CurrentValue, 0), CurrentDate(), $this->data_atualizacao_contato->ReadOnly);

			// bool_ativo_contato
			$this->bool_ativo_contato->setDbValueDef($rsnew, $this->bool_ativo_contato->CurrentValue, 0, $this->bool_ativo_contato->ReadOnly);
