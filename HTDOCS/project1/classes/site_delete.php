...
// Page class
//
class site_delete extends site
{
	...
	// Page object name
	public $PageObjName = "site_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("sitelist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("sitelist.php"); // Return to list
			}
		}
	}
