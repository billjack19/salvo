...
// Page class
//
class usuario_delete extends usuario
{
	...
	// Page object name
	public $PageObjName = "usuario_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("usuariolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("usuariolist.php"); // Return to list
			}
		}
	}
