...
// Page class
//
class contato_delete extends contato
{
	...
	// Page object name
	public $PageObjName = "contato_delete";
	...
	public function run()
	{
		...
		if ($filter == "")
			$this->terminate("contatolist.php"); // Prevent SQL injection, return to list
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("contatolist.php"); // Return to list
			}
		}
	}
