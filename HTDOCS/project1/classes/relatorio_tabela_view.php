...
// Page class
//
class relatorio_tabela_view extends relatorio_tabela
{
	...
	// Page object name
	public $PageObjName = "relatorio_tabela_view";
	...
	public function __construct()
	{
		...
		if (Get("id_relatorio_tabela") !== NULL) {
			$this->RecKey["id_relatorio_tabela"] = Get("id_relatorio_tabela");
			$keyUrl .= "&amp;id_relatorio_tabela=" . urlencode($this->RecKey["id_relatorio_tabela"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id_relatorio_tabela") !== NULL) {
				...
				$this->RecKey["id_relatorio_tabela"] = $this->id_relatorio_tabela->QueryStringValue;
			} elseif (IsApi() && Key(0) != NULL) {
				$this->id_relatorio_tabela->setQueryStringValue(Key(0));
				$this->RecKey["id_relatorio_tabela"] = $this->id_relatorio_tabela->QueryStringValue;
			} elseif (Post("id_relatorio_tabela") !== NULL) {
				$this->id_relatorio_tabela->setFormValue(Post("id_relatorio_tabela"));
				$this->RecKey["id_relatorio_tabela"] = $this->id_relatorio_tabela->FormValue;
			} elseif (IsApi() && Route(2) != NULL) {
				$this->id_relatorio_tabela->setFormValue(Route(2));
				$this->RecKey["id_relatorio_tabela"] = $this->id_relatorio_tabela->FormValue;
			} else {
				$returnUrl = "relatorio_tabelalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "relatorio_tabelalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "relatorio_tabelalist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "")
