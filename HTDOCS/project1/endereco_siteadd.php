...
// Create page object
$endereco_site_add = new endereco_site_add();

// Run the page
$endereco_site_add->run();
...
var fendereco_siteadd = currentForm = new ew.Form("fendereco_siteadd", "add");

// Validate form
fendereco_siteadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($endereco_site_add->descricao_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->endereco_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->numero_endereco_site->Required) { ?>
		...
		<?php if ($endereco_site_add->complemento_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->bairro_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->cidade_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->estado_id->Required) { ?>
		...
		<?php if ($endereco_site_add->cep_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->telefone_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->celular_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->email_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->horario_funcionamento_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->latitude_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->longitude_endereco_site->Required) { ?>
		...
		<?php } ?>
		<?php if ($endereco_site_add->data_atualizacao_endereco_site->Required) { ?>
		...
		<?php if ($endereco_site_add->usuario_id->Required) { ?>
		...
		<?php if ($endereco_site_add->bool_ativo_endereco_site->Required) { ?>
...
fendereco_siteadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fendereco_siteadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $endereco_site_add->showPageHeader(); ?>
<?php
$endereco_site_add->showMessage();
?>
<form name="fendereco_siteadd" id="fendereco_siteadd" class="<?php echo $endereco_site_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($endereco_site_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $endereco_site_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="endereco_site">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$endereco_site_add->IsModal ?>">
...
<?php if ($endereco_site->descricao_endereco_site->Visible) { // descricao_endereco_site ?>
	<div id="r_descricao_endereco_site" class="form-group row">
		<label id="elh_endereco_site_descricao_endereco_site" for="x_descricao_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->descricao_endereco_site->caption() ?><?php echo ($endereco_site->descricao_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->descricao_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->endereco_endereco_site->Visible) { // endereco_endereco_site ?>
	<div id="r_endereco_endereco_site" class="form-group row">
		<label id="elh_endereco_site_endereco_endereco_site" for="x_endereco_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->endereco_endereco_site->caption() ?><?php echo ($endereco_site->endereco_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->endereco_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->numero_endereco_site->Visible) { // numero_endereco_site ?>
	<div id="r_numero_endereco_site" class="form-group row">
		<label id="elh_endereco_site_numero_endereco_site" for="x_numero_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->numero_endereco_site->caption() ?><?php echo ($endereco_site->numero_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->numero_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->complemento_endereco_site->Visible) { // complemento_endereco_site ?>
	<div id="r_complemento_endereco_site" class="form-group row">
		<label id="elh_endereco_site_complemento_endereco_site" for="x_complemento_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->complemento_endereco_site->caption() ?><?php echo ($endereco_site->complemento_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->complemento_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->bairro_endereco_site->Visible) { // bairro_endereco_site ?>
	<div id="r_bairro_endereco_site" class="form-group row">
		<label id="elh_endereco_site_bairro_endereco_site" for="x_bairro_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->bairro_endereco_site->caption() ?><?php echo ($endereco_site->bairro_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->bairro_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->cidade_endereco_site->Visible) { // cidade_endereco_site ?>
	<div id="r_cidade_endereco_site" class="form-group row">
		<label id="elh_endereco_site_cidade_endereco_site" for="x_cidade_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->cidade_endereco_site->caption() ?><?php echo ($endereco_site->cidade_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->cidade_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->estado_id->Visible) { // estado_id ?>
	<div id="r_estado_id" class="form-group row">
		<label id="elh_endereco_site_estado_id" for="x_estado_id" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->estado_id->caption() ?><?php echo ($endereco_site->estado_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->estado_id->cellAttributes() ?>>
...
<?php if ($endereco_site->cep_endereco_site->Visible) { // cep_endereco_site ?>
	<div id="r_cep_endereco_site" class="form-group row">
		<label id="elh_endereco_site_cep_endereco_site" for="x_cep_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->cep_endereco_site->caption() ?><?php echo ($endereco_site->cep_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->cep_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->telefone_endereco_site->Visible) { // telefone_endereco_site ?>
	<div id="r_telefone_endereco_site" class="form-group row">
		<label id="elh_endereco_site_telefone_endereco_site" for="x_telefone_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->telefone_endereco_site->caption() ?><?php echo ($endereco_site->telefone_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->telefone_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->celular_endereco_site->Visible) { // celular_endereco_site ?>
	<div id="r_celular_endereco_site" class="form-group row">
		<label id="elh_endereco_site_celular_endereco_site" for="x_celular_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->celular_endereco_site->caption() ?><?php echo ($endereco_site->celular_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->celular_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->email_endereco_site->Visible) { // email_endereco_site ?>
	<div id="r_email_endereco_site" class="form-group row">
		<label id="elh_endereco_site_email_endereco_site" for="x_email_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->email_endereco_site->caption() ?><?php echo ($endereco_site->email_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->email_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->horario_funcionamento_endereco_site->Visible) { // horario_funcionamento_endereco_site ?>
	<div id="r_horario_funcionamento_endereco_site" class="form-group row">
		<label id="elh_endereco_site_horario_funcionamento_endereco_site" for="x_horario_funcionamento_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->horario_funcionamento_endereco_site->caption() ?><?php echo ($endereco_site->horario_funcionamento_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->horario_funcionamento_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->latitude_endereco_site->Visible) { // latitude_endereco_site ?>
	<div id="r_latitude_endereco_site" class="form-group row">
		<label id="elh_endereco_site_latitude_endereco_site" for="x_latitude_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->latitude_endereco_site->caption() ?><?php echo ($endereco_site->latitude_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->latitude_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->longitude_endereco_site->Visible) { // longitude_endereco_site ?>
	<div id="r_longitude_endereco_site" class="form-group row">
		<label id="elh_endereco_site_longitude_endereco_site" for="x_longitude_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->longitude_endereco_site->caption() ?><?php echo ($endereco_site->longitude_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->longitude_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->data_atualizacao_endereco_site->Visible) { // data_atualizacao_endereco_site ?>
	<div id="r_data_atualizacao_endereco_site" class="form-group row">
		<label id="elh_endereco_site_data_atualizacao_endereco_site" for="x_data_atualizacao_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->data_atualizacao_endereco_site->caption() ?><?php echo ($endereco_site->data_atualizacao_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->data_atualizacao_endereco_site->cellAttributes() ?>>
...
<?php if ($endereco_site->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_endereco_site_usuario_id" for="x_usuario_id" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->usuario_id->caption() ?><?php echo ($endereco_site->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->usuario_id->cellAttributes() ?>>
...
<?php if ($endereco_site->bool_ativo_endereco_site->Visible) { // bool_ativo_endereco_site ?>
	<div id="r_bool_ativo_endereco_site" class="form-group row">
		<label id="elh_endereco_site_bool_ativo_endereco_site" for="x_bool_ativo_endereco_site" class="<?php echo $endereco_site_add->LeftColumnClass ?>"><?php echo $endereco_site->bool_ativo_endereco_site->caption() ?><?php echo ($endereco_site->bool_ativo_endereco_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $endereco_site_add->RightColumnClass ?>"><div<?php echo $endereco_site->bool_ativo_endereco_site->cellAttributes() ?>>
...
<?php if (!$endereco_site_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $endereco_site_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $endereco_site_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$endereco_site_add->showPageFooter();
if (DEBUG_ENABLED)
