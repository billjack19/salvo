...
// Create page object
$saiba_mais_add = new saiba_mais_add();
...
var fsaiba_maisadd = currentForm = new ew.Form("fsaiba_maisadd", "add");

// Validate form
fsaiba_maisadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($saiba_mais_add->descricao_saiba_mais->Required) { ?>
		...
		<?php } ?>
		<?php if ($saiba_mais_add->pagina_principal_id->Required) { ?>
		...
		<?php if ($saiba_mais_add->usuario_id->Required) { ?>
		...
		<?php if ($saiba_mais_add->data_atualizacao_saiba_mais->Required) { ?>
		...
		<?php if ($saiba_mais_add->bool_ativo_saiba_mais->Required) { ?>
...
fsaiba_maisadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fsaiba_maisadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $saiba_mais_add->showPageHeader(); ?>
<?php
$saiba_mais_add->showMessage();
?>
<form name="fsaiba_maisadd" id="fsaiba_maisadd" class="<?php echo $saiba_mais_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($saiba_mais_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $saiba_mais_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="saiba_mais">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$saiba_mais_add->IsModal ?>">
...
<?php if ($saiba_mais->descricao_saiba_mais->Visible) { // descricao_saiba_mais ?>
	<div id="r_descricao_saiba_mais" class="form-group row">
		<label id="elh_saiba_mais_descricao_saiba_mais" for="x_descricao_saiba_mais" class="<?php echo $saiba_mais_add->LeftColumnClass ?>"><?php echo $saiba_mais->descricao_saiba_mais->caption() ?><?php echo ($saiba_mais->descricao_saiba_mais->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $saiba_mais_add->RightColumnClass ?>"><div<?php echo $saiba_mais->descricao_saiba_mais->cellAttributes() ?>>
...
<?php if ($saiba_mais->pagina_principal_id->Visible) { // pagina_principal_id ?>
	<div id="r_pagina_principal_id" class="form-group row">
		<label id="elh_saiba_mais_pagina_principal_id" for="x_pagina_principal_id" class="<?php echo $saiba_mais_add->LeftColumnClass ?>"><?php echo $saiba_mais->pagina_principal_id->caption() ?><?php echo ($saiba_mais->pagina_principal_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $saiba_mais_add->RightColumnClass ?>"><div<?php echo $saiba_mais->pagina_principal_id->cellAttributes() ?>>
...
<?php if ($saiba_mais->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_saiba_mais_usuario_id" for="x_usuario_id" class="<?php echo $saiba_mais_add->LeftColumnClass ?>"><?php echo $saiba_mais->usuario_id->caption() ?><?php echo ($saiba_mais->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $saiba_mais_add->RightColumnClass ?>"><div<?php echo $saiba_mais->usuario_id->cellAttributes() ?>>
...
<?php if ($saiba_mais->data_atualizacao_saiba_mais->Visible) { // data_atualizacao_saiba_mais ?>
	<div id="r_data_atualizacao_saiba_mais" class="form-group row">
		<label id="elh_saiba_mais_data_atualizacao_saiba_mais" for="x_data_atualizacao_saiba_mais" class="<?php echo $saiba_mais_add->LeftColumnClass ?>"><?php echo $saiba_mais->data_atualizacao_saiba_mais->caption() ?><?php echo ($saiba_mais->data_atualizacao_saiba_mais->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $saiba_mais_add->RightColumnClass ?>"><div<?php echo $saiba_mais->data_atualizacao_saiba_mais->cellAttributes() ?>>
...
<?php if ($saiba_mais->bool_ativo_saiba_mais->Visible) { // bool_ativo_saiba_mais ?>
	<div id="r_bool_ativo_saiba_mais" class="form-group row">
		<label id="elh_saiba_mais_bool_ativo_saiba_mais" for="x_bool_ativo_saiba_mais" class="<?php echo $saiba_mais_add->LeftColumnClass ?>"><?php echo $saiba_mais->bool_ativo_saiba_mais->caption() ?><?php echo ($saiba_mais->bool_ativo_saiba_mais->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $saiba_mais_add->RightColumnClass ?>"><div<?php echo $saiba_mais->bool_ativo_saiba_mais->cellAttributes() ?>>
...
<?php if (!$saiba_mais_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $saiba_mais_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $saiba_mais_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$saiba_mais_add->showPageFooter();
if (DEBUG_ENABLED)
