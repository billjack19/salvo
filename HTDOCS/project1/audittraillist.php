...
<?php if ($audittrail->action->Visible) { // action ?>
	<?php if ($audittrail->sortUrl($audittrail->action) == "") { ?>
		<th data-name="action" class="<?php echo $audittrail->action->headerCellClass() ?>"><div id="elh_audittrail_action" class="audittrail_action"><div class="ew-table-header-caption"><?php echo $audittrail->action->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="action" class="<?php echo $audittrail->action->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event,'<?php echo $audittrail->SortUrl($audittrail->action) ?>',1);"><div id="elh_audittrail_action" class="audittrail_action">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $audittrail->action->caption() ?><?php echo $Language->Phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($audittrail->action->getSort() == "ASC") { ?><i class="fa fa-sort-up"></i><?php } elseif ($audittrail->action->getSort() == "DESC") { ?><i class="fa fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php echo $audittrail->action->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($audittrail->_table->Visible) { // table ?>
