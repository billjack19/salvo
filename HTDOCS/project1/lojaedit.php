...
var flojaedit = currentForm = new ew.Form("flojaedit", "edit");

// Validate form
flojaedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($loja_edit->id_loja->Required) { ?>
			elm = this.getElements("x" + infix + "_id_loja");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $loja->id_loja->caption(), $loja->id_loja->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($loja_edit->titulo_loja->Required) { ?>
		...
		<?php } ?>
		<?php if ($loja_edit->descricao_loja->Required) { ?>
		...
		<?php } ?>
		<?php if ($loja_edit->imagem_loja->Required) { ?>
		...
		<?php } ?>
		<?php if ($loja_edit->pagina_principal_id->Required) { ?>
		...
		<?php if ($loja_edit->data_atualizacao_loja->Required) { ?>
		...
		<?php if ($loja_edit->usuario_id->Required) { ?>
		...
		<?php if ($loja_edit->bool_ativo_loja->Required) { ?>
...
flojaedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
flojaedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $loja_edit->showPageHeader(); ?>
<?php
$loja_edit->showMessage();
?>
<form name="flojaedit" id="flojaedit" class="<?php echo $loja_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($loja_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $loja_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="loja">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$loja_edit->IsModal ?>">
<div class="ew-edit-div"><!-- page* -->
<?php if ($loja->id_loja->Visible) { // id_loja ?>
	<div id="r_id_loja" class="form-group row">
		<label id="elh_loja_id_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->id_loja->caption() ?><?php echo ($loja->id_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->id_loja->cellAttributes() ?>>
<span id="el_loja_id_loja">
<span<?php echo $loja->id_loja->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($loja->id_loja->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="loja" data-field="x_id_loja" name="x_id_loja" id="x_id_loja" value="<?php echo HtmlEncode($loja->id_loja->CurrentValue) ?>">
<?php echo $loja->id_loja->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($loja->titulo_loja->Visible) { // titulo_loja ?>
	<div id="r_titulo_loja" class="form-group row">
		<label id="elh_loja_titulo_loja" for="x_titulo_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->titulo_loja->caption() ?><?php echo ($loja->titulo_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->titulo_loja->cellAttributes() ?>>
...
<?php if ($loja->descricao_loja->Visible) { // descricao_loja ?>
	<div id="r_descricao_loja" class="form-group row">
		<label id="elh_loja_descricao_loja" for="x_descricao_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->descricao_loja->caption() ?><?php echo ($loja->descricao_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->descricao_loja->cellAttributes() ?>>
...
<?php if ($loja->imagem_loja->Visible) { // imagem_loja ?>
	<div id="r_imagem_loja" class="form-group row">
		<label id="elh_loja_imagem_loja" for="x_imagem_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->imagem_loja->caption() ?><?php echo ($loja->imagem_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->imagem_loja->cellAttributes() ?>>
...
<?php if ($loja->pagina_principal_id->Visible) { // pagina_principal_id ?>
	<div id="r_pagina_principal_id" class="form-group row">
		<label id="elh_loja_pagina_principal_id" for="x_pagina_principal_id" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->pagina_principal_id->caption() ?><?php echo ($loja->pagina_principal_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->pagina_principal_id->cellAttributes() ?>>
...
<?php if ($loja->data_atualizacao_loja->Visible) { // data_atualizacao_loja ?>
	<div id="r_data_atualizacao_loja" class="form-group row">
		<label id="elh_loja_data_atualizacao_loja" for="x_data_atualizacao_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->data_atualizacao_loja->caption() ?><?php echo ($loja->data_atualizacao_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->data_atualizacao_loja->cellAttributes() ?>>
...
<?php if ($loja->usuario_id->Visible) { // usuario_id ?>
	<div id="r_usuario_id" class="form-group row">
		<label id="elh_loja_usuario_id" for="x_usuario_id" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->usuario_id->caption() ?><?php echo ($loja->usuario_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->usuario_id->cellAttributes() ?>>
...
<?php if ($loja->bool_ativo_loja->Visible) { // bool_ativo_loja ?>
	<div id="r_bool_ativo_loja" class="form-group row">
		<label id="elh_loja_bool_ativo_loja" for="x_bool_ativo_loja" class="<?php echo $loja_edit->LeftColumnClass ?>"><?php echo $loja->bool_ativo_loja->caption() ?><?php echo ($loja->bool_ativo_loja->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $loja_edit->RightColumnClass ?>"><div<?php echo $loja->bool_ativo_loja->cellAttributes() ?>>
...
<?php if (!$loja_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $loja_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $loja_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$loja_edit->showPageFooter();
if (DEBUG_ENABLED)
