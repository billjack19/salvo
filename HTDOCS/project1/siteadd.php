...
var fsiteadd = currentForm = new ew.Form("fsiteadd", "add");

// Validate form
fsiteadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($site_add->NOME_EMPRESA->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->NOME_CIDADE->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->FONE_APP->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->sendpassword->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->smtpserver->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->smtpserverport->Required) { ?>
		...
		<?php if ($site_add->MailFrom->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->MailTo->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->MailCc->Required) { ?>
		...
		<?php } ?>
		<?php if ($site_add->bool_ativo_site->Required) { ?>
...
fsiteadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fsiteadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $site_add->showPageHeader(); ?>
<?php
$site_add->showMessage();
?>
<form name="fsiteadd" id="fsiteadd" class="<?php echo $site_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($site_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $site_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="site">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$site_add->IsModal ?>">
<div class="ew-add-div"><!-- page* -->
<?php if ($site->NOME_EMPRESA->Visible) { // NOME_EMPRESA ?>
	<div id="r_NOME_EMPRESA" class="form-group row">
		<label id="elh_site_NOME_EMPRESA" for="x_NOME_EMPRESA" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->NOME_EMPRESA->caption() ?><?php echo ($site->NOME_EMPRESA->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->NOME_EMPRESA->cellAttributes() ?>>
...
<?php if ($site->NOME_CIDADE->Visible) { // NOME_CIDADE ?>
	<div id="r_NOME_CIDADE" class="form-group row">
		<label id="elh_site_NOME_CIDADE" for="x_NOME_CIDADE" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->NOME_CIDADE->caption() ?><?php echo ($site->NOME_CIDADE->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->NOME_CIDADE->cellAttributes() ?>>
...
<?php if ($site->ESTADO->Visible) { // ESTADO ?>
	<div id="r_ESTADO" class="form-group row">
		<label id="elh_site_ESTADO" for="x_ESTADO" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->ESTADO->caption() ?><?php echo ($site->ESTADO->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->ESTADO->cellAttributes() ?>>
...
<?php if ($site->FONE->Visible) { // FONE ?>
	<div id="r_FONE" class="form-group row">
		<label id="elh_site_FONE" for="x_FONE" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->FONE->caption() ?><?php echo ($site->FONE->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->FONE->cellAttributes() ?>>
...
<?php if ($site->FONE_APP->Visible) { // FONE_APP ?>
	<div id="r_FONE_APP" class="form-group row">
		<label id="elh_site_FONE_APP" for="x_FONE_APP" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->FONE_APP->caption() ?><?php echo ($site->FONE_APP->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->FONE_APP->cellAttributes() ?>>
...
<?php if ($site->_EMAIL->Visible) { // EMAIL ?>
	<div id="r__EMAIL" class="form-group row">
		<label id="elh_site__EMAIL" for="x__EMAIL" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->_EMAIL->caption() ?><?php echo ($site->_EMAIL->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->_EMAIL->cellAttributes() ?>>
...
<?php if ($site->sendusername->Visible) { // sendusername ?>
	<div id="r_sendusername" class="form-group row">
		<label id="elh_site_sendusername" for="x_sendusername" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->sendusername->caption() ?><?php echo ($site->sendusername->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->sendusername->cellAttributes() ?>>
...
<?php if ($site->sendpassword->Visible) { // sendpassword ?>
	<div id="r_sendpassword" class="form-group row">
		<label id="elh_site_sendpassword" for="x_sendpassword" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->sendpassword->caption() ?><?php echo ($site->sendpassword->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->sendpassword->cellAttributes() ?>>
...
<?php if ($site->smtpserver->Visible) { // smtpserver ?>
	<div id="r_smtpserver" class="form-group row">
		<label id="elh_site_smtpserver" for="x_smtpserver" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->smtpserver->caption() ?><?php echo ($site->smtpserver->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->smtpserver->cellAttributes() ?>>
...
<?php if ($site->smtpserverport->Visible) { // smtpserverport ?>
	<div id="r_smtpserverport" class="form-group row">
		<label id="elh_site_smtpserverport" for="x_smtpserverport" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->smtpserverport->caption() ?><?php echo ($site->smtpserverport->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->smtpserverport->cellAttributes() ?>>
...
<?php if ($site->MailFrom->Visible) { // MailFrom ?>
	<div id="r_MailFrom" class="form-group row">
		<label id="elh_site_MailFrom" for="x_MailFrom" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->MailFrom->caption() ?><?php echo ($site->MailFrom->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->MailFrom->cellAttributes() ?>>
...
<?php if ($site->MailTo->Visible) { // MailTo ?>
	<div id="r_MailTo" class="form-group row">
		<label id="elh_site_MailTo" for="x_MailTo" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->MailTo->caption() ?><?php echo ($site->MailTo->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->MailTo->cellAttributes() ?>>
...
<?php if ($site->MailCc->Visible) { // MailCc ?>
	<div id="r_MailCc" class="form-group row">
		<label id="elh_site_MailCc" for="x_MailCc" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->MailCc->caption() ?><?php echo ($site->MailCc->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->MailCc->cellAttributes() ?>>
...
<?php if ($site->bool_ativo_site->Visible) { // bool_ativo_site ?>
	<div id="r_bool_ativo_site" class="form-group row">
		<label id="elh_site_bool_ativo_site" for="x_bool_ativo_site" class="<?php echo $site_add->LeftColumnClass ?>"><?php echo $site->bool_ativo_site->caption() ?><?php echo ($site->bool_ativo_site->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $site_add->RightColumnClass ?>"><div<?php echo $site->bool_ativo_site->cellAttributes() ?>>
...
<?php if (!$site_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $site_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $site_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$site_add->showPageFooter();
if (DEBUG_ENABLED)
