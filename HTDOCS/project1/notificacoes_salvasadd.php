...
// Create page object
$notificacoes_salvas_add = new notificacoes_salvas_add();

// Run the page
$notificacoes_salvas_add->run();
...
$notificacoes_salvas_add->Page_Render();
?>
...
var fnotificacoes_salvasadd = currentForm = new ew.Form("fnotificacoes_salvasadd", "add");

// Validate form
fnotificacoes_salvasadd.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($notificacoes_salvas_add->descricao_notificacoes_salvas->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_salvas_add->usuario_atuador_notificacoes_salvas->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_salvas_add->usuaio_requerente_notificacoes_salvas->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_salvas_add->tipo_alteracao_notificacoes_salvas->Required) { ?>
		...
		<?php } ?>
		<?php if ($notificacoes_salvas_add->notificacoes_config_id->Required) { ?>
		...
		<?php if ($notificacoes_salvas_add->data_atualizacao_notificacoes_salvas->Required) { ?>
		...
		<?php if ($notificacoes_salvas_add->bool_ativo_notificacoes_salvas->Required) { ?>
...
fnotificacoes_salvasadd.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
fnotificacoes_salvasadd.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;
...
<?php $notificacoes_salvas_add->showPageHeader(); ?>
<?php
$notificacoes_salvas_add->showMessage();
?>
<form name="fnotificacoes_salvasadd" id="fnotificacoes_salvasadd" class="<?php echo $notificacoes_salvas_add->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($notificacoes_salvas_add->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $notificacoes_salvas_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="notificacoes_salvas">
<input type="hidden" name="action" id="action" value="insert">
<input type="hidden" name="modal" value="<?php echo (int)$notificacoes_salvas_add->IsModal ?>">
...
<?php if ($notificacoes_salvas->descricao_notificacoes_salvas->Visible) { // descricao_notificacoes_salvas ?>
	<div id="r_descricao_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_descricao_notificacoes_salvas" for="x_descricao_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->descricao_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->descricao_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->descricao_notificacoes_salvas->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->usuario_atuador_notificacoes_salvas->Visible) { // usuario_atuador_notificacoes_salvas ?>
	<div id="r_usuario_atuador_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_usuario_atuador_notificacoes_salvas" for="x_usuario_atuador_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->usuario_atuador_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->usuario_atuador_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->usuario_atuador_notificacoes_salvas->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->usuaio_requerente_notificacoes_salvas->Visible) { // usuaio_requerente_notificacoes_salvas ?>
	<div id="r_usuaio_requerente_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_usuaio_requerente_notificacoes_salvas" for="x_usuaio_requerente_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->usuaio_requerente_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->usuaio_requerente_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->usuaio_requerente_notificacoes_salvas->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->tipo_alteracao_notificacoes_salvas->Visible) { // tipo_alteracao_notificacoes_salvas ?>
	<div id="r_tipo_alteracao_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_tipo_alteracao_notificacoes_salvas" for="x_tipo_alteracao_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->tipo_alteracao_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->tipo_alteracao_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->tipo_alteracao_notificacoes_salvas->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->notificacoes_config_id->Visible) { // notificacoes_config_id ?>
	<div id="r_notificacoes_config_id" class="form-group row">
		<label id="elh_notificacoes_salvas_notificacoes_config_id" for="x_notificacoes_config_id" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->notificacoes_config_id->caption() ?><?php echo ($notificacoes_salvas->notificacoes_config_id->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->notificacoes_config_id->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->data_atualizacao_notificacoes_salvas->Visible) { // data_atualizacao_notificacoes_salvas ?>
	<div id="r_data_atualizacao_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_data_atualizacao_notificacoes_salvas" for="x_data_atualizacao_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->data_atualizacao_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->data_atualizacao_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->data_atualizacao_notificacoes_salvas->cellAttributes() ?>>
...
<?php if ($notificacoes_salvas->bool_ativo_notificacoes_salvas->Visible) { // bool_ativo_notificacoes_salvas ?>
	<div id="r_bool_ativo_notificacoes_salvas" class="form-group row">
		<label id="elh_notificacoes_salvas_bool_ativo_notificacoes_salvas" for="x_bool_ativo_notificacoes_salvas" class="<?php echo $notificacoes_salvas_add->LeftColumnClass ?>"><?php echo $notificacoes_salvas->bool_ativo_notificacoes_salvas->caption() ?><?php echo ($notificacoes_salvas->bool_ativo_notificacoes_salvas->Required) ? $Language->Phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $notificacoes_salvas_add->RightColumnClass ?>"><div<?php echo $notificacoes_salvas->bool_ativo_notificacoes_salvas->cellAttributes() ?>>
...
<?php if (!$notificacoes_salvas_add->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $notificacoes_salvas_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $notificacoes_salvas_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$notificacoes_salvas_add->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$notificacoes_salvas_add->terminate();
?>
