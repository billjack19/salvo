...
<head>
	<title>admim</title>
	<link rel='shortcut icon' href='app/img/Logotipo.png' />
											...
											<div class="panel-body">
												<div class="row">
													...
													<div class="col-md-12">
														...
														<input type="hidden" name="grade" data-p="cliente_site" data-g="orcamento" value="0">
														<input type="hidden" name="grade" data-p="orcamento" data-g="item_orcamento" value="0">
														<input type="hidden" name="grade" data-p="configurar_site" data-g="cards" value="0">
														<input type="hidden" name="grade" data-p="configurar_site" data-g="slide_show" value="0">
														<input type="hidden" name="grade" data-p="configurar_site" data-g="endereco_site" value="0">
														<input type="hidden" name="grade" data-p="configurar_site" data-g="loja" value="0">
														<input type="hidden" name="grade" data-p="loja" data-g="topicos_loja" value="0">
														<input type="hidden" name="grade" data-p="configurar_site" data-g="destaque_grupo" value="0">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form action="uploard.php" id="formulario_imgem" method="POST" enctype="multipart/form-data">
						...
						<input type="hidden" name="pasta" value="app/upload/img"><!--  amfiosecabos.com.br/web/admin/ -->
