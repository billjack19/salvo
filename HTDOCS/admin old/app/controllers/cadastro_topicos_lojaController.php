...
<?php 
	...
	$entidadeTopicos_loja->set($_POST['loja_id'], 'loja_id');
	$entidadeTopicos_loja->set($_POST['data_atualizacao_topicos_loja'], 'data_atualizacao_topicos_loja');
	$entidadeTopicos_loja->set($_POST['bool_ativo_topicos_loja'], 'bool_ativo_topicos_loja');

	$retorno = $topicos_lojaDAO->cadastraTopicos_loja($entidadeTopicos_loja);
	echo $retorno;
?>
