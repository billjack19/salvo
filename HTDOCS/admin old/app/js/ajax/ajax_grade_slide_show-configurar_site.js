	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_grade_slide_show-configurar_site' style='color: #f0ad4e;' data-id='"+id_slide_show+"' onclick='editar(this);' title='Editar' "+desabilitar+">";
				...
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='#!grade_slide_show-configurar_site' style='color: "+cor_ativo+"' data-id='"+id_slide_show+"' onclick=\"excluir(this , 'slide_show')\" title='Excluir'>";
