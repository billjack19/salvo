	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_grade_item_orcamento-orcamento' style='color: #f0ad4e;' data-id='"+id_item_orcamento+"' onclick='editar(this);' title='Editar' "+desabilitar+">";
				...
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='#!grade_item_orcamento-orcamento' style='color: "+cor_ativo+"' data-id='"+id_item_orcamento+"' onclick=\"excluir(this , 'item_orcamento')\" title='Excluir'>";
