	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_grade_destaque_grupo-configurar_site' style='color: #f0ad4e;' data-id='"+id_destaque_grupo+"' onclick='editar(this);' title='Editar' "+desabilitar+">";
				...
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='#!grade_destaque_grupo-configurar_site' style='color: "+cor_ativo+"' data-id='"+id_destaque_grupo+"' onclick=\"excluir(this , 'destaque_grupo')\" title='Excluir'>";
