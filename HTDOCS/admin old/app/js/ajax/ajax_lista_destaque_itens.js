...
$(document).ready(function(){
	...
	$.ajax({
		...
		type: 'POST',
		dataType: 'text',
		data: { 'pequisa_destaque_itens': true }
	}).done( function(data){
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_destaque_itens' style='color: #f0ad4e;' data-id='"+id_destaque_itens+"' onclick='editar(this);' title='Editar' "+desabilitar+">";
				tabelaViewBody +=				 	"<b><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i></b>";
				tabelaViewBody += 				"</a>";
				tabelaViewBody +=			"</td>";
				tabelaViewBody += 			"<td>"+descricao_destaque_itens+"</td>";
				tabelaViewBody += 			"<td><div id='item_"+parseInt(id_destaque_itens)+"'></div></td>";
				tabelaViewBody += 			"<td><div id='configurar_site_"+parseInt(id_destaque_itens)+"'></div></td>";
				tabelaViewBody += 			"<td>"+formatarData(data_atualizacao_destaque_itens)+"</td>";
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='#!destaque_itens' style='color: "+cor_ativo+"' data-id='"+id_destaque_itens+"' onclick=\"excluir(this , 'destaque_itens')\" title='Excluir'>";
			...
			telaCadastroDestaque_itens += 			"<td><b>Configurar Site</b></td>";
