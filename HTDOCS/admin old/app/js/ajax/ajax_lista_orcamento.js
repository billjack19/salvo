	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_orcamento' style='color: #f0ad4e;' data-id='"+id_orcamento+"' onclick='editar(this);' title='Editar' "+desabilitar+">";
				...
				tabelaViewBody +=  			"</td>";
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='#!orcamento' style='color: "+cor_ativo+"' data-id='"+id_orcamento+"' onclick=\"excluir(this , 'orcamento')\" title='Excluir'>";
