...
$log_emprestimo_livro = NULL;

//
// Table class for log_emprestimo_livro
//
class clog_emprestimo_livro extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'log_emprestimo_livro';
		$this->TableName = 'log_emprestimo_livro';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`log_emprestimo_livro`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID_EMPRESTIMO_LIVRO
		$this->ID_EMPRESTIMO_LIVRO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_ID_EMPRESTIMO_LIVRO', 'ID_EMPRESTIMO_LIVRO', '`ID_EMPRESTIMO_LIVRO`', '`ID_EMPRESTIMO_LIVRO`', 3, -1, FALSE, '`ID_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_LIVRO
		$this->ID_LIVRO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_ID_LIVRO', 'ID_LIVRO', '`ID_LIVRO`', '`ID_LIVRO`', 3, -1, FALSE, '`ID_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_ALUNO
		$this->ID_ALUNO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_ID_ALUNO', 'ID_ALUNO', '`ID_ALUNO`', '`ID_ALUNO`', 3, -1, FALSE, '`ID_ALUNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_CADASTRO
		$this->ID_CADASTRO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_ID_CADASTRO', 'ID_CADASTRO', '`ID_CADASTRO`', '`ID_CADASTRO`', 3, -1, FALSE, '`ID_CADASTRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_INICIAL_EMPRESTIMO_LIVRO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_DATA_INICIAL_EMPRESTIMO_LIVRO', 'DATA_INICIAL_EMPRESTIMO_LIVRO', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_INICIAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_FINAL_EMPRESTIMO_LIVRO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_DATA_FINAL_EMPRESTIMO_LIVRO', 'DATA_FINAL_EMPRESTIMO_LIVRO', '`DATA_FINAL_EMPRESTIMO_LIVRO`', '`DATA_FINAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_FINAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// STATUS_EMPRESTIMO
		$this->STATUS_EMPRESTIMO = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_STATUS_EMPRESTIMO', 'STATUS_EMPRESTIMO', '`STATUS_EMPRESTIMO`', '`STATUS_EMPRESTIMO`', 3, -1, FALSE, '`STATUS_EMPRESTIMO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FLTIPOLOG
		$this->FLTIPOLOG = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_FLTIPOLOG', 'FLTIPOLOG', '`FLTIPOLOG`', '`FLTIPOLOG`', 200, -1, FALSE, '`FLTIPOLOG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FLTIPOLOG->Sortable = TRUE; // Allow sort
		$this->fields['FLTIPOLOG'] = &$this->FLTIPOLOG;

		// DATALOG
		$this->DATALOG = new cField('log_emprestimo_livro', 'log_emprestimo_livro', 'x_DATALOG', 'DATALOG', '`DATALOG`', ew_CastDateFieldForLike('`DATALOG`', 0, "DB"), 135, 0, FALSE, '`DATALOG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`log_emprestimo_livro`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "log_emprestimo_livrolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "log_emprestimo_livroview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "log_emprestimo_livroedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "log_emprestimo_livroadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("log_emprestimo_livroview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("log_emprestimo_livroview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "log_emprestimo_livroadd.php?" . $this->UrlParm($parm);
		else
			$url = "log_emprestimo_livroadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("log_emprestimo_livroedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("log_emprestimo_livroadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("log_emprestimo_livrodelete.php", $this->UrlParm());
	}
