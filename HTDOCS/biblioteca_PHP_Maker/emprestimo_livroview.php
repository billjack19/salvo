...
$emprestimo_livro_view = NULL; // Initialize page object first

class cemprestimo_livro_view extends cemprestimo_livro {
	...
	// Page object name
	var $PageObjName = 'emprestimo_livro_view';
	...
	function __construct() {
		...
		if (@$_GET["ID_EMPRESTIMO_LIVRO"] <> "") {
			$this->RecKey["ID_EMPRESTIMO_LIVRO"] = $_GET["ID_EMPRESTIMO_LIVRO"];
			$KeyUrl .= "&amp;ID_EMPRESTIMO_LIVRO=" . urlencode($this->RecKey["ID_EMPRESTIMO_LIVRO"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID_EMPRESTIMO_LIVRO"] <> "") {
				...
				$this->RecKey["ID_EMPRESTIMO_LIVRO"] = $this->ID_EMPRESTIMO_LIVRO->QueryStringValue;
			} elseif (@$_POST["ID_EMPRESTIMO_LIVRO"] <> "") {
				$this->ID_EMPRESTIMO_LIVRO->setFormValue($_POST["ID_EMPRESTIMO_LIVRO"]);
				$this->RecKey["ID_EMPRESTIMO_LIVRO"] = $this->ID_EMPRESTIMO_LIVRO->FormValue;
			} else {
				$sReturnUrl = "emprestimo_livrolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "emprestimo_livrolist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "emprestimo_livrolist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($emprestimo_livro_view)) $emprestimo_livro_view = new cemprestimo_livro_view();

// Page init
$emprestimo_livro_view->Page_Init();

// Page main
$emprestimo_livro_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$emprestimo_livro_view->Page_Render();
?>
...
var CurrentForm = femprestimo_livroview = new ew_Form("femprestimo_livroview", "view");

// Form_CustomValidate event
femprestimo_livroview.Form_CustomValidate = 
...
femprestimo_livroview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $emprestimo_livro_view->ExportOptions->Render("body") ?>
<?php
	foreach ($emprestimo_livro_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $emprestimo_livro_view->ShowPageHeader(); ?>
<?php
$emprestimo_livro_view->ShowMessage();
?>
<form name="femprestimo_livroview" id="femprestimo_livroview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($emprestimo_livro_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $emprestimo_livro_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="emprestimo_livro">
<input type="hidden" name="modal" value="<?php echo intval($emprestimo_livro_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($emprestimo_livro->ID_EMPRESTIMO_LIVRO->Visible) { // ID_EMPRESTIMO_LIVRO ?>
	<tr id="r_ID_EMPRESTIMO_LIVRO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_ID_EMPRESTIMO_LIVRO"><?php echo $emprestimo_livro->ID_EMPRESTIMO_LIVRO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->ID_EMPRESTIMO_LIVRO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->ID_LIVRO->Visible) { // ID_LIVRO ?>
	<tr id="r_ID_LIVRO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_ID_LIVRO"><?php echo $emprestimo_livro->ID_LIVRO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->ID_LIVRO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->ID_ALUNO->Visible) { // ID_ALUNO ?>
	<tr id="r_ID_ALUNO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_ID_ALUNO"><?php echo $emprestimo_livro->ID_ALUNO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->ID_ALUNO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->ID_CADASTRO->Visible) { // ID_CADASTRO ?>
	<tr id="r_ID_CADASTRO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_ID_CADASTRO"><?php echo $emprestimo_livro->ID_CADASTRO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->ID_CADASTRO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->Visible) { // DATA_INICIAL_EMPRESTIMO_LIVRO ?>
	<tr id="r_DATA_INICIAL_EMPRESTIMO_LIVRO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_DATA_INICIAL_EMPRESTIMO_LIVRO"><?php echo $emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->Visible) { // DATA_FINAL_EMPRESTIMO_LIVRO ?>
	<tr id="r_DATA_FINAL_EMPRESTIMO_LIVRO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_DATA_FINAL_EMPRESTIMO_LIVRO"><?php echo $emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_livro->STATUS_EMPRESTIMO->Visible) { // STATUS_EMPRESTIMO ?>
	<tr id="r_STATUS_EMPRESTIMO">
		<td class="col-sm-2"><span id="elh_emprestimo_livro_STATUS_EMPRESTIMO"><?php echo $emprestimo_livro->STATUS_EMPRESTIMO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_livro->STATUS_EMPRESTIMO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
femprestimo_livroview.Init();
</script>
<?php
$emprestimo_livro_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$emprestimo_livro_view->Page_Terminate();
?>
