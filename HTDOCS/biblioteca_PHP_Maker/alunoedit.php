...
$aluno_edit = NULL; // Initialize page object first

class caluno_edit extends caluno {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ID_ALUNO")) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// NOME_ALUNO
			$this->NOME_ALUNO->SetDbValueDef($rsnew, $this->NOME_ALUNO->CurrentValue, "", $this->NOME_ALUNO->ReadOnly);

			// MATRICULA_ALUNO
			$this->MATRICULA_ALUNO->SetDbValueDef($rsnew, $this->MATRICULA_ALUNO->CurrentValue, "", $this->MATRICULA_ALUNO->ReadOnly);

			// EMAIL_ALUNO
			$this->EMAIL_ALUNO->SetDbValueDef($rsnew, $this->EMAIL_ALUNO->CurrentValue, NULL, $this->EMAIL_ALUNO->ReadOnly);

			// CPF_ALUNO
			$this->CPF_ALUNO->SetDbValueDef($rsnew, $this->CPF_ALUNO->CurrentValue, NULL, $this->CPF_ALUNO->ReadOnly);

			// RG_ALUNO
			$this->RG_ALUNO->SetDbValueDef($rsnew, $this->RG_ALUNO->CurrentValue, NULL, $this->RG_ALUNO->ReadOnly);

			// SEXO_ALUNO
			$this->SEXO_ALUNO->SetDbValueDef($rsnew, $this->SEXO_ALUNO->CurrentValue, "", $this->SEXO_ALUNO->ReadOnly);

			// DATA_NASCIMENTO_ALUNO
			$this->DATA_NASCIMENTO_ALUNO->SetDbValueDef($rsnew, $this->DATA_NASCIMENTO_ALUNO->CurrentValue, "", $this->DATA_NASCIMENTO_ALUNO->ReadOnly);

			// TURNO_ALUNO
			$this->TURNO_ALUNO->SetDbValueDef($rsnew, $this->TURNO_ALUNO->CurrentValue, "", $this->TURNO_ALUNO->ReadOnly);

			// TELEFONE_ALUNO
			$this->TELEFONE_ALUNO->SetDbValueDef($rsnew, $this->TELEFONE_ALUNO->CurrentValue, "", $this->TELEFONE_ALUNO->ReadOnly);

			// RECORD_ALUNO
			$this->RECORD_ALUNO->SetDbValueDef($rsnew, $this->RECORD_ALUNO->CurrentValue, NULL, $this->RECORD_ALUNO->ReadOnly);

			// ID_NIVEL_ACESSO
			$this->ID_NIVEL_ACESSO->SetDbValueDef($rsnew, $this->ID_NIVEL_ACESSO->CurrentValue, NULL, $this->ID_NIVEL_ACESSO->ReadOnly);

			// ANO_ALUNO
			$this->ANO_ALUNO->SetDbValueDef($rsnew, $this->ANO_ALUNO->CurrentValue, "", $this->ANO_ALUNO->ReadOnly);

			// TURMA_ALUNO
			$this->TURMA_ALUNO->SetDbValueDef($rsnew, $this->TURMA_ALUNO->CurrentValue, "", $this->TURMA_ALUNO->ReadOnly);

			// SALA_ALUNO
			$this->SALA_ALUNO->SetDbValueDef($rsnew, $this->SALA_ALUNO->CurrentValue, "", $this->SALA_ALUNO->ReadOnly);
...
// Create page object
if (!isset($aluno_edit)) $aluno_edit = new caluno_edit();

// Page init
$aluno_edit->Page_Init();

// Page main
$aluno_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$aluno_edit->Page_Render();
?>
...
var CurrentForm = falunoedit = new ew_Form("falunoedit", "edit");

// Validate form
falunoedit.Validate = function() {
...
falunoedit.Form_CustomValidate = 
...
falunoedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $aluno_edit->ShowPageHeader(); ?>
<?php
$aluno_edit->ShowMessage();
?>
<form name="falunoedit" id="falunoedit" class="<?php echo $aluno_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($aluno_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $aluno_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="aluno">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($aluno_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($aluno->ID_ALUNO->Visible) { // ID_ALUNO ?>
	<div id="r_ID_ALUNO" class="form-group">
		<label id="elh_aluno_ID_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->ID_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->ID_ALUNO->CellAttributes() ?>>
<span id="el_aluno_ID_ALUNO">
<span<?php echo $aluno->ID_ALUNO->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $aluno->ID_ALUNO->EditValue ?></p></span>
</span>
<input type="hidden" data-table="aluno" data-field="x_ID_ALUNO" name="x_ID_ALUNO" id="x_ID_ALUNO" value="<?php echo ew_HtmlEncode($aluno->ID_ALUNO->CurrentValue) ?>">
<?php echo $aluno->ID_ALUNO->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($aluno->NOME_ALUNO->Visible) { // NOME_ALUNO ?>
	<div id="r_NOME_ALUNO" class="form-group">
		<label id="elh_aluno_NOME_ALUNO" for="x_NOME_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->NOME_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->NOME_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->MATRICULA_ALUNO->Visible) { // MATRICULA_ALUNO ?>
	<div id="r_MATRICULA_ALUNO" class="form-group">
		<label id="elh_aluno_MATRICULA_ALUNO" for="x_MATRICULA_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->MATRICULA_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->MATRICULA_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->EMAIL_ALUNO->Visible) { // EMAIL_ALUNO ?>
	<div id="r_EMAIL_ALUNO" class="form-group">
		<label id="elh_aluno_EMAIL_ALUNO" for="x_EMAIL_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->EMAIL_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->EMAIL_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->CPF_ALUNO->Visible) { // CPF_ALUNO ?>
	<div id="r_CPF_ALUNO" class="form-group">
		<label id="elh_aluno_CPF_ALUNO" for="x_CPF_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->CPF_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->CPF_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->RG_ALUNO->Visible) { // RG_ALUNO ?>
	<div id="r_RG_ALUNO" class="form-group">
		<label id="elh_aluno_RG_ALUNO" for="x_RG_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->RG_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->RG_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->SEXO_ALUNO->Visible) { // SEXO_ALUNO ?>
	<div id="r_SEXO_ALUNO" class="form-group">
		<label id="elh_aluno_SEXO_ALUNO" for="x_SEXO_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->SEXO_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->SEXO_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->DATA_NASCIMENTO_ALUNO->Visible) { // DATA_NASCIMENTO_ALUNO ?>
	<div id="r_DATA_NASCIMENTO_ALUNO" class="form-group">
		<label id="elh_aluno_DATA_NASCIMENTO_ALUNO" for="x_DATA_NASCIMENTO_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->DATA_NASCIMENTO_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->DATA_NASCIMENTO_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->TURNO_ALUNO->Visible) { // TURNO_ALUNO ?>
	<div id="r_TURNO_ALUNO" class="form-group">
		<label id="elh_aluno_TURNO_ALUNO" for="x_TURNO_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->TURNO_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->TURNO_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->TELEFONE_ALUNO->Visible) { // TELEFONE_ALUNO ?>
	<div id="r_TELEFONE_ALUNO" class="form-group">
		<label id="elh_aluno_TELEFONE_ALUNO" for="x_TELEFONE_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->TELEFONE_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->TELEFONE_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->RECORD_ALUNO->Visible) { // RECORD_ALUNO ?>
	<div id="r_RECORD_ALUNO" class="form-group">
		<label id="elh_aluno_RECORD_ALUNO" for="x_RECORD_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->RECORD_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->RECORD_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->ID_NIVEL_ACESSO->Visible) { // ID_NIVEL_ACESSO ?>
	<div id="r_ID_NIVEL_ACESSO" class="form-group">
		<label id="elh_aluno_ID_NIVEL_ACESSO" for="x_ID_NIVEL_ACESSO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->ID_NIVEL_ACESSO->FldCaption() ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->ID_NIVEL_ACESSO->CellAttributes() ?>>
...
<?php if ($aluno->ANO_ALUNO->Visible) { // ANO_ALUNO ?>
	<div id="r_ANO_ALUNO" class="form-group">
		<label id="elh_aluno_ANO_ALUNO" for="x_ANO_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->ANO_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->ANO_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->TURMA_ALUNO->Visible) { // TURMA_ALUNO ?>
	<div id="r_TURMA_ALUNO" class="form-group">
		<label id="elh_aluno_TURMA_ALUNO" for="x_TURMA_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->TURMA_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->TURMA_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->SALA_ALUNO->Visible) { // SALA_ALUNO ?>
	<div id="r_SALA_ALUNO" class="form-group">
		<label id="elh_aluno_SALA_ALUNO" for="x_SALA_ALUNO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->SALA_ALUNO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->SALA_ALUNO->CellAttributes() ?>>
...
<?php if ($aluno->NUMERO_LIVROS->Visible) { // NUMERO_LIVROS ?>
	<div id="r_NUMERO_LIVROS" class="form-group">
		<label id="elh_aluno_NUMERO_LIVROS" for="x_NUMERO_LIVROS" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->NUMERO_LIVROS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->NUMERO_LIVROS->CellAttributes() ?>>
...
<?php if ($aluno->FREQUENCIA_LIVRO->Visible) { // FREQUENCIA_LIVRO ?>
	<div id="r_FREQUENCIA_LIVRO" class="form-group">
		<label id="elh_aluno_FREQUENCIA_LIVRO" for="x_FREQUENCIA_LIVRO" class="<?php echo $aluno_edit->LeftColumnClass ?>"><?php echo $aluno->FREQUENCIA_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $aluno_edit->RightColumnClass ?>"><div<?php echo $aluno->FREQUENCIA_LIVRO->CellAttributes() ?>>
...
<?php if (!$aluno_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $aluno_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $aluno_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
