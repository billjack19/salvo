...
$funcionario_edit = NULL; // Initialize page object first

class cfuncionario_edit extends cfuncionario {
	...
	// Page object name
	var $PageObjName = 'funcionario_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ID_FUNCIONARIO")) {
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			// NOME_FUNCIONARIO
			$this->NOME_FUNCIONARIO->SetDbValueDef($rsnew, $this->NOME_FUNCIONARIO->CurrentValue, "", $this->NOME_FUNCIONARIO->ReadOnly);

			// CPF_FUNCIONARIO
			$this->CPF_FUNCIONARIO->SetDbValueDef($rsnew, $this->CPF_FUNCIONARIO->CurrentValue, "", $this->CPF_FUNCIONARIO->ReadOnly);

			// RG_FUNCIONARIO
			$this->RG_FUNCIONARIO->SetDbValueDef($rsnew, $this->RG_FUNCIONARIO->CurrentValue, NULL, $this->RG_FUNCIONARIO->ReadOnly);

			// SEXO_FUNCIONARIO
			$this->SEXO_FUNCIONARIO->SetDbValueDef($rsnew, $this->SEXO_FUNCIONARIO->CurrentValue, "", $this->SEXO_FUNCIONARIO->ReadOnly);

			// DATA_NASCIMENTO_FUNCIONARIO
			$this->DATA_NASCIMENTO_FUNCIONARIO->SetDbValueDef($rsnew, $this->DATA_NASCIMENTO_FUNCIONARIO->CurrentValue, "", $this->DATA_NASCIMENTO_FUNCIONARIO->ReadOnly);

			// TELEFONE_FUNCIONARIO
			$this->TELEFONE_FUNCIONARIO->SetDbValueDef($rsnew, $this->TELEFONE_FUNCIONARIO->CurrentValue, "", $this->TELEFONE_FUNCIONARIO->ReadOnly);

			// EMAIL_FUNCIONARIO
			$this->EMAIL_FUNCIONARIO->SetDbValueDef($rsnew, $this->EMAIL_FUNCIONARIO->CurrentValue, NULL, $this->EMAIL_FUNCIONARIO->ReadOnly);

			// CEP_FUNCIONARIO
			$this->CEP_FUNCIONARIO->SetDbValueDef($rsnew, $this->CEP_FUNCIONARIO->CurrentValue, NULL, $this->CEP_FUNCIONARIO->ReadOnly);

			// ENDERECO_FUNCIONARIO
			$this->ENDERECO_FUNCIONARIO->SetDbValueDef($rsnew, $this->ENDERECO_FUNCIONARIO->CurrentValue, NULL, $this->ENDERECO_FUNCIONARIO->ReadOnly);

			// NUMERO_END_FUNCIONARIO
			$this->NUMERO_END_FUNCIONARIO->SetDbValueDef($rsnew, $this->NUMERO_END_FUNCIONARIO->CurrentValue, NULL, $this->NUMERO_END_FUNCIONARIO->ReadOnly);

			// COMPLEMENTO_END_FUNCIONARIO
			$this->COMPLEMENTO_END_FUNCIONARIO->SetDbValueDef($rsnew, $this->COMPLEMENTO_END_FUNCIONARIO->CurrentValue, NULL, $this->COMPLEMENTO_END_FUNCIONARIO->ReadOnly);

			// BAIRRO_END_FUNCIONARIO
			$this->BAIRRO_END_FUNCIONARIO->SetDbValueDef($rsnew, $this->BAIRRO_END_FUNCIONARIO->CurrentValue, NULL, $this->BAIRRO_END_FUNCIONARIO->ReadOnly);

			// ESTADO_END_FUNCIONARIO
			$this->ESTADO_END_FUNCIONARIO->SetDbValueDef($rsnew, $this->ESTADO_END_FUNCIONARIO->CurrentValue, NULL, $this->ESTADO_END_FUNCIONARIO->ReadOnly);

			// CIDADE_END_FUNCIONARIO
			$this->CIDADE_END_FUNCIONARIO->SetDbValueDef($rsnew, $this->CIDADE_END_FUNCIONARIO->CurrentValue, NULL, $this->CIDADE_END_FUNCIONARIO->ReadOnly);

			// TURNO_FUNCIONARIO
			$this->TURNO_FUNCIONARIO->SetDbValueDef($rsnew, $this->TURNO_FUNCIONARIO->CurrentValue, "", $this->TURNO_FUNCIONARIO->ReadOnly);

			// CARGO_FUNCIONARIO
			$this->CARGO_FUNCIONARIO->SetDbValueDef($rsnew, $this->CARGO_FUNCIONARIO->CurrentValue, "", $this->CARGO_FUNCIONARIO->ReadOnly);

			// ID_NIVEL_ACESSO
			$this->ID_NIVEL_ACESSO->SetDbValueDef($rsnew, $this->ID_NIVEL_ACESSO->CurrentValue, 0, $this->ID_NIVEL_ACESSO->ReadOnly);

			// MASP
			$this->MASP->SetDbValueDef($rsnew, $this->MASP->CurrentValue, "", $this->MASP->ReadOnly);

			// NUMERO_LIVROS
			$this->NUMERO_LIVROS->SetDbValueDef($rsnew, $this->NUMERO_LIVROS->CurrentValue, 0, $this->NUMERO_LIVROS->ReadOnly);
...
// Create page object
if (!isset($funcionario_edit)) $funcionario_edit = new cfuncionario_edit();

// Page init
$funcionario_edit->Page_Init();

// Page main
$funcionario_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$funcionario_edit->Page_Render();
?>
...
var CurrentForm = ffuncionarioedit = new ew_Form("ffuncionarioedit", "edit");

// Validate form
ffuncionarioedit.Validate = function() {
...
ffuncionarioedit.Form_CustomValidate = 
...
ffuncionarioedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $funcionario_edit->ShowPageHeader(); ?>
<?php
$funcionario_edit->ShowMessage();
?>
<form name="ffuncionarioedit" id="ffuncionarioedit" class="<?php echo $funcionario_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($funcionario_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $funcionario_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="funcionario">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($funcionario_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($funcionario->ID_FUNCIONARIO->Visible) { // ID_FUNCIONARIO ?>
	<div id="r_ID_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_ID_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->ID_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->ID_FUNCIONARIO->CellAttributes() ?>>
<span id="el_funcionario_ID_FUNCIONARIO">
<span<?php echo $funcionario->ID_FUNCIONARIO->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $funcionario->ID_FUNCIONARIO->EditValue ?></p></span>
</span>
<input type="hidden" data-table="funcionario" data-field="x_ID_FUNCIONARIO" name="x_ID_FUNCIONARIO" id="x_ID_FUNCIONARIO" value="<?php echo ew_HtmlEncode($funcionario->ID_FUNCIONARIO->CurrentValue) ?>">
<?php echo $funcionario->ID_FUNCIONARIO->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($funcionario->NOME_FUNCIONARIO->Visible) { // NOME_FUNCIONARIO ?>
	<div id="r_NOME_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_NOME_FUNCIONARIO" for="x_NOME_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->NOME_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->NOME_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->CPF_FUNCIONARIO->Visible) { // CPF_FUNCIONARIO ?>
	<div id="r_CPF_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_CPF_FUNCIONARIO" for="x_CPF_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->CPF_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->CPF_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->RG_FUNCIONARIO->Visible) { // RG_FUNCIONARIO ?>
	<div id="r_RG_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_RG_FUNCIONARIO" for="x_RG_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->RG_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->RG_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->SEXO_FUNCIONARIO->Visible) { // SEXO_FUNCIONARIO ?>
	<div id="r_SEXO_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_SEXO_FUNCIONARIO" for="x_SEXO_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->SEXO_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->SEXO_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->DATA_NASCIMENTO_FUNCIONARIO->Visible) { // DATA_NASCIMENTO_FUNCIONARIO ?>
	<div id="r_DATA_NASCIMENTO_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_DATA_NASCIMENTO_FUNCIONARIO" for="x_DATA_NASCIMENTO_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->DATA_NASCIMENTO_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->DATA_NASCIMENTO_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->TELEFONE_FUNCIONARIO->Visible) { // TELEFONE_FUNCIONARIO ?>
	<div id="r_TELEFONE_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_TELEFONE_FUNCIONARIO" for="x_TELEFONE_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->TELEFONE_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->TELEFONE_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->EMAIL_FUNCIONARIO->Visible) { // EMAIL_FUNCIONARIO ?>
	<div id="r_EMAIL_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_EMAIL_FUNCIONARIO" for="x_EMAIL_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->EMAIL_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->EMAIL_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->CEP_FUNCIONARIO->Visible) { // CEP_FUNCIONARIO ?>
	<div id="r_CEP_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_CEP_FUNCIONARIO" for="x_CEP_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->CEP_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->CEP_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->ENDERECO_FUNCIONARIO->Visible) { // ENDERECO_FUNCIONARIO ?>
	<div id="r_ENDERECO_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_ENDERECO_FUNCIONARIO" for="x_ENDERECO_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->ENDERECO_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->ENDERECO_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->NUMERO_END_FUNCIONARIO->Visible) { // NUMERO_END_FUNCIONARIO ?>
	<div id="r_NUMERO_END_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_NUMERO_END_FUNCIONARIO" for="x_NUMERO_END_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->NUMERO_END_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->NUMERO_END_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->COMPLEMENTO_END_FUNCIONARIO->Visible) { // COMPLEMENTO_END_FUNCIONARIO ?>
	<div id="r_COMPLEMENTO_END_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_COMPLEMENTO_END_FUNCIONARIO" for="x_COMPLEMENTO_END_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->COMPLEMENTO_END_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->COMPLEMENTO_END_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->BAIRRO_END_FUNCIONARIO->Visible) { // BAIRRO_END_FUNCIONARIO ?>
	<div id="r_BAIRRO_END_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_BAIRRO_END_FUNCIONARIO" for="x_BAIRRO_END_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->BAIRRO_END_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->BAIRRO_END_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->ESTADO_END_FUNCIONARIO->Visible) { // ESTADO_END_FUNCIONARIO ?>
	<div id="r_ESTADO_END_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_ESTADO_END_FUNCIONARIO" for="x_ESTADO_END_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->ESTADO_END_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->ESTADO_END_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->CIDADE_END_FUNCIONARIO->Visible) { // CIDADE_END_FUNCIONARIO ?>
	<div id="r_CIDADE_END_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_CIDADE_END_FUNCIONARIO" for="x_CIDADE_END_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->CIDADE_END_FUNCIONARIO->FldCaption() ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->CIDADE_END_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->TURNO_FUNCIONARIO->Visible) { // TURNO_FUNCIONARIO ?>
	<div id="r_TURNO_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_TURNO_FUNCIONARIO" for="x_TURNO_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->TURNO_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->TURNO_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->CARGO_FUNCIONARIO->Visible) { // CARGO_FUNCIONARIO ?>
	<div id="r_CARGO_FUNCIONARIO" class="form-group">
		<label id="elh_funcionario_CARGO_FUNCIONARIO" for="x_CARGO_FUNCIONARIO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->CARGO_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->CARGO_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($funcionario->ID_NIVEL_ACESSO->Visible) { // ID_NIVEL_ACESSO ?>
	<div id="r_ID_NIVEL_ACESSO" class="form-group">
		<label id="elh_funcionario_ID_NIVEL_ACESSO" for="x_ID_NIVEL_ACESSO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->ID_NIVEL_ACESSO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->ID_NIVEL_ACESSO->CellAttributes() ?>>
...
<?php if ($funcionario->MASP->Visible) { // MASP ?>
	<div id="r_MASP" class="form-group">
		<label id="elh_funcionario_MASP" for="x_MASP" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->MASP->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->MASP->CellAttributes() ?>>
...
<?php if ($funcionario->NUMERO_LIVROS->Visible) { // NUMERO_LIVROS ?>
	<div id="r_NUMERO_LIVROS" class="form-group">
		<label id="elh_funcionario_NUMERO_LIVROS" for="x_NUMERO_LIVROS" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->NUMERO_LIVROS->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->NUMERO_LIVROS->CellAttributes() ?>>
...
<?php if ($funcionario->FREQUENCIA_LIVRO->Visible) { // FREQUENCIA_LIVRO ?>
	<div id="r_FREQUENCIA_LIVRO" class="form-group">
		<label id="elh_funcionario_FREQUENCIA_LIVRO" for="x_FREQUENCIA_LIVRO" class="<?php echo $funcionario_edit->LeftColumnClass ?>"><?php echo $funcionario->FREQUENCIA_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $funcionario_edit->RightColumnClass ?>"><div<?php echo $funcionario->FREQUENCIA_LIVRO->CellAttributes() ?>>
...
<?php if (!$funcionario_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $funcionario_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $funcionario_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
ffuncionarioedit.Init();
</script>
<?php
$funcionario_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$funcionario_edit->Page_Terminate();
?>
