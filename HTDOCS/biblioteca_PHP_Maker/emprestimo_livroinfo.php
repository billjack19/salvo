...
$emprestimo_livro = NULL;

//
// Table class for emprestimo_livro
//
class cemprestimo_livro extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'emprestimo_livro';
		$this->TableName = 'emprestimo_livro';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`emprestimo_livro`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID_EMPRESTIMO_LIVRO
		$this->ID_EMPRESTIMO_LIVRO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_ID_EMPRESTIMO_LIVRO', 'ID_EMPRESTIMO_LIVRO', '`ID_EMPRESTIMO_LIVRO`', '`ID_EMPRESTIMO_LIVRO`', 3, -1, FALSE, '`ID_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ID_LIVRO
		$this->ID_LIVRO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_ID_LIVRO', 'ID_LIVRO', '`ID_LIVRO`', '`ID_LIVRO`', 3, -1, FALSE, '`ID_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_ALUNO
		$this->ID_ALUNO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_ID_ALUNO', 'ID_ALUNO', '`ID_ALUNO`', '`ID_ALUNO`', 3, -1, FALSE, '`ID_ALUNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_CADASTRO
		$this->ID_CADASTRO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_ID_CADASTRO', 'ID_CADASTRO', '`ID_CADASTRO`', '`ID_CADASTRO`', 3, -1, FALSE, '`ID_CADASTRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_INICIAL_EMPRESTIMO_LIVRO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_DATA_INICIAL_EMPRESTIMO_LIVRO', 'DATA_INICIAL_EMPRESTIMO_LIVRO', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_INICIAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_FINAL_EMPRESTIMO_LIVRO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_DATA_FINAL_EMPRESTIMO_LIVRO', 'DATA_FINAL_EMPRESTIMO_LIVRO', '`DATA_FINAL_EMPRESTIMO_LIVRO`', '`DATA_FINAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_FINAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// STATUS_EMPRESTIMO
		$this->STATUS_EMPRESTIMO = new cField('emprestimo_livro', 'emprestimo_livro', 'x_STATUS_EMPRESTIMO', 'STATUS_EMPRESTIMO', '`STATUS_EMPRESTIMO`', '`STATUS_EMPRESTIMO`', 3, -1, FALSE, '`STATUS_EMPRESTIMO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`emprestimo_livro`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "emprestimo_livrolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "emprestimo_livroedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "emprestimo_livroadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("emprestimo_livroview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("emprestimo_livroview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "emprestimo_livroadd.php?" . $this->UrlParm($parm);
		else
			$url = "emprestimo_livroadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("emprestimo_livroedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("emprestimo_livroadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("emprestimo_livrodelete.php", $this->UrlParm());
	}
