...
define("EW_PROJECT_ID", "{F97651BD-5B9A-4483-825A-646D2CE2E400}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'P0riZdNwJ6ixUhOl', TRUE); // Random key for encryption
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "biblioteca", "qs" => "`", "qe" => "`");
