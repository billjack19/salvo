...
//
// Table class for produto
//
class cproduto extends cTable {
	var $ID_PRODUTO;
	...
	function __construct() {
		...
		$this->TableVar = 'produto';
		$this->TableName = 'produto';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`produto`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID_PRODUTO
		$this->ID_PRODUTO = new cField('produto', 'produto', 'x_ID_PRODUTO', 'ID_PRODUTO', '`ID_PRODUTO`', '`ID_PRODUTO`', 3, -1, FALSE, '`ID_PRODUTO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// DESCRICAO_PRODUTO
		$this->DESCRICAO_PRODUTO = new cField('produto', 'produto', 'x_DESCRICAO_PRODUTO', 'DESCRICAO_PRODUTO', '`DESCRICAO_PRODUTO`', '`DESCRICAO_PRODUTO`', 200, -1, FALSE, '`DESCRICAO_PRODUTO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DESCRICAO_PRODUTO->Sortable = TRUE; // Allow sort
		$this->fields['DESCRICAO_PRODUTO'] = &$this->DESCRICAO_PRODUTO;

		// STATUS_PRODUTO
		$this->STATUS_PRODUTO = new cField('produto', 'produto', 'x_STATUS_PRODUTO', 'STATUS_PRODUTO', '`STATUS_PRODUTO`', '`STATUS_PRODUTO`', 200, -1, FALSE, '`STATUS_PRODUTO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`produto`";
	}
	...
	function GetModalCaption($pageName) {
		...
		elseif ($pageName == "produtoedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "produtoadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("produtoview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("produtoview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "produtoadd.php?" . $this->UrlParm($parm);
		else
			$url = "produtoadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("produtoedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("produtoadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("produtodelete.php", $this->UrlParm());
	}
