...
$emprestimo_kit_view = NULL; // Initialize page object first

class cemprestimo_kit_view extends cemprestimo_kit {
	...
	// Page object name
	var $PageObjName = 'emprestimo_kit_view';
	...
	function __construct() {
		...
		if (@$_GET["ID_EMPRESTIMO_KIT"] <> "") {
			$this->RecKey["ID_EMPRESTIMO_KIT"] = $_GET["ID_EMPRESTIMO_KIT"];
			$KeyUrl .= "&amp;ID_EMPRESTIMO_KIT=" . urlencode($this->RecKey["ID_EMPRESTIMO_KIT"]);
		}
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["ID_EMPRESTIMO_KIT"] <> "") {
				...
				$this->RecKey["ID_EMPRESTIMO_KIT"] = $this->ID_EMPRESTIMO_KIT->QueryStringValue;
			} elseif (@$_POST["ID_EMPRESTIMO_KIT"] <> "") {
				$this->ID_EMPRESTIMO_KIT->setFormValue($_POST["ID_EMPRESTIMO_KIT"]);
				$this->RecKey["ID_EMPRESTIMO_KIT"] = $this->ID_EMPRESTIMO_KIT->FormValue;
			} else {
				$sReturnUrl = "emprestimo_kitlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "emprestimo_kitlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "emprestimo_kitlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($emprestimo_kit_view)) $emprestimo_kit_view = new cemprestimo_kit_view();

// Page init
$emprestimo_kit_view->Page_Init();

// Page main
$emprestimo_kit_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$emprestimo_kit_view->Page_Render();
?>
...
var CurrentForm = femprestimo_kitview = new ew_Form("femprestimo_kitview", "view");

// Form_CustomValidate event
femprestimo_kitview.Form_CustomValidate = 
...
femprestimo_kitview.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<div class="ewToolbar">
<?php $emprestimo_kit_view->ExportOptions->Render("body") ?>
<?php
	foreach ($emprestimo_kit_view->OtherOptions as &$option)
		$option->Render("body");
?>
<div class="clearfix"></div>
</div>
<?php $emprestimo_kit_view->ShowPageHeader(); ?>
<?php
$emprestimo_kit_view->ShowMessage();
?>
<form name="femprestimo_kitview" id="femprestimo_kitview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($emprestimo_kit_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $emprestimo_kit_view->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="emprestimo_kit">
<input type="hidden" name="modal" value="<?php echo intval($emprestimo_kit_view->IsModal) ?>">
<table class="table table-striped table-bordered table-hover table-condensed ewViewTable">
<?php if ($emprestimo_kit->ID_EMPRESTIMO_KIT->Visible) { // ID_EMPRESTIMO_KIT ?>
	<tr id="r_ID_EMPRESTIMO_KIT">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_ID_EMPRESTIMO_KIT"><?php echo $emprestimo_kit->ID_EMPRESTIMO_KIT->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->ID_EMPRESTIMO_KIT->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_kit->ID_KIT->Visible) { // ID_KIT ?>
	<tr id="r_ID_KIT">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_ID_KIT"><?php echo $emprestimo_kit->ID_KIT->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->ID_KIT->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_kit->ID_FUNCIONARIO->Visible) { // ID_FUNCIONARIO ?>
	<tr id="r_ID_FUNCIONARIO">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_ID_FUNCIONARIO"><?php echo $emprestimo_kit->ID_FUNCIONARIO->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->ID_FUNCIONARIO->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_kit->DATA_EMPRESTIMO_KIT->Visible) { // DATA_EMPRESTIMO_KIT ?>
	<tr id="r_DATA_EMPRESTIMO_KIT">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_DATA_EMPRESTIMO_KIT"><?php echo $emprestimo_kit->DATA_EMPRESTIMO_KIT->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->DATA_EMPRESTIMO_KIT->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_kit->CODIGO_AULA_EMPRESTIMO_KIT->Visible) { // CODIGO_AULA_EMPRESTIMO_KIT ?>
	<tr id="r_CODIGO_AULA_EMPRESTIMO_KIT">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_CODIGO_AULA_EMPRESTIMO_KIT"><?php echo $emprestimo_kit->CODIGO_AULA_EMPRESTIMO_KIT->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->CODIGO_AULA_EMPRESTIMO_KIT->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($emprestimo_kit->STATUS_EMPRESTIMO_KIT->Visible) { // STATUS_EMPRESTIMO_KIT ?>
	<tr id="r_STATUS_EMPRESTIMO_KIT">
		<td class="col-sm-2"><span id="elh_emprestimo_kit_STATUS_EMPRESTIMO_KIT"><?php echo $emprestimo_kit->STATUS_EMPRESTIMO_KIT->FldCaption() ?></span></td>
...
<?php echo $emprestimo_kit->STATUS_EMPRESTIMO_KIT->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
femprestimo_kitview.Init();
</script>
<?php
$emprestimo_kit_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$emprestimo_kit_view->Page_Terminate();
?>
