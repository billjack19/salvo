...
$emprestimo_livro2_edit = NULL; // Initialize page object first

class cemprestimo_livro2_edit extends cemprestimo_livro2 {
	...
	// Page object name
	var $PageObjName = 'emprestimo_livro2_edit';
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ID_EMPRESTIMO_LIVRO2")) {
				$this->ID_EMPRESTIMO_LIVRO2->setFormValue($objForm->GetValue("x_ID_EMPRESTIMO_LIVRO2"));
			}
		} else {
			...
			$loadByQuery = FALSE;
			if (isset($_GET["ID_EMPRESTIMO_LIVRO2"])) {
	...
	function LoadFormValues() {
		...
		// Load from form
		global $objForm;
		if (!$this->ID_EMPRESTIMO_LIVRO2->FldIsDetailKey)
			$this->ID_EMPRESTIMO_LIVRO2->setFormValue($objForm->GetValue("x_ID_EMPRESTIMO_LIVRO2"));
	...
	function RestoreFormValues() {
		global $objForm;
		$this->ID_EMPRESTIMO_LIVRO2->CurrentValue = $this->ID_EMPRESTIMO_LIVRO2->FormValue;
...
// Create page object
if (!isset($emprestimo_livro2_edit)) $emprestimo_livro2_edit = new cemprestimo_livro2_edit();

// Page init
$emprestimo_livro2_edit->Page_Init();

// Page main
$emprestimo_livro2_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$emprestimo_livro2_edit->Page_Render();
?>
...
var CurrentForm = femprestimo_livro2edit = new ew_Form("femprestimo_livro2edit", "edit");

// Validate form
femprestimo_livro2edit.Validate = function() {
...
femprestimo_livro2edit.Form_CustomValidate = 
...
femprestimo_livro2edit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $emprestimo_livro2_edit->ShowPageHeader(); ?>
<?php
$emprestimo_livro2_edit->ShowMessage();
?>
<form name="femprestimo_livro2edit" id="femprestimo_livro2edit" class="<?php echo $emprestimo_livro2_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($emprestimo_livro2_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $emprestimo_livro2_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="emprestimo_livro2">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($emprestimo_livro2_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->Visible) { // ID_EMPRESTIMO_LIVRO2 ?>
	<div id="r_ID_EMPRESTIMO_LIVRO2" class="form-group">
		<label id="elh_emprestimo_livro2_ID_EMPRESTIMO_LIVRO2" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->FldCaption() ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->CellAttributes() ?>>
<span id="el_emprestimo_livro2_ID_EMPRESTIMO_LIVRO2">
<span<?php echo $emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->EditValue ?></p></span>
</span>
<input type="hidden" data-table="emprestimo_livro2" data-field="x_ID_EMPRESTIMO_LIVRO2" name="x_ID_EMPRESTIMO_LIVRO2" id="x_ID_EMPRESTIMO_LIVRO2" value="<?php echo ew_HtmlEncode($emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->CurrentValue) ?>">
<?php echo $emprestimo_livro2->ID_EMPRESTIMO_LIVRO2->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($emprestimo_livro2->ID_LIVRO->Visible) { // ID_LIVRO ?>
	<div id="r_ID_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro2_ID_LIVRO" for="x_ID_LIVRO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->ID_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->ID_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro2->ID_FUNCIONARIO->Visible) { // ID_FUNCIONARIO ?>
	<div id="r_ID_FUNCIONARIO" class="form-group">
		<label id="elh_emprestimo_livro2_ID_FUNCIONARIO" for="x_ID_FUNCIONARIO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->ID_FUNCIONARIO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->ID_FUNCIONARIO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro2->ID_CADASTRO->Visible) { // ID_CADASTRO ?>
	<div id="r_ID_CADASTRO" class="form-group">
		<label id="elh_emprestimo_livro2_ID_CADASTRO" for="x_ID_CADASTRO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->ID_CADASTRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->ID_CADASTRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro2->DATA_INICIAL_EMPRESTIMO_LIVRO->Visible) { // DATA_INICIAL_EMPRESTIMO_LIVRO ?>
	<div id="r_DATA_INICIAL_EMPRESTIMO_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro2_DATA_INICIAL_EMPRESTIMO_LIVRO" for="x_DATA_INICIAL_EMPRESTIMO_LIVRO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->DATA_INICIAL_EMPRESTIMO_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->DATA_INICIAL_EMPRESTIMO_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro2->DATA_FINAL_EMPRESTIMO_LIVRO->Visible) { // DATA_FINAL_EMPRESTIMO_LIVRO ?>
	<div id="r_DATA_FINAL_EMPRESTIMO_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro2_DATA_FINAL_EMPRESTIMO_LIVRO" for="x_DATA_FINAL_EMPRESTIMO_LIVRO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->DATA_FINAL_EMPRESTIMO_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->DATA_FINAL_EMPRESTIMO_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro2->STATUS_EMPRESTIMO->Visible) { // STATUS_EMPRESTIMO ?>
	<div id="r_STATUS_EMPRESTIMO" class="form-group">
		<label id="elh_emprestimo_livro2_STATUS_EMPRESTIMO" for="x_STATUS_EMPRESTIMO" class="<?php echo $emprestimo_livro2_edit->LeftColumnClass ?>"><?php echo $emprestimo_livro2->STATUS_EMPRESTIMO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro2_edit->RightColumnClass ?>"><div<?php echo $emprestimo_livro2->STATUS_EMPRESTIMO->CellAttributes() ?>>
...
<?php if (!$emprestimo_livro2_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $emprestimo_livro2_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $emprestimo_livro2_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
femprestimo_livro2edit.Init();
</script>
<?php
$emprestimo_livro2_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$emprestimo_livro2_edit->Page_Terminate();
?>
