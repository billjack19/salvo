...
$v_logemprestimolivro = NULL;

//
// Table class for v_logemprestimolivro
//
class cv_logemprestimolivro extends cTable {
	var $ID_EMPRESTIMO_LIVRO;
	var $NOME_ALUNO;
	var $NOME_LIVRO;
	var $NOME_CADASTRO;
	...
	function __construct() {
		...
		$this->TableVar = 'v_logemprestimolivro';
		$this->TableName = 'v_logemprestimolivro';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_logemprestimolivro`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID_EMPRESTIMO_LIVRO
		$this->ID_EMPRESTIMO_LIVRO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_ID_EMPRESTIMO_LIVRO', 'ID_EMPRESTIMO_LIVRO', '`ID_EMPRESTIMO_LIVRO`', '`ID_EMPRESTIMO_LIVRO`', 3, -1, FALSE, '`ID_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->ID_EMPRESTIMO_LIVRO->Sortable = TRUE; // Allow sort
		$this->ID_EMPRESTIMO_LIVRO->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['ID_EMPRESTIMO_LIVRO'] = &$this->ID_EMPRESTIMO_LIVRO;

		// NOME_ALUNO
		$this->NOME_ALUNO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_NOME_ALUNO', 'NOME_ALUNO', '`NOME_ALUNO`', '`NOME_ALUNO`', 200, -1, FALSE, '`NOME_ALUNO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOME_ALUNO->Sortable = TRUE; // Allow sort
		$this->fields['NOME_ALUNO'] = &$this->NOME_ALUNO;

		// NOME_LIVRO
		$this->NOME_LIVRO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_NOME_LIVRO', 'NOME_LIVRO', '`NOME_LIVRO`', '`NOME_LIVRO`', 200, -1, FALSE, '`NOME_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOME_LIVRO->Sortable = TRUE; // Allow sort
		$this->fields['NOME_LIVRO'] = &$this->NOME_LIVRO;

		// NOME_CADASTRO
		$this->NOME_CADASTRO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_NOME_CADASTRO', 'NOME_CADASTRO', '`NOME_CADASTRO`', '`NOME_CADASTRO`', 200, -1, FALSE, '`NOME_CADASTRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOME_CADASTRO->Sortable = TRUE; // Allow sort
		$this->fields['NOME_CADASTRO'] = &$this->NOME_CADASTRO;

		// DATA_INICIAL_EMPRESTIMO_LIVRO
		$this->DATA_INICIAL_EMPRESTIMO_LIVRO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_DATA_INICIAL_EMPRESTIMO_LIVRO', 'DATA_INICIAL_EMPRESTIMO_LIVRO', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_INICIAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_FINAL_EMPRESTIMO_LIVRO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_DATA_FINAL_EMPRESTIMO_LIVRO', 'DATA_FINAL_EMPRESTIMO_LIVRO', '`DATA_FINAL_EMPRESTIMO_LIVRO`', '`DATA_FINAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_FINAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// STATUS_EMPRESTIMO
		$this->STATUS_EMPRESTIMO = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_STATUS_EMPRESTIMO', 'STATUS_EMPRESTIMO', '`STATUS_EMPRESTIMO`', '`STATUS_EMPRESTIMO`', 3, -1, FALSE, '`STATUS_EMPRESTIMO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FLTIPOLOG
		$this->FLTIPOLOG = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_FLTIPOLOG', 'FLTIPOLOG', '`FLTIPOLOG`', '`FLTIPOLOG`', 200, -1, FALSE, '`FLTIPOLOG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->FLTIPOLOG->Sortable = TRUE; // Allow sort
		$this->fields['FLTIPOLOG'] = &$this->FLTIPOLOG;

		// DATALOG
		$this->DATALOG = new cField('v_logemprestimolivro', 'v_logemprestimolivro', 'x_DATALOG', 'DATALOG', '`DATALOG`', ew_CastDateFieldForLike('`DATALOG`', 0, "DB"), 135, 0, FALSE, '`DATALOG`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->DATALOG->Sortable = TRUE; // Allow sort
		$this->DATALOG->FldDefaultErrMsg = str_replace("%s", $GLOBALS["EW_DATE_FORMAT"], $Language->Phrase("IncorrectDate"));
		$this->fields['DATALOG'] = &$this->DATALOG;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_logemprestimolivro`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_logemprestimolivrolist.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "v_logemprestimolivroview.php")
			return $Language->Phrase("View");
		elseif ($pageName == "v_logemprestimolivroedit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_logemprestimolivroadd.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_logemprestimolivroview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_logemprestimolivroview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_logemprestimolivroadd.php?" . $this->UrlParm($parm);
		else
			$url = "v_logemprestimolivroadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_logemprestimolivroedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_logemprestimolivroadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_logemprestimolivrodelete.php", $this->UrlParm());
	}
	...
	function LoadListRowValues(&$rs) {
		$this->ID_EMPRESTIMO_LIVRO->setDbValue($rs->fields('ID_EMPRESTIMO_LIVRO'));
		$this->NOME_ALUNO->setDbValue($rs->fields('NOME_ALUNO'));
		$this->NOME_LIVRO->setDbValue($rs->fields('NOME_LIVRO'));
		$this->NOME_CADASTRO->setDbValue($rs->fields('NOME_CADASTRO'));
		...
		$this->FLTIPOLOG->setDbValue($rs->fields('FLTIPOLOG'));
		$this->DATALOG->setDbValue($rs->fields('DATALOG'));
	}
	...
	function RenderEditRow() {
		...
		$this->ID_EMPRESTIMO_LIVRO->PlaceHolder = ew_RemoveHtml($this->ID_EMPRESTIMO_LIVRO->FldCaption());
		...
		$this->NOME_CADASTRO->EditValue = $this->NOME_CADASTRO->CurrentValue;
		...
		// FLTIPOLOG
		$this->FLTIPOLOG->EditAttrs["class"] = "form-control";
		$this->FLTIPOLOG->EditCustomAttributes = "";
		$this->FLTIPOLOG->EditValue = $this->FLTIPOLOG->CurrentValue;
		$this->FLTIPOLOG->PlaceHolder = ew_RemoveHtml($this->FLTIPOLOG->FldCaption());

		// DATALOG
		$this->DATALOG->EditAttrs["class"] = "form-control";
		$this->DATALOG->EditCustomAttributes = "";
		$this->DATALOG->EditValue = ew_FormatDateTime($this->DATALOG->CurrentValue, 8);
		$this->DATALOG->PlaceHolder = ew_RemoveHtml($this->DATALOG->FldCaption());
		...
		if (!$Doc->ExportCustom) {
			...
			if ($Doc->Horizontal) { // Horizontal format, write header
				...
				if ($ExportPageType == "view") {
					if ($this->ID_EMPRESTIMO_LIVRO->Exportable) $Doc->ExportCaption($this->ID_EMPRESTIMO_LIVRO);
					...
					if ($this->NOME_CADASTRO->Exportable) $Doc->ExportCaption($this->NOME_CADASTRO);
					...
					if ($this->FLTIPOLOG->Exportable) $Doc->ExportCaption($this->FLTIPOLOG);
					if ($this->DATALOG->Exportable) $Doc->ExportCaption($this->DATALOG);
				} else {
					if ($this->ID_EMPRESTIMO_LIVRO->Exportable) $Doc->ExportCaption($this->ID_EMPRESTIMO_LIVRO);
					if ($this->NOME_ALUNO->Exportable) $Doc->ExportCaption($this->NOME_ALUNO);
					if ($this->NOME_LIVRO->Exportable) $Doc->ExportCaption($this->NOME_LIVRO);
		...
		while (!$Recordset->EOF && $RecCnt < $StopRec) {
			...
			if (intval($RecCnt) >= intval($StartRec)) {
				...
				if (!$Doc->ExportCustom) {
					...
					if ($ExportPageType == "view") {
						if ($this->ID_EMPRESTIMO_LIVRO->Exportable) $Doc->ExportField($this->ID_EMPRESTIMO_LIVRO);
						...
						if ($this->NOME_CADASTRO->Exportable) $Doc->ExportField($this->NOME_CADASTRO);
						...
						if ($this->FLTIPOLOG->Exportable) $Doc->ExportField($this->FLTIPOLOG);
						if ($this->DATALOG->Exportable) $Doc->ExportField($this->DATALOG);
					} else {
						if ($this->ID_EMPRESTIMO_LIVRO->Exportable) $Doc->ExportField($this->ID_EMPRESTIMO_LIVRO);
						if ($this->NOME_ALUNO->Exportable) $Doc->ExportField($this->NOME_ALUNO);
						if ($this->NOME_LIVRO->Exportable) $Doc->ExportField($this->NOME_LIVRO);
