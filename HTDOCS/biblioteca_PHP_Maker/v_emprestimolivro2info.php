...
$v_emprestimolivro2 = NULL;

//
// Table class for v_emprestimolivro2
//
class cv_emprestimolivro2 extends cTable {
	...
	function __construct() {
		...
		$this->TableVar = 'v_emprestimolivro2';
		$this->TableName = 'v_emprestimolivro2';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_emprestimolivro2`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		$this->ID_EMPRESTIMO_LIVRO2 = new cField('v_emprestimolivro2', 'v_emprestimolivro2', 'x_ID_EMPRESTIMO_LIVRO2', 'ID_EMPRESTIMO_LIVRO2', '`ID_EMPRESTIMO_LIVRO2`', '`ID_EMPRESTIMO_LIVRO2`', 3, -1, FALSE, '`ID_EMPRESTIMO_LIVRO2`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// NOME_FUNCIONARIO
		$this->NOME_FUNCIONARIO = new cField('v_emprestimolivro2', 'v_emprestimolivro2', 'x_NOME_FUNCIONARIO', 'NOME_FUNCIONARIO', '`NOME_FUNCIONARIO`', '`NOME_FUNCIONARIO`', 200, -1, FALSE, '`NOME_FUNCIONARIO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOME_FUNCIONARIO->Sortable = TRUE; // Allow sort
		$this->fields['NOME_FUNCIONARIO'] = &$this->NOME_FUNCIONARIO;

		// NOME_LIVRO
		$this->NOME_LIVRO = new cField('v_emprestimolivro2', 'v_emprestimolivro2', 'x_NOME_LIVRO', 'NOME_LIVRO', '`NOME_LIVRO`', '`NOME_LIVRO`', 200, -1, FALSE, '`NOME_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NOME_LIVRO->Sortable = TRUE; // Allow sort
		$this->fields['NOME_LIVRO'] = &$this->NOME_LIVRO;

		// DATA_INICIAL_EMPRESTIMO_LIVRO
		$this->DATA_INICIAL_EMPRESTIMO_LIVRO = new cField('v_emprestimolivro2', 'v_emprestimolivro2', 'x_DATA_INICIAL_EMPRESTIMO_LIVRO', 'DATA_INICIAL_EMPRESTIMO_LIVRO', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', '`DATA_INICIAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_INICIAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->DATA_FINAL_EMPRESTIMO_LIVRO = new cField('v_emprestimolivro2', 'v_emprestimolivro2', 'x_DATA_FINAL_EMPRESTIMO_LIVRO', 'DATA_FINAL_EMPRESTIMO_LIVRO', '`DATA_FINAL_EMPRESTIMO_LIVRO`', '`DATA_FINAL_EMPRESTIMO_LIVRO`', 200, -1, FALSE, '`DATA_FINAL_EMPRESTIMO_LIVRO`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v_emprestimolivro2`";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "v_emprestimolivro2list.php";
		}
	}
	...
	function GetModalCaption($pageName) {
		global $Language;
		if ($pageName == "v_emprestimolivro2view.php")
			return $Language->Phrase("View");
		elseif ($pageName == "v_emprestimolivro2edit.php")
			return $Language->Phrase("Edit");
		elseif ($pageName == "v_emprestimolivro2add.php")
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v_emprestimolivro2view.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v_emprestimolivro2view.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v_emprestimolivro2add.php?" . $this->UrlParm($parm);
		else
			$url = "v_emprestimolivro2add.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("v_emprestimolivro2edit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("v_emprestimolivro2add.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v_emprestimolivro2delete.php", $this->UrlParm());
	}
