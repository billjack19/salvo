...
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>teacher.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EW_RELATIVE_PATH ?>teacher.ico">
