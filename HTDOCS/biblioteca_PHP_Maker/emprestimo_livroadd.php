...
$emprestimo_livro_add = NULL; // Initialize page object first

class cemprestimo_livro_add extends cemprestimo_livro {
	...
	// Page object name
	var $PageObjName = 'emprestimo_livro_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["ID_EMPRESTIMO_LIVRO"] != "") {
				$this->ID_EMPRESTIMO_LIVRO->setQueryStringValue($_GET["ID_EMPRESTIMO_LIVRO"]);
				$this->setKey("ID_EMPRESTIMO_LIVRO", $this->ID_EMPRESTIMO_LIVRO->CurrentValue); // Set up key
			} else {
				$this->setKey("ID_EMPRESTIMO_LIVRO", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "emprestimo_livroview.php")
	...
	function LoadDefaultValues() {
		...
		$this->ID_EMPRESTIMO_LIVRO->OldValue = $this->ID_EMPRESTIMO_LIVRO->CurrentValue;
	...
	function NewRow() {
		...
		$row = array();
		$row['ID_EMPRESTIMO_LIVRO'] = $this->ID_EMPRESTIMO_LIVRO->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// ID_ALUNO
		$this->ID_ALUNO->SetDbValueDef($rsnew, $this->ID_ALUNO->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($emprestimo_livro_add)) $emprestimo_livro_add = new cemprestimo_livro_add();

// Page init
$emprestimo_livro_add->Page_Init();

// Page main
$emprestimo_livro_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$emprestimo_livro_add->Page_Render();
?>
...
var CurrentForm = femprestimo_livroadd = new ew_Form("femprestimo_livroadd", "add");

// Validate form
femprestimo_livroadd.Validate = function() {
...
femprestimo_livroadd.Form_CustomValidate = 
...
femprestimo_livroadd.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $emprestimo_livro_add->ShowPageHeader(); ?>
<?php
$emprestimo_livro_add->ShowMessage();
?>
<form name="femprestimo_livroadd" id="femprestimo_livroadd" class="<?php echo $emprestimo_livro_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($emprestimo_livro_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $emprestimo_livro_add->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="emprestimo_livro">
<input type="hidden" name="a_add" id="a_add" value="A">
<input type="hidden" name="modal" value="<?php echo intval($emprestimo_livro_add->IsModal) ?>">
<div class="ewAddDiv"><!-- page* -->
<?php if ($emprestimo_livro->ID_LIVRO->Visible) { // ID_LIVRO ?>
	<div id="r_ID_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro_ID_LIVRO" for="x_ID_LIVRO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->ID_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->ID_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro->ID_ALUNO->Visible) { // ID_ALUNO ?>
	<div id="r_ID_ALUNO" class="form-group">
		<label id="elh_emprestimo_livro_ID_ALUNO" for="x_ID_ALUNO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->ID_ALUNO->FldCaption() ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->ID_ALUNO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro->ID_CADASTRO->Visible) { // ID_CADASTRO ?>
	<div id="r_ID_CADASTRO" class="form-group">
		<label id="elh_emprestimo_livro_ID_CADASTRO" for="x_ID_CADASTRO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->ID_CADASTRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->ID_CADASTRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->Visible) { // DATA_INICIAL_EMPRESTIMO_LIVRO ?>
	<div id="r_DATA_INICIAL_EMPRESTIMO_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro_DATA_INICIAL_EMPRESTIMO_LIVRO" for="x_DATA_INICIAL_EMPRESTIMO_LIVRO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->DATA_INICIAL_EMPRESTIMO_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->Visible) { // DATA_FINAL_EMPRESTIMO_LIVRO ?>
	<div id="r_DATA_FINAL_EMPRESTIMO_LIVRO" class="form-group">
		<label id="elh_emprestimo_livro_DATA_FINAL_EMPRESTIMO_LIVRO" for="x_DATA_FINAL_EMPRESTIMO_LIVRO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->DATA_FINAL_EMPRESTIMO_LIVRO->CellAttributes() ?>>
...
<?php if ($emprestimo_livro->STATUS_EMPRESTIMO->Visible) { // STATUS_EMPRESTIMO ?>
	<div id="r_STATUS_EMPRESTIMO" class="form-group">
		<label id="elh_emprestimo_livro_STATUS_EMPRESTIMO" for="x_STATUS_EMPRESTIMO" class="<?php echo $emprestimo_livro_add->LeftColumnClass ?>"><?php echo $emprestimo_livro->STATUS_EMPRESTIMO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $emprestimo_livro_add->RightColumnClass ?>"><div<?php echo $emprestimo_livro->STATUS_EMPRESTIMO->CellAttributes() ?>>
...
<?php if (!$emprestimo_livro_add->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $emprestimo_livro_add->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("AddBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $emprestimo_livro_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<script type="text/javascript">
femprestimo_livroadd.Init();
</script>
<?php
$emprestimo_livro_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$emprestimo_livro_add->Page_Terminate();
?>
