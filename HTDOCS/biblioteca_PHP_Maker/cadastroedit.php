...
$cadastro_edit = NULL; // Initialize page object first

class ccadastro_edit extends ccadastro {
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			...
			// Load key from Form
			if ($objForm->HasValue("x_ID_CADASTRO")) {
	...
	function EditRow() {
		...
		if ($this->LOGIN_CADASTRO->CurrentValue <> "") { // Check field with unique index
			$sFilterChk = "(`LOGIN_CADASTRO` = '" . ew_AdjustSql($this->LOGIN_CADASTRO->CurrentValue, $this->DBID) . "')";
		...
		if ($rs->EOF) {
			...
			// NOME_CADASTRO
			$this->NOME_CADASTRO->SetDbValueDef($rsnew, $this->NOME_CADASTRO->CurrentValue, "", $this->NOME_CADASTRO->ReadOnly);

			// LOGIN_CADASTRO
			$this->LOGIN_CADASTRO->SetDbValueDef($rsnew, $this->LOGIN_CADASTRO->CurrentValue, "", $this->LOGIN_CADASTRO->ReadOnly);

			// SENHA_CADASTRO
			$this->SENHA_CADASTRO->SetDbValueDef($rsnew, $this->SENHA_CADASTRO->CurrentValue, "", $this->SENHA_CADASTRO->ReadOnly);
...
// Create page object
if (!isset($cadastro_edit)) $cadastro_edit = new ccadastro_edit();

// Page init
$cadastro_edit->Page_Init();

// Page main
$cadastro_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$cadastro_edit->Page_Render();
?>
...
var CurrentForm = fcadastroedit = new ew_Form("fcadastroedit", "edit");

// Validate form
fcadastroedit.Validate = function() {
...
fcadastroedit.Form_CustomValidate = 
...
fcadastroedit.ValidateRequired = <?php echo json_encode(EW_CLIENT_VALIDATE) ?>;
...
<?php $cadastro_edit->ShowPageHeader(); ?>
<?php
$cadastro_edit->ShowMessage();
?>
<form name="fcadastroedit" id="fcadastroedit" class="<?php echo $cadastro_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($cadastro_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $cadastro_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="cadastro">
<input type="hidden" name="a_edit" id="a_edit" value="U">
<input type="hidden" name="modal" value="<?php echo intval($cadastro_edit->IsModal) ?>">
<div class="ewEditDiv"><!-- page* -->
<?php if ($cadastro->ID_CADASTRO->Visible) { // ID_CADASTRO ?>
	<div id="r_ID_CADASTRO" class="form-group">
		<label id="elh_cadastro_ID_CADASTRO" class="<?php echo $cadastro_edit->LeftColumnClass ?>"><?php echo $cadastro->ID_CADASTRO->FldCaption() ?></label>
		<div class="<?php echo $cadastro_edit->RightColumnClass ?>"><div<?php echo $cadastro->ID_CADASTRO->CellAttributes() ?>>
<span id="el_cadastro_ID_CADASTRO">
<span<?php echo $cadastro->ID_CADASTRO->ViewAttributes() ?>>
<p class="form-control-static"><?php echo $cadastro->ID_CADASTRO->EditValue ?></p></span>
</span>
<input type="hidden" data-table="cadastro" data-field="x_ID_CADASTRO" name="x_ID_CADASTRO" id="x_ID_CADASTRO" value="<?php echo ew_HtmlEncode($cadastro->ID_CADASTRO->CurrentValue) ?>">
<?php echo $cadastro->ID_CADASTRO->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($cadastro->NOME_CADASTRO->Visible) { // NOME_CADASTRO ?>
	<div id="r_NOME_CADASTRO" class="form-group">
		<label id="elh_cadastro_NOME_CADASTRO" for="x_NOME_CADASTRO" class="<?php echo $cadastro_edit->LeftColumnClass ?>"><?php echo $cadastro->NOME_CADASTRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cadastro_edit->RightColumnClass ?>"><div<?php echo $cadastro->NOME_CADASTRO->CellAttributes() ?>>
...
<?php if ($cadastro->LOGIN_CADASTRO->Visible) { // LOGIN_CADASTRO ?>
	<div id="r_LOGIN_CADASTRO" class="form-group">
		<label id="elh_cadastro_LOGIN_CADASTRO" for="x_LOGIN_CADASTRO" class="<?php echo $cadastro_edit->LeftColumnClass ?>"><?php echo $cadastro->LOGIN_CADASTRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cadastro_edit->RightColumnClass ?>"><div<?php echo $cadastro->LOGIN_CADASTRO->CellAttributes() ?>>
...
<?php if ($cadastro->SENHA_CADASTRO->Visible) { // SENHA_CADASTRO ?>
	<div id="r_SENHA_CADASTRO" class="form-group">
		<label id="elh_cadastro_SENHA_CADASTRO" for="x_SENHA_CADASTRO" class="<?php echo $cadastro_edit->LeftColumnClass ?>"><?php echo $cadastro->SENHA_CADASTRO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cadastro_edit->RightColumnClass ?>"><div<?php echo $cadastro->SENHA_CADASTRO->CellAttributes() ?>>
...
<?php if ($cadastro->ID_NIVEL_ACESSO->Visible) { // ID_NIVEL_ACESSO ?>
	<div id="r_ID_NIVEL_ACESSO" class="form-group">
		<label id="elh_cadastro_ID_NIVEL_ACESSO" for="x_ID_NIVEL_ACESSO" class="<?php echo $cadastro_edit->LeftColumnClass ?>"><?php echo $cadastro->ID_NIVEL_ACESSO->FldCaption() ?><?php echo $Language->Phrase("FieldRequiredIndicator") ?></label>
		<div class="<?php echo $cadastro_edit->RightColumnClass ?>"><div<?php echo $cadastro->ID_NIVEL_ACESSO->CellAttributes() ?>>
...
<?php if (!$cadastro_edit->IsModal) { ?>
<div class="form-group"><!-- buttons .form-group -->
	<div class="<?php echo $cadastro_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ewButton" name="btnAction" id="btnAction" type="submit"><?php echo $Language->Phrase("SaveBtn") ?></button>
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $cadastro_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
