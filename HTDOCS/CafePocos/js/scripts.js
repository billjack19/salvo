...
//Controles de navegacao do slideshow fotos
var slideIndex = 1;
// showDivs(slideIndex);
...
function myMap()
{
  ...
  myCenter=new google.maps.LatLng(-21.7837161, -46.5636733);
  var mapOptions= {
	center:myCenter,
...
function excluir(el , table, idOrcamento){
	if(confirm("Tem certeza que deseja remover o item deste cadastro?")){
		$.ajax({
			...
			listarItensOrcamento(idOrcamento);
		});
	} else return 0;
}
