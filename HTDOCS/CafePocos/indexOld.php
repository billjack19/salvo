...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container">
			...
			<h1 class="my-4"><?php echo $tituloBemVindo; ?></h1>
			...
			<div class=\"row\" style=\"background-color: #ddd;border-radius: 10px;\">";
				...
				if ($idSaibaMais != 0) {
					...
					foreach ($verifica as $dados) {
						$contAdicionalSite++;
						$configImgAdicionalSite = $dados['imagem_adicional_site'] != "" ? "<img class=\"\" style=\"border-radius: 10px;\" width=\"50%\" src=\"".$caminhoImg.$dados['imagem_adicional_site']."\" alt=\"\">" : "";

						$bloco1_AdicionalSite = "
					<div class=\"col-md-8 col-xs-6 text-center\"'>
						<br><br>
						<h3>".$dados['titulo_adicional_site']."</h3>
						<p>".$dados['descricao_adicional_site']."</p>
					</div>";
						$bloco2_AdicionalSite = "
