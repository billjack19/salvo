...
app.config(function($routeProvider)
{
	...
	// Tabela: teste
	.when('/teste', {
		templateUrl : 'app/views/teste.htm',
	})
	.when('/adicionar_teste', {
		templateUrl : 'app/views/adicionar_teste.htm',
	})
	.when('/editar_teste', {
		templateUrl : 'app/views/editar_teste.htm',
	})
	...
	// Grades: teste_grade-teste
	.when('/grade_teste_grade-teste', {
		templateUrl : 'app/views/grade_teste_grade-teste.htm',
	})
	.when('/adicionar_grade_teste_grade-teste', {
		templateUrl : 'app/views/adicionar_grade_teste_grade-teste.htm',
	})
	.when('/editar_grade_teste_grade-teste', {
		templateUrl : 'app/views/editar_grade_teste_grade-teste.htm',
	})
