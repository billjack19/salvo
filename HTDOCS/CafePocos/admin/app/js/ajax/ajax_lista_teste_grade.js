	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				acumularFunctionCampo.push(teste_id+"+teste");
				acumularFunctionId.push(id_teste_grade);
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_teste_grade' style='color: #f0ad4e;' data-id='"+id_teste_grade+"' onclick='editar(this);' title='Editar'"+accesskeyEditar+" "+desabilitar+">";
				tabelaViewBody +=				 	"<b><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i></b>";
				tabelaViewBody += 				"</a>";
				tabelaViewBody +=			"</td>";
				tabelaViewBody += 			"<td>"+descricao_teste_grade+"</td>";
				tabelaViewBody += 			"<td><div id='teste_"+parseInt(id_teste_grade)+"'></div></td>";
				...
				tabelaViewBody += 				"<a href='#!teste_grade' style='color: "+cor_ativo+"' data-id='"+id_teste_grade+"' onclick=\"excluir(this , 'teste_grade', "+bool_ativo_teste_grade+", 'teste_grade')\">";
			...
			telaCadastroTeste_grade += 			"<td><b>Teste</b></td>";
