...
function atualizarrRegistro(){
	var campoFocus = "";
		 if(validation($("#descricao_empresa").val() == "")) campoFocus = "descricao_empresa";
	else if(validation($("#imagem_logo_empresa").val() == "")) campoFocus = "imagem_logo_empresa";
	else if(validation($("#data_atualizacao_empresa").val() == "")) campoFocus = "data_atualizacao_empresa";
	else if(validation($("#usuario_id").val() == "")) campoFocus = "usuario_id";
	else if(validation($("#bool_ativo_empresa").val() == "")) campoFocus = "bool_ativo_empresa";
