...
<?php 
	...
	$bool_ativo_usuario = $_POST['bool_ativo_usuario'] == '' ? 0 : $_POST['bool_ativo_usuario'];
	$entidadeUsuario->set($bool_ativo_usuario, 'bool_ativo_usuario');


	$retorno = $usuarioDAO->atualizaUsuario($entidadeUsuario, $_POST['id_usuario']);
	echo $retorno;
?>
