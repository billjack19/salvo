...
<div class="row" id="telaLogin">
	<div class="col-xs-12" id="cabecarioPrincipal">
		<div style="margin-left: 15%; margin-right: 15%;">
			<!-- <form id="formLogin" method="post"> -->
			<div class="col-xs-12">
				<h2 class="text-center">Lanches CDI</h2>
...
<!-- Tela Principal -->
<!-- ***************************************************************************************************************** -->
<div class="row" id="telaPrincipal" style="display: none;">
	<div class="container-fluid" style="width: 105%; height: 100%;display: block; position: fixed;">
		...
		<div id="hiddenUsuario"></div>
		<input type="hidden" value="" id="qtd_n_cobrar">

		<?php include "views/cabecario_principal.php"; ?>
		<?php include "views/tela_itens.php"; ?>
		<?php include "views/tela_pedidos_itens.php";?>
		<?php include "views/tela_pedidos_itens_view.php";?>
		<?php include "views/tela_pedidos.php";?>
...
<?php 
	include "views/rodape_inicial.php";
	include "views/modal_config_login.php";
	include "views/teclado_numerioco.php"; 
	include "views/modal_pseudo_adiciona_item.php";
	include "views/modal_pseudo_subGrupo.php";
	include "views/modal_pseudo_finalizar_pedido.php";
?>
...
<?php 
	include "views/impresao_comanda.php";
?>
