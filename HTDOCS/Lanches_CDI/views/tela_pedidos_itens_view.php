...
<div class="col-xs-5 text-center" id="talaPedidosItensView" style="border-left-style: solid;padding: 0px; height: 85%; display: none;">
	<div class="col-xs-12" style="padding: 0;">
		<span style="background-color: #337ab7;">
			<h1 style="margin: 0px;margin-bottom: 30px;background-color: #337ab7;color: white;">
				Visualizar&nbsp;&nbsp;&nbsp;Pedido / Itens
			</h1>
		</span>
	</div>
	...
	<div id="conteudo_item_pedido_geral_2">
			...
			<table class="table">
				<tr>
					<td width="50%">
						<b>Pedido</b>
					<!-- </td><td align="center"> -->
						<input type="text" id="numPedidoItens_numero_view" value="" class="text-right form-control" disabled>
					</td>
					<td>
						...
						<b>Total</b>
					<!-- </td><td align="center"> -->
						<input type="text" id="numPedidoItens_totalPedido_view" class="text-right form-control" value="R$ 0,00" disabled>
				...
				<!-- <tr>
					...
					<td> -->
						<!-- <script type="text/javascript"> -->
							<!-- function excluirPedidoUnico(){ desocuparMesa( $("#documentoGeral").val() ); } -->
						<!-- </script> -->
						<!-- <button class="btn btn-danger btn-block" style="padding: 0" id="btn_excluir_todos" onclick="excluirPedidoUnico();"> -->
				...
				<tr>
					...
					<!-- </td><td align="center"> -->
						...
						<input type="text" id="numPedidoItens_cliente_view" class="text-right form-control" disabled>
							<!-- <input type="" id="numPedidoItens_cliente_view"> -->
							<!-- <input type="text" value="Carrgando..." class="form-control" disabled> -->
						<!-- </div> -->
		...
		<br><br><br><br><br><br>
		<div class="col-xs-12" id="cabecarioItensDivView" style="margin-left: 0px;padding-right: 40px;padding-left: 0px;">
			<table class="table">
				<tr>
		...
		<div class="col-xs-12 blocoItensPedidoView" id="conteudo_itens_pedido_tabela_view" style="margin-left: 0%;padding-right: 40px;padding-left: 0px;">
			<!-- <table class="table">
				<tr>
