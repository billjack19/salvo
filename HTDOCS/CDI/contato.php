...
<html lang="pt-br">
	...
	<body>
		...
		<div class="container">
			...
			<div class="row">
				<!-- Map Column -->
				<div class="col-lg-8 mb-4" style='color: <?php echo $corTexto; ?>'>
					<?php
					$stringEnderecoSite = "";
				...
				<div class="col-lg-4 mb-4" style='color: <?php echo $corTexto; ?>'>
					...
					<form action="mail/contact_me.php" enctype="multipart/form-data" method="POST">
						<div class="row">
							<div class="file-field input-field col s8">
								...
								?>
								<button type="submit" id='gravar' class="waves-effect waves-light btn <?php echo $classeBtnEnviarContato; ?>">
