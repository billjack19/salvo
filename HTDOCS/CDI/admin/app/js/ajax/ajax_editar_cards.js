...
$(document).ready(function(){
	...
	$.ajax({
		...
		descricao_item_cards = vetor[3];
		imagem_cards = vetor[4];
		sequencia_cards = vetor[5];
		configurar_site_id = vetor[6];
		data_atualizacao_cards = vetor[7];
		bool_ativo_cards = vetor[8];
		
		$("#titulo_cards").val(titulo_cards);
		$("#descricao_cards").val(descricao_cards);
		$("#descricao_item_cards").val(descricao_item_cards);
		$("#imagem_cards").val(imagem_cards);
		$("#sequencia_cards").val(sequencia_cards);
