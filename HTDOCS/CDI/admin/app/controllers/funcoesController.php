	...
	foreach ($verifica as $dados) {
		...
		if ( file_exists($caminhoUploadImagem."/".$dados[1]) ) {
			...
			<div class='col-md-4 col-sm-6 col-xs-12 text-center divImg'>
				<img src='".$preCaminho_Site."/".$dados[1]."' width='100%'><br><!--  height=\"50px\"  -->
				<b>".$dados[1]."</b><br><br>
...
if (!empty($_POST['imgensServidoPasta'])) {
	...
	for ($i=0; $i < count($files1); $i++) { 
		if (
			...
			$resultado .= "
			<div class='col-md-4 col-sm-6 col-xs-12 text-center divImg'>
				<img src='".$preCaminho_Site."/".$files1[$i]."' width='100%'><br><!--  height=\"50px\"  -->
...
/************************************************************************************************************************/
/** Operaçõe genericas com tabela do banco **/
/************************************************************************************************************************/
