...
<?php 
	...
	if ($gravar) {
		...
		$entidadeConfigurar_site->set($_POST['titulo_menu_configurar_site'], 'titulo_menu_configurar_site');
		...
		$entidadeConfigurar_site->set($_POST['imagem_logo_sm_configurar_site'], 'imagem_logo_sm_configurar_site');
		$entidadeConfigurar_site->set($_POST['bem_vindo_configurar_site'], 'bem_vindo_configurar_site');
		$entidadeConfigurar_site->set($_POST['data_atualizacao_configurar_site'], 'data_atualizacao_configurar_site');

		$bool_ativo_configurar_site = $_POST['bool_ativo_configurar_site'] == '' ? 0 : $_POST['bool_ativo_configurar_site'];
		$entidadeConfigurar_site->set($bool_ativo_configurar_site, 'bool_ativo_configurar_site');


		$retorno = $configurar_siteDAO->cadastraConfigurar_site($entidadeConfigurar_site);
		echo $retorno;
	}
	else echo $saida;
?>
