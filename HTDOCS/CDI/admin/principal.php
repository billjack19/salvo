...
$topicos_cards_cards = "0";
if(!empty($_SESSION['topicos_cards-cards'])) {
	$topicos_cards_cards = $_SESSION['topicos_cards-cards'];
}
...
$acess_links_uteis = false;
if(in_array('links_uteis', $minha_area_nivel_acesso)) $acess_links_uteis = true;

$acess_quem_somos = false;
if(in_array('quem_somos', $minha_area_nivel_acesso)) $acess_quem_somos = true;

$acess_saiba_mais = false;
if(in_array('saiba_mais', $minha_area_nivel_acesso)) $acess_saiba_mais = true;
...
$acess_adicional_site_saiba_mais = "0";
if(in_array('adicional_site-saiba_mais', $minha_area_nivel_acesso)) $acess_adicional_site_saiba_mais = "1";

$acess_topicos_cards_cards = "0";
if(in_array('topicos_cards-cards', $minha_area_nivel_acesso)) $acess_topicos_cards_cards = "1";
...
<head>
	...
	<link rel='shortcut icon' href='app/img/LogotipoFinal.png' />
											...
											<div class="panel-body">
												<div class="row">
													...
													<div class="col-md-12">
														...
														<input type="hidden" name="grade" id="el_saiba_mais-adicional_site" data-p="saiba_mais" data-g="adicional_site" value="<?php echo $adicional_site_saiba_mais; ?>">
														<input type="hidden" id='n_acs_adicional_site_saiba_mais' value='<?php echo $acess_adicional_site_saiba_mais; ?>'>
														<input type="hidden" name="grade" id="el_cards-topicos_cards" data-p="cards" data-g="topicos_cards" value="<?php echo $topicos_cards_cards; ?>">
														<input type="hidden" id='n_acs_topicos_cards_cards' value='<?php echo $acess_topicos_cards_cards; ?>'>
