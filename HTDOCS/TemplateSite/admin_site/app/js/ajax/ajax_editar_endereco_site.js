...
$(document).ready(function(){
	...
	$.ajax({
		...
		cidade_endereco_site = vetor[5];
		estado_id = vetor[6];
		cep_endereco_site = vetor[7];
		telefone_endereco_site = vetor[8];
		celular_endereco_site = vetor[9];
		horario_funcionamento_endereco_site = vetor[10];
		latitude_endereco_site = vetor[11];
		longitude_endereco_site = vetor[12];
		data_atualizacao_endereco_site = vetor[13];
		bool_ativo_endereco_site = vetor[14];
