...
class slide_showDAO{
	...
	function cadastraSlide_show(Slide_show $entidadeSlide_show){
		try{
			...
			$stmt = $this->pdo->prepare("INSERT INTO slide_show (titulo_slide_show, descricao_slide_show, imagem_slide_show, bool_ativo_slide_show) VALUES (:titulo_slide_show, :descricao_slide_show, :imagem_slide_show, :bool_ativo_slide_show);"
			);
	...
	function atualizaSlide_show(Slide_show $entidadeSlide_show, $id){
		try{
			...
			$stmt = $this->pdo->prepare("UPDATE slide_show SET titulo_slide_show = :titulo_slide_show, descricao_slide_show = :descricao_slide_show, imagem_slide_show = :imagem_slide_show, bool_ativo_slide_show = :bool_ativo_slide_show WHERE id_slide_show = ".$id.";"
			);
			return $stmt->execute($param);
		}catch(PDOException $ex){
