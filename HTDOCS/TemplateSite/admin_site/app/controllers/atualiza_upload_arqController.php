...
<?php 
	...
	$entidadeUpload_arq->set($_POST['bool_ativo_upload_arq'], 'bool_ativo_upload_arq');

	$retorno = $upload_arqDAO->atualizaUpload_arq($entidadeUpload_arq, $_POST['id_upload_arq']);
	echo $retorno;
?>
