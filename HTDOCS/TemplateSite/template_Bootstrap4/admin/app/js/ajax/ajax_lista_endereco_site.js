	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				cidade_endereco_site = subvetor[5];
				estado_id = subvetor[6];
				cep_endereco_site = subvetor[7];
				telefone_endereco_site = subvetor[8];
				celular_endereco_site = subvetor[9];
				horario_funcionamento_endereco_site = subvetor[10];
				latitude_endereco_site = subvetor[11];
				longitude_endereco_site = subvetor[12];
				data_atualizacao_endereco_site = subvetor[13];
				bool_ativo_endereco_site = subvetor[14];
				...
				tabelaViewBody += 			"<td>"+cidade_endereco_site+"</td>";
				tabelaViewBody += 			"<td align='center'>";
			...
			telaCadastroEndereco_site += 			"<td><b>Cidade</b></td>";
