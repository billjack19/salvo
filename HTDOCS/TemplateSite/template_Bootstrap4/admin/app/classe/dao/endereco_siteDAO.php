...
class endereco_siteDAO{
	...
	function cadastraEndereco_site(Endereco_site $entidadeEndereco_site){
		try{
			...
			$stmt = $this->pdo->prepare("INSERT INTO endereco_site (descricao_endereco_site, endereco_endereco_site, numero_endereco_site, complemento_endereco_site, cidade_endereco_site, estado_id, cep_endereco_site, telefone_endereco_site, celular_endereco_site, horario_funcionamento_endereco_site, latitude_endereco_site, longitude_endereco_site, bool_ativo_endereco_site) VALUES (:descricao_endereco_site, :endereco_endereco_site, :numero_endereco_site, :complemento_endereco_site, :cidade_endereco_site, :estado_id, :cep_endereco_site, :telefone_endereco_site, :celular_endereco_site, :horario_funcionamento_endereco_site, :latitude_endereco_site, :longitude_endereco_site, :bool_ativo_endereco_site);"
			);
	...
	function atualizaEndereco_site(Endereco_site $entidadeEndereco_site, $id){
		try{
			...
			$stmt = $this->pdo->prepare("UPDATE endereco_site SET descricao_endereco_site = :descricao_endereco_site, endereco_endereco_site = :endereco_endereco_site, numero_endereco_site = :numero_endereco_site, complemento_endereco_site = :complemento_endereco_site, cidade_endereco_site = :cidade_endereco_site, estado_id = :estado_id, cep_endereco_site = :cep_endereco_site, telefone_endereco_site = :telefone_endereco_site, celular_endereco_site = :celular_endereco_site, horario_funcionamento_endereco_site = :horario_funcionamento_endereco_site, latitude_endereco_site = :latitude_endereco_site, longitude_endereco_site = :longitude_endereco_site, bool_ativo_endereco_site = :bool_ativo_endereco_site WHERE id_endereco_site = ".$id.";"
			);
			return $stmt->execute($param);
		}catch(PDOException $ex){
