		...
		if (data == "") {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabela_cliente += jk_tr("' bgcolor='"+cor_linha+"","",
					...
					+ jk_td("left",  
						jk_buttonComplemento("", "", "", "", "excluirMovimentacao("+id_movimentacao_cacamba+");", 
...
function montarComboBuscaMovimentacao(){
	jk_comboDataList(
		...
		[ "1","2","3","4","5" ],
		0, [4], "b", "comboBuscaMovimentacao", "telaAdicionarMovimentacao(this.value);", 0
	);
}
