...
<nav class="navbar fixed-top navbar-expand-lg corPrincipalFundo fixed-top" style="color: white;">
	...
	<div class="container" style="color: white;">
		...
		<a class="navbar-brand" href="index.php" style="color: white;">
			&nbsp;&nbsp;
			<span style="font-size: 40px;"><?php echo $tituo_menu; ?></span>
		</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<?php
		$stringTelefoneMenu = "";
		...
		foreach ($verifica as $dados) {
			$configCelular = $dados['celular_endereco_site'] != "" ? "<br><i class=\"fa fa-phone\" aria-hidden=\"true\"></i>$spancoPo".$dados['celular_endereco_site'] : "";
			// whatsapp
...
<form action="controllers/login.php" method="POST">
	...
	<input type="submit" style="opacity: 0;" type="submit" id="btnDeslogar">
...
<div id="orcamento" class="w3-modal">
	<div class="w3-modal-content w3-animate-zoom">
		<div class="w3-container">
			<span onclick="fecharModalOrcamento();" class="w3-button w3-display-topright">
				&times;
			</span>
			<br><h2 class="corPrincipalText">Orçamento</h2>
			<ul class="nav nav-tabs">
				<li class="nav-item">
					<a class="nav-link active" id="linkAddOrcamento" onclick="mostrarConteudoOrcamento('linkAddOrcamento')" href="#">
						Criar Orçamento
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="linkAddItemOrcamento" onclick="mostrarConteudoOrcamento('linkAddItemOrcamento')" href="#">
						Adicionar Item ao Orçamento
					</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" id="linkStatusOrcamento" onclick="mostrarConteudoOrcamento('linkStatusOrcamento')" href="#">
						Status Orçamento
					</a>
				</li>
			</ul>
			...
			<div id="cliarOrcamentoDiv" style="display: block;">
				<h3>Criar Orçamento</h3>

				<label>Nome do Orçamento</label>
				<input type="text" class="form-control" id="descricao_orcamento"><br>
				<button class="btn btn-default" onclick="cadastrarOrcamento()">Gravar</button>
				<br>
				<div id="listaOrcamentoCadastradosCrud">
					<h3>Nenhum registro encontrado!</h3>
				</div>
			</div>

			<div id="adicionarOracamentoDiv" style="display: none;">
				<h3>Adicionar Item ao Orçamento</h3>
				<label >Selecione Orcamento: </label>
				<div id="orcamentoDiv"></div>
				<label>Item Selecionado: </label>
				<div id="comboItemDiv"></div>
				<label>Quantidade: </label>
				<input type="number" class="form-control" id="quantidade_item_orcamento"><br>
				<button class="btn btn-default" onclick="cadastrarItemOrcamento();">Adicionar Item</button>
			</div>

			<div id="StatusOrcamentoDiv" style="display: none;">
				<h3>Status Orçamento</h3>
				<label>Orçamento</label>
				<div id="listaOrcamneto"></div>
				<div id="listaItensDoOrcamento">
					<h3>Nenhum registro encontrado!</h3>
				</div>
			</div>
			<br><br>
...
<div id="alterarOrcamento" class="w3-modal">
	<div class="w3-modal-content w3-animate-zoom">
		<div class="w3-container">
			<span onclick="document.getElementById('alterarOrcamento').style.display='none'" class="w3-button w3-display-topright">
				&times;
			</span>
			<br><h2 class="corPrincipalText">Alterar Orçamanto</h2>
			<label>Orçamento</label>
			<input type="text" class="form-control" id="descricaoOrcamentoAltera">
			<input type="hidden" id="idOrcamentoAltera"><br>
			<button class="btn btn-default" onclick="altualizarOrcamento();">Altualizar</button>
			<br><br>
		</div>
	</div>
</div>
