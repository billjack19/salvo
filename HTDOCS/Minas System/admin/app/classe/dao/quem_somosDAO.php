...
class quem_somosDAO{
	...
	function cadastraQuem_somos(Quem_somos $entidadeQuem_somos, $area){
		...
		$descricaoNotificacao .= 'Imagem => '.$entidadeQuem_somos->get('imagem_quem_somos').'<br>';
	...
	function atualizaQuem_somos(Quem_somos $entidadeQuem_somos, $id, $area){
		...
		foreach ($verifica as $dados){ 
			...
			if ($dados['imagem_quem_somos'] != $entidadeQuem_somos->get('imagem_quem_somos')) {
				$descricaoNotificacao .= '<b style="color: red">Imagem: '.$dados['imagem_quem_somos'].' => '.$entidadeQuem_somos->get('imagem_quem_somos').'</b><br>';
				$controleAteracao++;
			}
			else {
				$descricaoNotificacao .= 'Imagem => '.$entidadeQuem_somos->get('imagem_quem_somos').'<br>';
