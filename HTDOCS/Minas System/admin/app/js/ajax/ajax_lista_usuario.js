	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_usuario' style='color: #f0ad4e;' data-id='"+id_usuario+"' onclick='editar(this);' title='Editar'"+accesskeyEditar+" "+desabilitar+">";
