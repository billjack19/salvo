...
function gravarRegistro(){
	var campoFocus = "";
		 if($("#nome_contato").val() == "") campoFocus = "nome_contato";
	else if($("#usuario_id").val() == "") campoFocus = "usuario_id";
	else if($("#data_atualizacao_contato").val() == "") campoFocus = "data_atualizacao_contato";
	else if($("#bool_ativo_contato").val() == "") campoFocus = "bool_ativo_contato";
