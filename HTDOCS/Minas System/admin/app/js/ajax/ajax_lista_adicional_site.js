...
function buscar_adicional_site(){
	...
	$("#conteudoAdicional_site").html("Carregando...");
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				acumularFunctionCampo.push(saiba_mais_id+"+saiba_mais");
				acumularFunctionId.push(id_adicional_site);
				...
				tabelaViewBody +=				"<a href='principal.php#!editar_adicional_site' style='color: #f0ad4e;' data-id='"+id_adicional_site+"' onclick='editar(this);' title='Editar'"+accesskeyEditar+" "+desabilitar+">";
				tabelaViewBody +=				 	"<b><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i></b>";
				tabelaViewBody += 				"</a>";
				tabelaViewBody +=			"</td>";
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<div  id='ativo_"+id_adicional_site+"'>";
				tabelaViewBody += 				"<a href='#!adicional_site' style='color: "+cor_ativo+"' data-id='"+id_adicional_site+"' onclick=\"excluir(this , 'adicional_site', "+bool_ativo_adicional_site+", 'adicional_site')\">";
				...
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='app/upload/img/"+imagem_adicional_site+"' target='_blank'>";
				tabelaViewBody += 					"<img src='app/upload/img/"+imagem_adicional_site+"' style='max-height: 500px; max-width: 15%;'>";
				tabelaViewBody += 				"</a>";
				tabelaViewBody += 			"</td>";
				tabelaViewBody += 			"<td><div id='saiba_mais_"+parseInt(id_adicional_site)+"'></div></td>";
			...
			telaCadastroAdicional_site += 			"<td><b>Saiba Mais</b></td>";
