			...
			<div class="side-nav">
				<ul class="nav">
					...
					<li>
						...
						<i class="fa fa-list" a="" <="" span="">
				</i>
							&nbsp;<span class="txt">Cadastro</span>
						</a>
						<ul class="sub">
							<?php if($acess_cliente_site) { ?>
							<li>
								<a href="principal.php#!cliente_site" onclick="configAreaDeAtucao('cliente_site')"><span class="txt">Cliente Site</span></a>
							</li>
							<?php } ?>
							<?php if($acess_configurar_site) { ?>
							<li>
								<a href="principal.php#!configurar_site" onclick="configAreaDeAtucao('configurar_site')"><span class="txt">Configurar Site</span></a>
							</li>
							<?php } ?>
							<?php if($acess_contato) { ?>
							<li>
								<a href="principal.php#!contato" onclick="configAreaDeAtucao('contato')"><span class="txt">Contato</span></a>
							</li>
							<?php } ?>
							...
							<li>
								<a href="principal.php#!quem_somos" onclick="configAreaDeAtucao('quem_somos')"><span class="txt">Quem Somos</span></a>
							</li>
							<?php } ?>
							<?php if($acess_videos) { ?>
							<li>
								<a href="principal.php#!videos" onclick="configAreaDeAtucao('videos')"><span class="txt">Vídeos</span></a>
							</li>
							<?php } ?>
						</ul>
					</li>
