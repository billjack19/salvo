...
function montarListaPedsito(){
	...
	$.ajax({
		...
		if (data.length == 0) {
			...
			montarListaPedido += "<td>";
			montarListaPedido += "<div style='background-color: #E9E97A;' class='legenda'></div>";			
			montarListaPedido += "</td><td>";
			montarListaPedido += "&nbsp;&nbsp;Total zerado&nbsp;&nbsp;&nbsp;";
			montarListaPedido += "</td>";
			// "</tr><tr>";
			montarListaPedido += "<td>";
			montarListaPedido += "<div style='background-color: #E9967A;' class='legenda'></div>";
			montarListaPedido += "</td><td>";
			montarListaPedido += "&nbsp;&nbsp;Não finalizado&nbsp;&nbsp;&nbsp;";
			montarListaPedido += "</td>";
			// "</tr><tr>";
			montarListaPedido += "<td>";
			montarListaPedido += "<div style='background-color: #98FB98;' class='legenda'></div>";
			montarListaPedido += "</td><td>";
