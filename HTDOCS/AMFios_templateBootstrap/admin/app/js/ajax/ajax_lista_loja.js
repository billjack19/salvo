	...
	$.ajax({
		...
		if (subvetor[1] == undefined) {
			...
			for (var i = 0; i < vetor.length; i++) {
				...
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='app/upload/img/"+imagem_loja+"' target='_blank'>";
				tabelaViewBody += 					"<img src='app/upload/img/"+imagem_loja+"' style='max-height: 500px; max-width: 15%;'>";
				tabelaViewBody += 				"</a>";
				tabelaViewBody += 			"</td>";
				tabelaViewBody += 			"<td><div id='configurar_site_"+parseInt(id_loja)+"'></div></td>";
				tabelaViewBody += 			"<td>"+formatarData(data_atualizacao_loja)+"</td>";
				if($("#n_acs_topicos_loja_loja").val() == 1 || $("#n_acs_topicos_loja_loja").val() == "1") {
				tabelaViewBody += 			"<td align='center'>";
				tabelaViewBody += 				"<a href='principal.php#!grade_topicos_loja-loja' style='color: green' data-id='"+id_loja+"' onclick=\"grade(this , 'loja', 'topicos_loja')\" title='Tópicos Loja'>";
			...
			if($("#n_acs_topicos_loja_loja").val() == 1 || $("#n_acs_topicos_loja_loja").val() == "1") {
			telaCadastroLoja += 			"<td><b>Tópicos Loja</b></td>";
			}
			telaCadastroLoja += 		"</tr>";
