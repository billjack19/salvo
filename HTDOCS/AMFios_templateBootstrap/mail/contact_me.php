...
/***************************************************************************************************************************/
	...
	$Assunto = "Formulario de Contato - Site AMFios & Cabos";
...
/***************************************************************************************************************************/
	...
	$mail->SMTPDebug = 0;
	$mail->Host = "mail.cdiinfo.com.br"; // Endereço do servidor SMTP // $mail->Host = "smtp.gmail.com";
	$mail->SMTPAuth = true; // Usa autenticação SMTP? (opcional)
	$mail->Username = 'thiago@cdiinfo.com.br'; // Usuário do servidor SMTP // $mail->Username = 'cdiinfo.suporte@gmail.com';
	$mail->Password = 'Cdidesenv03@'; // Senha do servidor SMTP // $mail->Password = 'cdiinfo!@#';
	...
	// Define o remetente
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->From = "thiago@cdiinfo.com.br"; // Seu e-mail
	...
	$mail->AddBCC('jackmailteste@gmail.com', 'Thigo CDI (AMFios & Cabos)'); // Cópia Oculta

	// Define os dados técnicos da Mensagem
	// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	$mail->IsHTML(true); // Define que o e-mail será enviado como HTML
	$mail->AddEmbeddedImage('../img/logo/Logotipo.png', '1');
...
/***************************************************************************************************************************/
	...
	$entidadeContato->set($nome_final, 'ARQUIVO_CONTATO');
