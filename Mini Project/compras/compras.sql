...
-- Copiando dados para a tabela compras_jk_19.area_nivel_acesso: ~15 rows (aproximadamente)
...
INSERT INTO `area_nivel_acesso` (`id_area_nivel_acesso`, `area_area_nivel_acesso`, `demostrativo_area_nivel_acesso`, `bool_list_area_nivel_acesso`, `bool_insert_area_nivel_acesso`, `bool_update_area_nivel_acesso`, `nivel_acesso_id`, `data_atualizacao_area_nivel_acesso`, `usuario_id`, `bool_ativo_area_nivel_acesso`) VALUES
	(100, 'grupo', 'Grupo', 1, 1, 1, 1, '2018-07-25 21:50:13', 1, 1),
	(101, 'item', 'Item', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(102, 'lanc_preco', 'Lanc Preço', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(103, 'marca', 'Marca', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(104, 'orcamento', 'Orçamento', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(105, 'supermercado', 'Supermercado', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(106, 'orcamento_item-orcamento', 'Orçamento Item - Orçamento', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(107, 'item-grupo', 'Item - Grupo', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(108, 'equivalentes-item', 'Equivalentes - Item', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(109, 'upload', 'Upload', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(110, 'mapa', 'Mapa', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(111, 'mov', 'Mov', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(112, 'relatorio', 'Relatório', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(113, 'notificacao', 'Notificação', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1),
	(114, 'usuario', 'Usuário', 1, 1, 1, 1, '2018-07-25 21:50:14', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.item: ~5 rows (aproximadamente)
DELETE FROM `item`;
...
-- Copiando dados para a tabela compras_jk_19.marca: ~6 rows (aproximadamente)
DELETE FROM `marca`;
...
INSERT INTO `nivel_acesso` (`id_nivel_acesso`, `descricao_nivel_acesso`, `area_nivel_acesso`, `data_atualizacao_nivel_acesso`, `usuario_id`, `bool_ativo_nivel_acesso`) VALUES
	(1, 'Nivel Administrador', 'grupo+item+lanc_preco+marca+orcamento+supermercado+orcamento_item-orcamento+item-grupo+equivalentes-item+upload+mapa+mov+relatorio+notificacao+usuario', '2018-07-25 21:50:13', 1, 1);
...
-- Copiando dados para a tabela compras_jk_19.supermercado: ~5 rows (aproximadamente)
