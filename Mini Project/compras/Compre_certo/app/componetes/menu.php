				...
				<ul class="nav">
					...
					<li>
						...
						<ul class="sub">
							...
							<?php } ?>
							<?php if($acess_lanc_preco) { ?>
							<li>
								<a href="principal.php#!lanc_preco" onclick="configAreaDeAtucao('lanc_preco')"><span class="txt">Lanc Preco</span></a>
							</li>
							<?php } ?>
							<?php if($acess_marca) { ?>
							<li>
								<a href="principal.php#!marca" onclick="configAreaDeAtucao('marca')"><span class="txt">Marca</span></a>
							</li>
							<?php } ?>
							<?php if($acess_orcamento) { ?>
							<li>
								<a href="principal.php#!orcamento" onclick="configAreaDeAtucao('orcamento')"><span class="txt">Orçamento</span></a>
							</li>
							<?php } ?>
							<?php if($acess_supermercado) { ?>
							<li>
								<a href="principal.php#!supermercado" onclick="configAreaDeAtucao('supermercado')"><span class="txt">Supermercado</span></a>
							</li>
							<?php } ?>
						</ul>
					</li>
